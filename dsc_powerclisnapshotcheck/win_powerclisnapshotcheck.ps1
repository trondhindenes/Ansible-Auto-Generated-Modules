...
#ATTRIBUTE:resourcepoolname;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$resourcepoolname = Get-Attr -obj $params -name resourcepoolname -failifempty $True -resultobj $result
#ATTRIBUTE:vcentername;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$vcentername = Get-Attr -obj $params -name vcentername -failifempty $True -resultobj $result
...
$DscResourceName = "PowerCLISnapShotCheck"

$DscModuleName = "dsc_powerclisnapshotcheck"
