...
#ATTRIBUTE:Decryption;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:3DES,AES,Auto,DES
$Decryption = Get-Attr -obj $params -name Decryption -failifempty $True -resultobj $result
#ATTRIBUTE:DecryptionKey;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DecryptionKey = Get-Attr -obj $params -name DecryptionKey -failifempty $True -resultobj $result
...
#ATTRIBUTE:Validation;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:3DES,AES,HMACSHA256,HMACSHA384,HMACSHA512,MD5,SHA1
$Validation = Get-Attr -obj $params -name Validation -failifempty $True -resultobj $result
#ATTRIBUTE:ValidationKey;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ValidationKey = Get-Attr -obj $params -name ValidationKey -failifempty $True -resultobj $result
...
If ($Decryption)
{
    If (('3DES','AES','Auto','DES') -contains $Decryption ) {
    }
    Else
    {
        Fail-Json $result "Option Decryption has invalid value $Decryption. Valid values are '3DES','AES','Auto','DES'"
    }
}
...
If ($Validation)
{
    If (('3DES','AES','HMACSHA256','HMACSHA384','HMACSHA512','MD5','SHA1') -contains $Validation ) {
    }
    Else
    {
        Fail-Json $result "Option Validation has invalid value $Validation. Valid values are '3DES','AES','HMACSHA256','HMACSHA384','HMACSHA512','MD5','SHA1'"
    }
}
...
$DscResourceName = "xIISMachineKey"

$DscModuleName = "xiismachinekey"
