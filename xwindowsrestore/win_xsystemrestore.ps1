...
#ATTRIBUTE:Drive;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Drive = Get-Attr -obj $params -name Drive -failifempty $False -resultobj $result
...
$DscResourceName = "xSystemRestore"
