...
#ATTRIBUTE:AutoLaunchDesktop;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AutoLaunchDesktop = Get-Attr -obj $params -name AutoLaunchDesktop -failifempty $False -resultobj $result
#ATTRIBUTE:ShowDesktopsView;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ShowDesktopsView = Get-Attr -obj $params -name ShowDesktopsView -failifempty $False -resultobj $result
#ATTRIBUTE:ShowAppsView;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ShowAppsView = Get-Attr -obj $params -name ShowAppsView -failifempty $False -resultobj $result
#ATTRIBUTE:DefaultView;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DefaultView = Get-Attr -obj $params -name DefaultView -failifempty $False -resultobj $result
#ATTRIBUTE:PluginAssistant;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PluginAssistant = Get-Attr -obj $params -name PluginAssistant -failifempty $False -resultobj $result
#ATTRIBUTE:PluginAssistantUpgrade;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PluginAssistantUpgrade = Get-Attr -obj $params -name PluginAssistantUpgrade -failifempty $False -resultobj $result
#ATTRIBUTE:WorkspaceControl;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WorkspaceControl = Get-Attr -obj $params -name WorkspaceControl -failifempty $False -resultobj $result
#ATTRIBUTE:AutoReconnectAtLogon;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AutoReconnectAtLogon = Get-Attr -obj $params -name AutoReconnectAtLogon -failifempty $False -resultobj $result
#ATTRIBUTE:LogOffAction;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LogOffAction = Get-Attr -obj $params -name LogOffAction -failifempty $False -resultobj $result
#ATTRIBUTE:ShowReconnectButton;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ShowReconnectButton = Get-Attr -obj $params -name ShowReconnectButton -failifempty $False -resultobj $result
#ATTRIBUTE:ShowDisconnectButton;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ShowDisconnectButton = Get-Attr -obj $params -name ShowDisconnectButton -failifempty $False -resultobj $result
#ATTRIBUTE:SingleTabLaunch;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SingleTabLaunch = Get-Attr -obj $params -name SingleTabLaunch -failifempty $False -resultobj $result
#ATTRIBUTE:SessionTimeout;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SessionTimeout = Get-Attr -obj $params -name SessionTimeout -failifempty $False -resultobj $result
...
$DscResourceName = "XD7LabStorefrontWebConfig"

$DscModuleName = "xendesktop7lab"
