...
#ATTRIBUTE:RedirectUrl;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RedirectUrl = Get-Attr -obj $params -name RedirectUrl -failifempty $True -resultobj $result
...
$DscResourceName = "XD7LabStorefrontRedirect"
