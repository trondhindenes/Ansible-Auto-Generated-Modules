...
#ATTRIBUTE:XenDesktopMediaPath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$XenDesktopMediaPath = Get-Attr -obj $params -name XenDesktopMediaPath -failifempty $True -resultobj $result
#ATTRIBUTE:SiteName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SiteName = Get-Attr -obj $params -name SiteName -failifempty $True -resultobj $result
...
#ATTRIBUTE:DatabaseServerName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DatabaseServerName = Get-Attr -obj $params -name DatabaseServerName -failifempty $True -resultobj $result
#ATTRIBUTE:CitrixLicensePath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CitrixLicensePath = Get-Attr -obj $params -name CitrixLicensePath -failifempty $True -resultobj $result
...
#ATTRIBUTE:PfxCertificatePath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PfxCertificatePath = Get-Attr -obj $params -name PfxCertificatePath -failifempty $True -resultobj $result
#ATTRIBUTE:PfxCertificateThumbprint;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PfxCertificateThumbprint = Get-Attr -obj $params -name PfxCertificateThumbprint -failifempty $True -resultobj $result
#ATTRIBUTE:PfxCertificateCredential_username;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PfxCertificateCredential_username = Get-Attr -obj $params -name PfxCertificateCredential_username -failifempty $True -resultobj $result
#ATTRIBUTE:PfxCertificateCredential_password;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PfxCertificateCredential_password = Get-Attr -obj $params -name PfxCertificateCredential_password -failifempty $True -resultobj $result
#ATTRIBUTE:StoreFrontBaseUrl;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$StoreFrontBaseUrl = Get-Attr -obj $params -name StoreFrontBaseUrl -failifempty $False -resultobj $result
#ATTRIBUTE:StoreFrontRedirectUrl;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$StoreFrontRedirectUrl = Get-Attr -obj $params -name StoreFrontRedirectUrl -failifempty $False -resultobj $result
#ATTRIBUTE:Users;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Users = Get-Attr -obj $params -name Users -failifempty $False -resultobj $result
#ATTRIBUTE:CatalogName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CatalogName = Get-Attr -obj $params -name CatalogName -failifempty $False -resultobj $result
#ATTRIBUTE:DeliveryGroupName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DeliveryGroupName = Get-Attr -obj $params -name DeliveryGroupName -failifempty $False -resultobj $result
#ATTRIBUTE:DeliveryGroupDescription;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DeliveryGroupDescription = Get-Attr -obj $params -name DeliveryGroupDescription -failifempty $False -resultobj $result
#ATTRIBUTE:LicenseModel;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LicenseModel = Get-Attr -obj $params -name LicenseModel -failifempty $False -resultobj $result
#ATTRIBUTE:InstallRDSLicensingRole;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$InstallRDSLicensingRole = Get-Attr -obj $params -name InstallRDSLicensingRole -failifempty $False -resultobj $result
#ATTRIBUTE:RDSLicenseServer;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RDSLicenseServer = Get-Attr -obj $params -name RDSLicenseServer -failifempty $False -resultobj $result
#ATTRIBUTE:SiteAdministrator;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SiteAdministrator = Get-Attr -obj $params -name SiteAdministrator -failifempty $False -resultobj $result
...
if ($PfxCertificateCredential_username)
{
$PfxCertificateCredential_securepassword = $PfxCertificateCredential_password | ConvertTo-SecureString -asPlainText -Force
$PfxCertificateCredential = New-Object System.Management.Automation.PSCredential($PfxCertificateCredential_username,$PfxCertificateCredential_securepassword)
}
...
$DscResourceName = "XD7LabSimpleHttps"
