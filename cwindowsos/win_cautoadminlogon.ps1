...
#ATTRIBUTE:AutoAdminCredential_username;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AutoAdminCredential_username = Get-Attr -obj $params -name AutoAdminCredential_username -failifempty $True -resultobj $result
#ATTRIBUTE:AutoAdminCredential_password;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AutoAdminCredential_password = Get-Attr -obj $params -name AutoAdminCredential_password -failifempty $True -resultobj $result
#ATTRIBUTE:Ensure;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
...
if ($AutoAdminCredential_username)
{
$AutoAdminCredential_securepassword = $AutoAdminCredential_password | ConvertTo-SecureString -asPlainText -Force
$AutoAdminCredential = New-Object System.Management.Automation.PSCredential($AutoAdminCredential_username,$AutoAdminCredential_securepassword)
}

$DscResourceName = "cAutoAdminLogon"

$DscModuleName = "cwindowsos"
