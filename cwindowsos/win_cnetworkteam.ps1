...
#ATTRIBUTE:LoadBalancingAlgorithm;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Dynamic,HyperVPort,IPAddresses,MacAddresses,TransportPorts
...
{
    If (('Dynamic','HyperVPort','IPAddresses','MacAddresses','TransportPorts') -contains $LoadBalancingAlgorithm ) {
    }
    Else
    {
        Fail-Json $result "Option LoadBalancingAlgorithm has invalid value $LoadBalancingAlgorithm. Valid values are 'Dynamic','HyperVPort','IPAddresses','MacAddresses','TransportPorts'"
    }
}
