...
#ATTRIBUTE:CertificateAuthentication,MANDATORY:False,DEFAULTVALUE:,DESCRIPTION:
...
#ATTRIBUTE:InternalNLBBypassUrl,MANDATORY:False,DEFAULTVALUE:,DESCRIPTION:
...
#ATTRIBUTE:OAuthAuthentication,MANDATORY:False,DEFAULTVALUE:,DESCRIPTION:
...
#ATTRIBUTE:WSSecurityAuthentication,MANDATORY:False,DEFAULTVALUE:,DESCRIPTION:
