...
#ATTRIBUTE:BakfilePath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$BakfilePath = Get-Attr -obj $params -name BakfilePath -failifempty $True -resultobj $result
#ATTRIBUTE:SQLDatabase;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SQLDatabase = Get-Attr -obj $params -name SQLDatabase -failifempty $True -resultobj $result
...
#ATTRIBUTE:TrustedConnection;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TrustedConnection = Get-Attr -obj $params -name TrustedConnection -failifempty $True -resultobj $result
...
#ATTRIBUTE:SQLpassword;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SQLpassword = Get-Attr -obj $params -name SQLpassword -failifempty $False -resultobj $result
#ATTRIBUTE:SQLusername;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SQLusername = Get-Attr -obj $params -name SQLusername -failifempty $False -resultobj $result
...
$DscResourceName = "cEPRSRestoreDBFromBackup"

$DscModuleName = "ceprsdbfeatures"
