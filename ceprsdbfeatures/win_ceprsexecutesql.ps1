...
#ATTRIBUTE:SQLFile;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SQLFile = Get-Attr -obj $params -name SQLFile -failifempty $True -resultobj $result
...
#ATTRIBUTE:Variables;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Variables = Get-Attr -obj $params -name Variables -failifempty $False -resultobj $result
...
$DscResourceName = "cEPRSExecuteSql"
