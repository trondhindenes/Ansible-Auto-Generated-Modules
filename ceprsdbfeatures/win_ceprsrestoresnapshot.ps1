...
#ATTRIBUTE:SnapShotName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SnapShotName = Get-Attr -obj $params -name SnapShotName -failifempty $True -resultobj $result
...
$DscResourceName = "cEPRSRestoreSnapshot"
