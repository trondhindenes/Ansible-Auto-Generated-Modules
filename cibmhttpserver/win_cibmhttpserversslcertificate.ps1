...
#ATTRIBUTE:CertificateLabel;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CertificateLabel = Get-Attr -obj $params -name CertificateLabel -failifempty $True -resultobj $result
...
#ATTRIBUTE:KeyDBPassword_username;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$KeyDBPassword_username = Get-Attr -obj $params -name KeyDBPassword_username -failifempty $True -resultobj $result
#ATTRIBUTE:KeyDBPassword_password;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$KeyDBPassword_password = Get-Attr -obj $params -name KeyDBPassword_password -failifempty $True -resultobj $result
#ATTRIBUTE:KeyDBPath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$KeyDBPath = Get-Attr -obj $params -name KeyDBPath -failifempty $True -resultobj $result
#ATTRIBUTE:CertificatePassword_username;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CertificatePassword_username = Get-Attr -obj $params -name CertificatePassword_username -failifempty $False -resultobj $result
#ATTRIBUTE:CertificatePassword_password;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CertificatePassword_password = Get-Attr -obj $params -name CertificatePassword_password -failifempty $False -resultobj $result
#ATTRIBUTE:CertificatePath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CertificatePath = Get-Attr -obj $params -name CertificatePath -failifempty $False -resultobj $result
#ATTRIBUTE:CertificatePathCredential_username;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CertificatePathCredential_username = Get-Attr -obj $params -name CertificatePathCredential_username -failifempty $False -resultobj $result
#ATTRIBUTE:CertificatePathCredential_password;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CertificatePathCredential_password = Get-Attr -obj $params -name CertificatePathCredential_password -failifempty $False -resultobj $result
#ATTRIBUTE:Default;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Default = Get-Attr -obj $params -name Default -failifempty $False -resultobj $result
...
if ($KeyDBPassword_username)
{
$KeyDBPassword_securepassword = $KeyDBPassword_password | ConvertTo-SecureString -asPlainText -Force
$KeyDBPassword = New-Object System.Management.Automation.PSCredential($KeyDBPassword_username,$KeyDBPassword_securepassword)
}

if ($CertificatePassword_username)
{
$CertificatePassword_securepassword = $CertificatePassword_password | ConvertTo-SecureString -asPlainText -Force
$CertificatePassword = New-Object System.Management.Automation.PSCredential($CertificatePassword_username,$CertificatePassword_securepassword)
}

if ($CertificatePathCredential_username)
{
$CertificatePathCredential_securepassword = $CertificatePathCredential_password | ConvertTo-SecureString -asPlainText -Force
$CertificatePathCredential = New-Object System.Management.Automation.PSCredential($CertificatePathCredential_username,$CertificatePathCredential_securepassword)
}
...
$DscResourceName = "cIBMHTTPServerSSLCertificate"
