...
#ATTRIBUTE:HTTPPort;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$HTTPPort = Get-Attr -obj $params -name HTTPPort -failifempty $False -resultobj $result
...
#ATTRIBUTE:WindowsServiceAccount_username;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WindowsServiceAccount_username = Get-Attr -obj $params -name WindowsServiceAccount_username -failifempty $False -resultobj $result
#ATTRIBUTE:WindowsServiceAccount_password;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WindowsServiceAccount_password = Get-Attr -obj $params -name WindowsServiceAccount_password -failifempty $False -resultobj $result
...
if ($WindowsServiceAccount_username)
{
$WindowsServiceAccount_securepassword = $WindowsServiceAccount_password | ConvertTo-SecureString -asPlainText -Force
$WindowsServiceAccount = New-Object System.Management.Automation.PSCredential($WindowsServiceAccount_username,$WindowsServiceAccount_securepassword)
}

$DscResourceName = "cIBMHTTPServer"
