...
if ($ServerCredential_username)
{
$ServerCredential_securepassword = $ServerCredential_password | ConvertTo-SecureString -asPlainText -Force
$ServerCredential = New-Object System.Management.Automation.PSCredential($ServerCredential_username,$ServerCredential_securepassword)
}
...
$DscResourceName = "xAzureSqlDatabase"
