...
#ATTRIBUTE:AzureSubscriptionName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AzureSubscriptionName = Get-Attr -obj $params -name AzureSubscriptionName -failifempty $True -resultobj $result
...
$DscResourceName = "xAzureSubscription"
