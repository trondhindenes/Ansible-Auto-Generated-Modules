...
#ATTRIBUTE:CreateCheckRegValue;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CreateCheckRegValue = Get-Attr -obj $params -name CreateCheckRegValue -failifempty $False -resultobj $result
...
If ($HashAlgorithm)
{
    If (('MD5','RIPEMD160','SHA1','SHA256','SHA384','SHA512') -contains $HashAlgorithm ) {
    }
    Else
    {
