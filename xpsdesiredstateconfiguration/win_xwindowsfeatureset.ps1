...
#ATTRIBUTE:IncludeAllSubFeature;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IncludeAllSubFeature = Get-Attr -obj $params -name IncludeAllSubFeature -failifempty $False -resultobj $result
