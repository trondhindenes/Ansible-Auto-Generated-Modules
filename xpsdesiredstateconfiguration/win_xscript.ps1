...
#ATTRIBUTE:GetScript;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$GetScript = Get-Attr -obj $params -name GetScript -failifempty $True -resultobj $result
#ATTRIBUTE:SetScript;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SetScript = Get-Attr -obj $params -name SetScript -failifempty $True -resultobj $result
#ATTRIBUTE:TestScript;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TestScript = Get-Attr -obj $params -name TestScript -failifempty $True -resultobj $result
