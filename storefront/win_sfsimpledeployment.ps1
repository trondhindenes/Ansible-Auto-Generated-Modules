...
#ATTRIBUTE:BaseUrl;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$BaseUrl = Get-Attr -obj $params -name BaseUrl -failifempty $True -resultobj $result
...
#ATTRIBUTE:FarmType;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
...
#ATTRIBUTE:StoreVirtualPath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$StoreVirtualPath = Get-Attr -obj $params -name StoreVirtualPath -failifempty $False -resultobj $result
#ATTRIBUTE:AuthenticationVirtualPath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AuthenticationVirtualPath = Get-Attr -obj $params -name AuthenticationVirtualPath -failifempty $False -resultobj $result
#ATTRIBUTE:Transport;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Transport = Get-Attr -obj $params -name Transport -failifempty $False -resultobj $result
...
$DscResourceName = "SFSimpleDeployment"
