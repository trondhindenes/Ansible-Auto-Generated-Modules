...
#ATTRIBUTE:DestinationPath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DestinationPath = Get-Attr -obj $params -name DestinationPath -failifempty $False -resultobj $result
#ATTRIBUTE:Ensure;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Absent,Present
$Ensure = Get-Attr -obj $params -name Ensure -failifempty $False -resultobj $result
#ATTRIBUTE:MacClientPath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MacClientPath = Get-Attr -obj $params -name MacClientPath -failifempty $False -resultobj $result
...
#ATTRIBUTE:WindowsClientPath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WindowsClientPath = Get-Attr -obj $params -name WindowsClientPath -failifempty $False -resultobj $result
