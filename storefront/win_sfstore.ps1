...
#ATTRIBUTE:AuthenticationServiceVirtualPath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AuthenticationServiceVirtualPath = Get-Attr -obj $params -name AuthenticationServiceVirtualPath -failifempty $True -resultobj $result
...
#ATTRIBUTE:FriendlyName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FriendlyName = Get-Attr -obj $params -name FriendlyName -failifempty $False -resultobj $result
...
#ATTRIBUTE:SiteId;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SiteId = Get-Attr -obj $params -name SiteId -failifempty $False -resultobj $result
