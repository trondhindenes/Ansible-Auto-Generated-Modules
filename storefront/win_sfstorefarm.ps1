...
#ATTRIBUTE:FarmName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FarmName = Get-Attr -obj $params -name FarmName -failifempty $True -resultobj $result
#ATTRIBUTE:FarmType;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:AppController,VDIinaBox,XenApp,XenDesktop
$FarmType = Get-Attr -obj $params -name FarmType -failifempty $True -resultobj $result
#ATTRIBUTE:Servers;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Servers = Get-Attr -obj $params -name Servers -failifempty $True -resultobj $result
#ATTRIBUTE:StoreVirtualPath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$StoreVirtualPath = Get-Attr -obj $params -name StoreVirtualPath -failifempty $True -resultobj $result
#ATTRIBUTE:AllFailedBypassDuration;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllFailedBypassDuration = Get-Attr -obj $params -name AllFailedBypassDuration -failifempty $False -resultobj $result
#ATTRIBUTE:BypassDuration;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$BypassDuration = Get-Attr -obj $params -name BypassDuration -failifempty $False -resultobj $result
#ATTRIBUTE:Ensure;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Absent,Present
$Ensure = Get-Attr -obj $params -name Ensure -failifempty $False -resultobj $result
#ATTRIBUTE:LoadBalance;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LoadBalance = Get-Attr -obj $params -name LoadBalance -failifempty $False -resultobj $result
#ATTRIBUTE:MaxFailedServersPerRequest;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MaxFailedServersPerRequest = Get-Attr -obj $params -name MaxFailedServersPerRequest -failifempty $False -resultobj $result
...
#ATTRIBUTE:RadeTicketTimeToLive;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RadeTicketTimeToLive = Get-Attr -obj $params -name RadeTicketTimeToLive -failifempty $False -resultobj $result
#ATTRIBUTE:ServicePort;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ServicePort = Get-Attr -obj $params -name ServicePort -failifempty $False -resultobj $result
#ATTRIBUTE:SSLRelayServicePort;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SSLRelayServicePort = Get-Attr -obj $params -name SSLRelayServicePort -failifempty $False -resultobj $result
#ATTRIBUTE:TicketTimeToLive;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TicketTimeToLive = Get-Attr -obj $params -name TicketTimeToLive -failifempty $False -resultobj $result
#ATTRIBUTE:TransportType;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:HTTP,HTTPS,SSL
$TransportType = Get-Attr -obj $params -name TransportType -failifempty $False -resultobj $result
...
If ($FarmType)
{
    If (('AppController','VDIinaBox','XenApp','XenDesktop') -contains $FarmType ) {
    }
    Else
    {
        Fail-Json $result "Option FarmType has invalid value $FarmType. Valid values are 'AppController','VDIinaBox','XenApp','XenDesktop'"
    }
}
...
If ($TransportType)
{
    If (('HTTP','HTTPS','SSL') -contains $TransportType ) {
    }
    Else
    {
        Fail-Json $result "Option TransportType has invalid value $TransportType. Valid values are 'HTTP','HTTPS','SSL'"
    }
}
...
$DscResourceName = "SFStoreFarm"

$DscModuleName = "storefront"
