...
#ATTRIBUTE:VirtualPath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$VirtualPath = Get-Attr -obj $params -name VirtualPath -failifempty $True -resultobj $result
#ATTRIBUTE:AuthenticationMethods;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Certificate,CitrixAGBasic,CitrixFederation,ExplicitForms,HttpBasic,IntegratedWindows
$AuthenticationMethods = Get-Attr -obj $params -name AuthenticationMethods -failifempty $False -resultobj $result
#ATTRIBUTE:Ensure;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Absent,Present
$Ensure = Get-Attr -obj $params -name Ensure -failifempty $False -resultobj $result
#ATTRIBUTE:ExcludeAuthenticationMethods;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Certificate,CitrixAGBasic,CitrixFederation,ExplicitForms,HttpBasic,IntegratedWindows
$ExcludeAuthenticationMethods = Get-Attr -obj $params -name ExcludeAuthenticationMethods -failifempty $False -resultobj $result
#ATTRIBUTE:IncludeAuthenticationMethods;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Certificate,CitrixAGBasic,CitrixFederation,ExplicitForms,HttpBasic,IntegratedWindows
$IncludeAuthenticationMethods = Get-Attr -obj $params -name IncludeAuthenticationMethods -failifempty $False -resultobj $result
...
{
    If (('Certificate','CitrixAGBasic','CitrixFederation','ExplicitForms','HttpBasic','IntegratedWindows') -contains $AuthenticationMethods ) {
    }
    Else
    {
        Fail-Json $result "Option AuthenticationMethods has invalid value $AuthenticationMethods. Valid values are 'Certificate','CitrixAGBasic','CitrixFederation','ExplicitForms','HttpBasic','IntegratedWindows'"
    }
}
...
If ($ExcludeAuthenticationMethods)
{
    If (('Certificate','CitrixAGBasic','CitrixFederation','ExplicitForms','HttpBasic','IntegratedWindows') -contains $ExcludeAuthenticationMethods ) {
    }
    Else
    {
        Fail-Json $result "Option ExcludeAuthenticationMethods has invalid value $ExcludeAuthenticationMethods. Valid values are 'Certificate','CitrixAGBasic','CitrixFederation','ExplicitForms','HttpBasic','IntegratedWindows'"
    }
}


If ($IncludeAuthenticationMethods)
{
    If (('Certificate','CitrixAGBasic','CitrixFederation','ExplicitForms','HttpBasic','IntegratedWindows') -contains $IncludeAuthenticationMethods ) {
    }
    Else
    {
        Fail-Json $result "Option IncludeAuthenticationMethods has invalid value $IncludeAuthenticationMethods. Valid values are 'Certificate','CitrixAGBasic','CitrixFederation','ExplicitForms','HttpBasic','IntegratedWindows'"
    }
}
...
$DscResourceName = "SFAuthenticationServiceMethod"
