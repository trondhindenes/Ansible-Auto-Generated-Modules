...
#ATTRIBUTE:LogonType;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Domain,DomainAndRSA,GatewayKnows,None,RSA,SmartCard,SMS,UsedForHDXOnly
$LogonType = Get-Attr -obj $params -name LogonType -failifempty $True -resultobj $result
...
#ATTRIBUTE:CallbackUrl;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CallbackUrl = Get-Attr -obj $params -name CallbackUrl -failifempty $False -resultobj $result
...
#ATTRIBUTE:RequestTicketTwoSTAs;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RequestTicketTwoSTAs = Get-Attr -obj $params -name RequestTicketTwoSTAs -failifempty $False -resultobj $result
#ATTRIBUTE:SecureTicketAuthorityUrls;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SecureTicketAuthorityUrls = Get-Attr -obj $params -name SecureTicketAuthorityUrls -failifempty $False -resultobj $result
#ATTRIBUTE:SessionReliability;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SessionReliability = Get-Attr -obj $params -name SessionReliability -failifempty $False -resultobj $result
#ATTRIBUTE:SmartCardFallbackLogonType;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Domain,DomainAndRSA,GatewayKnows,None,RSA,SmartCard,SMS,UsedForHDXOnly
$SmartCardFallbackLogonType = Get-Attr -obj $params -name SmartCardFallbackLogonType -failifempty $False -resultobj $result
#ATTRIBUTE:StasBypassDuration;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$StasBypassDuration = Get-Attr -obj $params -name StasBypassDuration -failifempty $False -resultobj $result
#ATTRIBUTE:StasUseLoadBalancing;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$StasUseLoadBalancing = Get-Attr -obj $params -name StasUseLoadBalancing -failifempty $False -resultobj $result
#ATTRIBUTE:SubnetIPAddress;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SubnetIPAddress = Get-Attr -obj $params -name SubnetIPAddress -failifempty $False -resultobj $result
...
If ($LogonType)
{
    If (('Domain','DomainAndRSA','GatewayKnows','None','RSA','SmartCard','SMS','UsedForHDXOnly') -contains $LogonType ) {
    }
    Else
    {
        Fail-Json $result "Option LogonType has invalid value $LogonType. Valid values are 'Domain','DomainAndRSA','GatewayKnows','None','RSA','SmartCard','SMS','UsedForHDXOnly'"
    }
}
...
If ($SmartCardFallbackLogonType)
{
    If (('Domain','DomainAndRSA','GatewayKnows','None','RSA','SmartCard','SMS','UsedForHDXOnly') -contains $SmartCardFallbackLogonType ) {
    }
    Else
    {
        Fail-Json $result "Option SmartCardFallbackLogonType has invalid value $SmartCardFallbackLogonType. Valid values are 'Domain','DomainAndRSA','GatewayKnows','None','RSA','SmartCard','SMS','UsedForHDXOnly'"
    }
}
