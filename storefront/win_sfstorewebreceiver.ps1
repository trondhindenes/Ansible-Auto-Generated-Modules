...
#ATTRIBUTE:ClassicReceiver;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ClassicReceiver = Get-Attr -obj $params -name ClassicReceiver -failifempty $False -resultobj $result
...
#ATTRIBUTE:VirtualPath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$VirtualPath = Get-Attr -obj $params -name VirtualPath -failifempty $False -resultobj $result
...
$DscResourceName = "SFStoreWebReceiver"
