...
#ATTRIBUTE:Extension;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Extension = Get-Attr -obj $params -name Extension -failifempty $True -resultobj $result
#ATTRIBUTE:MimeType;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MimeType = Get-Attr -obj $params -name MimeType -failifempty $True -resultobj $result
...
$DscResourceName = "xIisMimeTypeMapping"
