...
if ($DataReader_username)
{
$DataReader_securepassword = $DataReader_password | ConvertTo-SecureString -asPlainText -Force
$DataReader = New-Object System.Management.Automation.PSCredential($DataReader_username,$DataReader_securepassword)
}

if ($DataWriter_username)
{
$DataWriter_securepassword = $DataWriter_password | ConvertTo-SecureString -asPlainText -Force
$DataWriter = New-Object System.Management.Automation.PSCredential($DataWriter_username,$DataWriter_securepassword)
}
...
if ($ActionAccount_username)
{
$ActionAccount_securepassword = $ActionAccount_password | ConvertTo-SecureString -asPlainText -Force
$ActionAccount = New-Object System.Management.Automation.PSCredential($ActionAccount_username,$ActionAccount_securepassword)
}

if ($DASAccount_username)
{
$DASAccount_securepassword = $DASAccount_password | ConvertTo-SecureString -asPlainText -Force
$DASAccount = New-Object System.Management.Automation.PSCredential($DASAccount_username,$DASAccount_securepassword)
}
...
$DscResourceName = "xSCOMManagementServerSetup"
