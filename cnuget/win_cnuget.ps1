...
#ATTRIBUTE:APIKey;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$APIKey = Get-Attr -obj $params -name APIKey -failifempty $True -resultobj $result
#ATTRIBUTE:Name;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Name = Get-Attr -obj $params -name Name -failifempty $True -resultobj $result
#ATTRIBUTE:PackageSource;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PackageSource = Get-Attr -obj $params -name PackageSource -failifempty $True -resultobj $result
...
#ATTRIBUTE:AllowNugetPackagePush;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowNugetPackagePush = Get-Attr -obj $params -name AllowNugetPackagePush -failifempty $False -resultobj $result
#ATTRIBUTE:AllowPackageOverwrite;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowPackageOverwrite = Get-Attr -obj $params -name AllowPackageOverwrite -failifempty $False -resultobj $result
#ATTRIBUTE:Protocol;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:http,https
...
If ($Protocol)
{
    ...
    Else
    {
        Fail-Json $result "Option Protocol has invalid value $Protocol. Valid values are 'http','https'"
    }
}
...
$DscResourceName = "cNuget"

$DscModuleName = "cnuget"
