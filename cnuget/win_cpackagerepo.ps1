...
#ATTRIBUTE:InstallPolicy;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Trusted,Untrusted
$InstallPolicy = Get-Attr -obj $params -name InstallPolicy -failifempty $True -resultobj $result
...
#ATTRIBUTE:SourceUri;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SourceUri = Get-Attr -obj $params -name SourceUri -failifempty $True -resultobj $result
