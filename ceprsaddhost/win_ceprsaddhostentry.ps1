...
#ATTRIBUTE:MappingServerName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MappingServerName = Get-Attr -obj $params -name MappingServerName -failifempty $True -resultobj $result
...
$DscResourceName = "cEPRSAddHostEntry"

$DscModuleName = "ceprsaddhost"
