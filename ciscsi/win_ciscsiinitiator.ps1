...
#ATTRIBUTE:NodeAddress;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$NodeAddress = Get-Attr -obj $params -name NodeAddress -failifempty $True -resultobj $result
#ATTRIBUTE:TargetPortalAddress;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TargetPortalAddress = Get-Attr -obj $params -name TargetPortalAddress -failifempty $True -resultobj $result
#ATTRIBUTE:AuthenticationType;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:MutualCHAP,None,OneWayCHAP
$AuthenticationType = Get-Attr -obj $params -name AuthenticationType -failifempty $False -resultobj $result
#ATTRIBUTE:ChapSecret;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ChapSecret = Get-Attr -obj $params -name ChapSecret -failifempty $False -resultobj $result
#ATTRIBUTE:ChapUsername;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ChapUsername = Get-Attr -obj $params -name ChapUsername -failifempty $False -resultobj $result
#ATTRIBUTE:Ensure;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Absent,Present
$Ensure = Get-Attr -obj $params -name Ensure -failifempty $False -resultobj $result
#ATTRIBUTE:InitiatorInstanceName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$InitiatorInstanceName = Get-Attr -obj $params -name InitiatorInstanceName -failifempty $False -resultobj $result
#ATTRIBUTE:InitiatorPortalAddress;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$InitiatorPortalAddress = Get-Attr -obj $params -name InitiatorPortalAddress -failifempty $False -resultobj $result
#ATTRIBUTE:IsDataDigest;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IsDataDigest = Get-Attr -obj $params -name IsDataDigest -failifempty $False -resultobj $result
#ATTRIBUTE:IsHeaderDigest;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IsHeaderDigest = Get-Attr -obj $params -name IsHeaderDigest -failifempty $False -resultobj $result
#ATTRIBUTE:IsMultipathEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IsMultipathEnabled = Get-Attr -obj $params -name IsMultipathEnabled -failifempty $False -resultobj $result
#ATTRIBUTE:iSNSServer;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$iSNSServer = Get-Attr -obj $params -name iSNSServer -failifempty $False -resultobj $result
#ATTRIBUTE:IsPersistent;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IsPersistent = Get-Attr -obj $params -name IsPersistent -failifempty $False -resultobj $result
...
#ATTRIBUTE:ReportToPnP;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ReportToPnP = Get-Attr -obj $params -name ReportToPnP -failifempty $False -resultobj $result
#ATTRIBUTE:TargetPortalPortNumber;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TargetPortalPortNumber = Get-Attr -obj $params -name TargetPortalPortNumber -failifempty $False -resultobj $result
...
{
    If (('MutualCHAP','None','OneWayCHAP') -contains $AuthenticationType ) {
    }
    Else
    {
        Fail-Json $result "Option AuthenticationType has invalid value $AuthenticationType. Valid values are 'MutualCHAP','None','OneWayCHAP'"
    }
}
...
$DscResourceName = "ciSCSIInitiator"

$DscModuleName = "ciscsi"
