...
#ATTRIBUTE:InitiatorIds;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$InitiatorIds = Get-Attr -obj $params -name InitiatorIds -failifempty $True -resultobj $result
#ATTRIBUTE:Paths;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Paths = Get-Attr -obj $params -name Paths -failifempty $True -resultobj $result
#ATTRIBUTE:TargetName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TargetName = Get-Attr -obj $params -name TargetName -failifempty $True -resultobj $result
...
$DscResourceName = "ciSCSIServerTarget"
