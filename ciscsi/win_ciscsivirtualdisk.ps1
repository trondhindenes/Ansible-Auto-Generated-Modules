...
#ATTRIBUTE:BlockSizeBytes;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$BlockSizeBytes = Get-Attr -obj $params -name BlockSizeBytes -failifempty $False -resultobj $result
...
#ATTRIBUTE:DiskType;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Differencing,Dynamic,Fixed
$DiskType = Get-Attr -obj $params -name DiskType -failifempty $False -resultobj $result
#ATTRIBUTE:Ensure;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Absent,Present
$Ensure = Get-Attr -obj $params -name Ensure -failifempty $False -resultobj $result
#ATTRIBUTE:LogicalSectorSizeBytes;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:4096,512
$LogicalSectorSizeBytes = Get-Attr -obj $params -name LogicalSectorSizeBytes -failifempty $False -resultobj $result
#ATTRIBUTE:ParentPath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ParentPath = Get-Attr -obj $params -name ParentPath -failifempty $False -resultobj $result
#ATTRIBUTE:PhysicalSectorSizeBytes;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:4096,512
$PhysicalSectorSizeBytes = Get-Attr -obj $params -name PhysicalSectorSizeBytes -failifempty $False -resultobj $result
...
#ATTRIBUTE:SizeBytes;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SizeBytes = Get-Attr -obj $params -name SizeBytes -failifempty $False -resultobj $result
...
If ($DiskType)
{
    If (('Differencing','Dynamic','Fixed') -contains $DiskType ) {
    }
    Else
    {
        Fail-Json $result "Option DiskType has invalid value $DiskType. Valid values are 'Differencing','Dynamic','Fixed'"
    }
}
...
If ($LogicalSectorSizeBytes)
{
    If (('4096','512') -contains $LogicalSectorSizeBytes ) {
    }
    Else
    {
        Fail-Json $result "Option LogicalSectorSizeBytes has invalid value $LogicalSectorSizeBytes. Valid values are '4096','512'"
    }
}


If ($PhysicalSectorSizeBytes)
{
    If (('4096','512') -contains $PhysicalSectorSizeBytes ) {
    }
    Else
    {
        Fail-Json $result "Option PhysicalSectorSizeBytes has invalid value $PhysicalSectorSizeBytes. Valid values are '4096','512'"
    }
}
...
$DscResourceName = "ciSCSIVirtualDisk"
