...
#ATTRIBUTE:Action;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Allow,Block,Bypass
$Action = Get-Attr -obj $params -name Action -failifempty $True -resultobj $result
#ATTRIBUTE:Direction;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Inbound,Outbound
$Direction = Get-Attr -obj $params -name Direction -failifempty $True -resultobj $result
...
#ATTRIBUTE:Profile;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Profile = Get-Attr -obj $params -name Profile -failifempty $True -resultobj $result
...
$DscResourceName = "vFirewall"

$DscModuleName = "legacynetworking"
