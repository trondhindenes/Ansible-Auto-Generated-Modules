...
#ATTRIBUTE:AttibutenodetoUpdate;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AttibutenodetoUpdate = Get-Attr -obj $params -name AttibutenodetoUpdate -failifempty $True -resultobj $result
...
$DscResourceName = "cEPRSXMLRemoveNodeKeyValuePair"
