...
#ATTRIBUTE:ConfigFilePath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ConfigFilePath = Get-Attr -obj $params -name ConfigFilePath -failifempty $True -resultobj $result
