...
#ATTRIBUTE:Configurationpath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
...
#ATTRIBUTE:Innertext;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Innertext = Get-Attr -obj $params -name Innertext -failifempty $True -resultobj $result
#ATTRIBUTE:InnertexttoUpdate;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$InnertexttoUpdate = Get-Attr -obj $params -name InnertexttoUpdate -failifempty $True -resultobj $result
#ATTRIBUTE:IsSinglenode;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IsSinglenode = Get-Attr -obj $params -name IsSinglenode -failifempty $True -resultobj $result
...
$DscResourceName = "cEPRSXmlEditSingleNode"
