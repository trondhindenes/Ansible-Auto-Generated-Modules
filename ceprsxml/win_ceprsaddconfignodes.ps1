...
#ATTRIBUTE:AttributeKeyName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AttributeKeyName = Get-Attr -obj $params -name AttributeKeyName -failifempty $True -resultobj $result
#ATTRIBUTE:AttributeKeyValue;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AttributeKeyValue = Get-Attr -obj $params -name AttributeKeyValue -failifempty $True -resultobj $result
#ATTRIBUTE:AttributeNodeToUpdate;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AttributeNodeToUpdate = Get-Attr -obj $params -name AttributeNodeToUpdate -failifempty $True -resultobj $result
#ATTRIBUTE:AttributeNodeValue;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AttributeNodeValue = Get-Attr -obj $params -name AttributeNodeValue -failifempty $True -resultobj $result
#ATTRIBUTE:ConfigPath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ConfigPath = Get-Attr -obj $params -name ConfigPath -failifempty $True -resultobj $result
#ATTRIBUTE:ConfigurationSectionPath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ConfigurationSectionPath = Get-Attr -obj $params -name ConfigurationSectionPath -failifempty $True -resultobj $result
#ATTRIBUTE:Ensure;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Ensure = Get-Attr -obj $params -name Ensure -failifempty $True -resultobj $result
#ATTRIBUTE:LogFile;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LogFile = Get-Attr -obj $params -name LogFile -failifempty $True -resultobj $result
#ATTRIBUTE:TagName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TagName = Get-Attr -obj $params -name TagName -failifempty $True -resultobj $result
...
$DscResourceName = "cEPRSAddConfigNodes"

$DscModuleName = "ceprsxml"
