...
#ATTRIBUTE:MasterServers;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MasterServers = Get-Attr -obj $params -name MasterServers -failifempty $True -resultobj $result
...
$DscResourceName = "xDnsServerSecondaryZone"
