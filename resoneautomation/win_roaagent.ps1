...
#ATTRIBUTE:SiteId;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SiteId = Get-Attr -obj $params -name SiteId -failifempty $True -resultobj $result
#ATTRIBUTE:AddToTeam;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AddToTeam = Get-Attr -obj $params -name AddToTeam -failifempty $False -resultobj $result
#ATTRIBUTE:DispatcherList;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DispatcherList = Get-Attr -obj $params -name DispatcherList -failifempty $False -resultobj $result
#ATTRIBUTE:DownloadDispatcherList;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DownloadDispatcherList = Get-Attr -obj $params -name DownloadDispatcherList -failifempty $False -resultobj $result
#ATTRIBUTE:Ensure;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Absent,Present
$Ensure = Get-Attr -obj $params -name Ensure -failifempty $False -resultobj $result
#ATTRIBUTE:InvokeProject;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$InvokeProject = Get-Attr -obj $params -name InvokeProject -failifempty $False -resultobj $result
...
#ATTRIBUTE:UseAutodetectFirst;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UseAutodetectFirst = Get-Attr -obj $params -name UseAutodetectFirst -failifempty $False -resultobj $result
...
$DscResourceName = "ROAAgent"

$DscModuleName = "resoneautomation"
