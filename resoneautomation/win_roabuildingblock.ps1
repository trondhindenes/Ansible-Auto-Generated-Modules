...
#ATTRIBUTE:IsRESONEAutomationCredential;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IsRESONEAutomationCredential = Get-Attr -obj $params -name IsRESONEAutomationCredential -failifempty $False -resultobj $result
...
$DscResourceName = "ROABuildingBlock"
