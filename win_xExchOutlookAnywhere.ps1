...
{
    If (('Allow','None','Require') -contains $ExtendedProtectionTokenChecking ) {
    }
    Else
    {
...
If ($ExternalClientAuthenticationMethod)
{
    If (('Basic','Negotiate','Ntlm') -contains $ExternalClientAuthenticationMethod ) {
    }
    Else
    {
        Fail-Json $result "Option ExternalClientAuthenticationMethod has invalid value $ExternalClientAuthenticationMethod. Valid values are 'Basic','Negotiate','Ntlm'"
    }
}


If ($InternalClientAuthenticationMethod)
{
    If (('Basic','Negotiate','Ntlm') -contains $InternalClientAuthenticationMethod ) {
    }
    Else
    {
...
$DscResourceName = "xExchOutlookAnywhere"
