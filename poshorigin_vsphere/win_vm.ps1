...
#ATTRIBUTE:Tags;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Tags = Get-Attr -obj $params -name Tags -failifempty $False -resultobj $result
...
#ATTRIBUTE:UpdateTools;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UpdateTools = Get-Attr -obj $params -name UpdateTools -failifempty $False -resultobj $result
...
$DscModuleName = "poshorigin_vsphere"
