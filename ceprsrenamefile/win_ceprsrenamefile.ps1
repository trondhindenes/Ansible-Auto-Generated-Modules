...
#ATTRIBUTE:NewFileName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$NewFileName = Get-Attr -obj $params -name NewFileName -failifempty $True -resultobj $result
#ATTRIBUTE:OldFileName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$OldFileName = Get-Attr -obj $params -name OldFileName -failifempty $True -resultobj $result
...
$DscResourceName = "cEPRSRenameFile"

$DscModuleName = "ceprsrenamefile"
