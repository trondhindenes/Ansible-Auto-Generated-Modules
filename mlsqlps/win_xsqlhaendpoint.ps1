...
#ATTRIBUTE:AllowedUser;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowedUser = Get-Attr -obj $params -name AllowedUser -failifempty $True -resultobj $result
...
#ATTRIBUTE:PortNumber;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PortNumber = Get-Attr -obj $params -name PortNumber -failifempty $False -resultobj $result
...
$DscResourceName = "xSqlHAEndPoint"
