...
#ATTRIBUTE:ServiceCredential_username;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ServiceCredential_username = Get-Attr -obj $params -name ServiceCredential_username -failifempty $True -resultobj $result
#ATTRIBUTE:ServiceCredential_password;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ServiceCredential_password = Get-Attr -obj $params -name ServiceCredential_password -failifempty $True -resultobj $result
...
if ($ServiceCredential_username)
{
$ServiceCredential_securepassword = $ServiceCredential_password | ConvertTo-SecureString -asPlainText -Force
$ServiceCredential = New-Object System.Management.Automation.PSCredential($ServiceCredential_username,$ServiceCredential_securepassword)
}
