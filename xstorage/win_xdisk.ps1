...
#ATTRIBUTE:DiskNumber;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DiskNumber = Get-Attr -obj $params -name DiskNumber -failifempty $True -resultobj $result
#ATTRIBUTE:DriveLetter;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DriveLetter = Get-Attr -obj $params -name DriveLetter -failifempty $True -resultobj $result
#ATTRIBUTE:AllocationUnitSize;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllocationUnitSize = Get-Attr -obj $params -name AllocationUnitSize -failifempty $False -resultobj $result
#ATTRIBUTE:FSLabel;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FSLabel = Get-Attr -obj $params -name FSLabel -failifempty $False -resultobj $result
...
#ATTRIBUTE:Size;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Size = Get-Attr -obj $params -name Size -failifempty $False -resultobj $result
...
$DscResourceName = "xDisk"

$DscModuleName = "xstorage"
