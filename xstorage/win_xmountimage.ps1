...
#ATTRIBUTE:ImagePath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ImagePath = Get-Attr -obj $params -name ImagePath -failifempty $True -resultobj $result
#ATTRIBUTE:Name;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Name = Get-Attr -obj $params -name Name -failifempty $True -resultobj $result
#ATTRIBUTE:DriveLetter;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DriveLetter = Get-Attr -obj $params -name DriveLetter -failifempty $False -resultobj $result
