...
#ATTRIBUTE:Information;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Information = Get-Attr -obj $params -name Information -failifempty $True -resultobj $result
#ATTRIBUTE:Protocol;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
...
$DscResourceName = "xIISWebBinding"

$DscModuleName = "xiiswebbinding"
