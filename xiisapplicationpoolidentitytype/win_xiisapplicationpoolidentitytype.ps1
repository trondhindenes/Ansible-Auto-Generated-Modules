...
#ATTRIBUTE:IdentityType;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:ApplicationPoolIdentity,LocalService,LocalSystem,NetworkService,SpecificUser
$IdentityType = Get-Attr -obj $params -name IdentityType -failifempty $True -resultobj $result
#ATTRIBUTE:Pool;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Pool = Get-Attr -obj $params -name Pool -failifempty $True -resultobj $result
#ATTRIBUTE:Identity_username;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Identity_username = Get-Attr -obj $params -name Identity_username -failifempty $False -resultobj $result
#ATTRIBUTE:Identity_password;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Identity_password = Get-Attr -obj $params -name Identity_password -failifempty $False -resultobj $result
...
{
$Identity_securepassword = $Identity_password | ConvertTo-SecureString -asPlainText -Force
$Identity = New-Object System.Management.Automation.PSCredential($Identity_username,$Identity_securepassword)
}
...
$DscResourceName = "xIISApplicationPoolIdentityType"

$DscModuleName = "xiisapplicationpoolidentitytype"
