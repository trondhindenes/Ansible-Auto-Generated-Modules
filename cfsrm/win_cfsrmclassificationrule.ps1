...
#ATTRIBUTE:ClassificationMechanism;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ClassificationMechanism = Get-Attr -obj $params -name ClassificationMechanism -failifempty $False -resultobj $result
#ATTRIBUTE:ContentRegularExpression;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ContentRegularExpression = Get-Attr -obj $params -name ContentRegularExpression -failifempty $False -resultobj $result
#ATTRIBUTE:ContentString;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ContentString = Get-Attr -obj $params -name ContentString -failifempty $False -resultobj $result
#ATTRIBUTE:ContentStringCaseSensitive;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ContentStringCaseSensitive = Get-Attr -obj $params -name ContentStringCaseSensitive -failifempty $False -resultobj $result
...
$Disabled = Get-Attr -obj $params -name Disabled -failifempty $False -resultobj $result
#ATTRIBUTE:Ensure;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Absent,Present
$Ensure = Get-Attr -obj $params -name Ensure -failifempty $False -resultobj $result
#ATTRIBUTE:Flags;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Flags = Get-Attr -obj $params -name Flags -failifempty $False -resultobj $result
#ATTRIBUTE:Namespace;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Namespace = Get-Attr -obj $params -name Namespace -failifempty $False -resultobj $result
#ATTRIBUTE:Parameters;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Parameters = Get-Attr -obj $params -name Parameters -failifempty $False -resultobj $result
#ATTRIBUTE:Property;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Property = Get-Attr -obj $params -name Property -failifempty $False -resultobj $result
#ATTRIBUTE:PropertyValue;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PropertyValue = Get-Attr -obj $params -name PropertyValue -failifempty $False -resultobj $result
...
#ATTRIBUTE:ReevaluateProperty;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Aggregate,Never,Overwrite
$ReevaluateProperty = Get-Attr -obj $params -name ReevaluateProperty -failifempty $False -resultobj $result
...
{
    If (('Aggregate','Never','Overwrite') -contains $ReevaluateProperty ) {
    }
    Else
    {
        Fail-Json $result "Option ReevaluateProperty has invalid value $ReevaluateProperty. Valid values are 'Aggregate','Never','Overwrite'"
    }
}
...
$DscResourceName = "cFSRMClassificationRule"
