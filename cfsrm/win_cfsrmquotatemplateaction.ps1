...
#ATTRIBUTE:Percentage;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Percentage = Get-Attr -obj $params -name Percentage -failifempty $True -resultobj $result
#ATTRIBUTE:Type;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Command,Email,Event,Report
$Type = Get-Attr -obj $params -name Type -failifempty $True -resultobj $result
#ATTRIBUTE:Body;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Body = Get-Attr -obj $params -name Body -failifempty $False -resultobj $result
...
#ATTRIBUTE:CommandParameters;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CommandParameters = Get-Attr -obj $params -name CommandParameters -failifempty $False -resultobj $result
#ATTRIBUTE:Ensure;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Absent,Present
$Ensure = Get-Attr -obj $params -name Ensure -failifempty $False -resultobj $result
#ATTRIBUTE:EventType;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Error,Information,None,Warning
$EventType = Get-Attr -obj $params -name EventType -failifempty $False -resultobj $result
#ATTRIBUTE:KillTimeOut;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$KillTimeOut = Get-Attr -obj $params -name KillTimeOut -failifempty $False -resultobj $result
#ATTRIBUTE:MailBCC;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MailBCC = Get-Attr -obj $params -name MailBCC -failifempty $False -resultobj $result
#ATTRIBUTE:MailCC;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MailCC = Get-Attr -obj $params -name MailCC -failifempty $False -resultobj $result
#ATTRIBUTE:MailTo;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MailTo = Get-Attr -obj $params -name MailTo -failifempty $False -resultobj $result
...
#ATTRIBUTE:ReportTypes;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ReportTypes = Get-Attr -obj $params -name ReportTypes -failifempty $False -resultobj $result
#ATTRIBUTE:RunLimitInterval;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RunLimitInterval = Get-Attr -obj $params -name RunLimitInterval -failifempty $False -resultobj $result
#ATTRIBUTE:SecurityLevel;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:LocalService,LocalSystem,NetworkService,None
$SecurityLevel = Get-Attr -obj $params -name SecurityLevel -failifempty $False -resultobj $result
#ATTRIBUTE:ShouldLogError;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ShouldLogError = Get-Attr -obj $params -name ShouldLogError -failifempty $False -resultobj $result
...
If ($Type)
{
    If (('Command','Email','Event','Report') -contains $Type ) {
    }
    Else
    {
        Fail-Json $result "Option Type has invalid value $Type. Valid values are 'Command','Email','Event','Report'"
    }
}
...
If ($EventType)
{
    If (('Error','Information','None','Warning') -contains $EventType ) {
    }
    Else
    {
        Fail-Json $result "Option EventType has invalid value $EventType. Valid values are 'Error','Information','None','Warning'"
    }
}
...
If ($SecurityLevel)
{
    If (('LocalService','LocalSystem','NetworkService','None') -contains $SecurityLevel ) {
    }
    Else
    {
        Fail-Json $result "Option SecurityLevel has invalid value $SecurityLevel. Valid values are 'LocalService','LocalSystem','NetworkService','None'"
    }
}
...
$DscResourceName = "cFSRMQuotaTemplateAction"
