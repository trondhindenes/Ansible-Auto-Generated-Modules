...
#ATTRIBUTE:Active;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Active = Get-Attr -obj $params -name Active -failifempty $False -resultobj $result
...
#ATTRIBUTE:IncludeGroup;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IncludeGroup = Get-Attr -obj $params -name IncludeGroup -failifempty $False -resultobj $result
...
$DscResourceName = "cFSRMFileScreen"
