...
#ATTRIBUTE:ExcludePattern;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ExcludePattern = Get-Attr -obj $params -name ExcludePattern -failifempty $False -resultobj $result
#ATTRIBUTE:IncludePattern;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IncludePattern = Get-Attr -obj $params -name IncludePattern -failifempty $False -resultobj $result
...
$DscResourceName = "cFSRMFileGroup"
