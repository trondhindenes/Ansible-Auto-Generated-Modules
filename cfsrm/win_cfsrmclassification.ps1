...
#ATTRIBUTE:Id;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Id = Get-Attr -obj $params -name Id -failifempty $True -resultobj $result
#ATTRIBUTE:Continuous;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Continuous = Get-Attr -obj $params -name Continuous -failifempty $False -resultobj $result
#ATTRIBUTE:ContinuousLog;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ContinuousLog = Get-Attr -obj $params -name ContinuousLog -failifempty $False -resultobj $result
#ATTRIBUTE:ContinuousLogSize;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ContinuousLogSize = Get-Attr -obj $params -name ContinuousLogSize -failifempty $False -resultobj $result
#ATTRIBUTE:ExcludeNamespace;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ExcludeNamespace = Get-Attr -obj $params -name ExcludeNamespace -failifempty $False -resultobj $result
...
#ATTRIBUTE:ScheduleMonthly;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ScheduleMonthly = Get-Attr -obj $params -name ScheduleMonthly -failifempty $False -resultobj $result
#ATTRIBUTE:ScheduleRunDuration;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ScheduleRunDuration = Get-Attr -obj $params -name ScheduleRunDuration -failifempty $False -resultobj $result
#ATTRIBUTE:ScheduleTime;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ScheduleTime = Get-Attr -obj $params -name ScheduleTime -failifempty $False -resultobj $result
#ATTRIBUTE:ScheduleWeekly;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ScheduleWeekly = Get-Attr -obj $params -name ScheduleWeekly -failifempty $False -resultobj $result
...
$DscResourceName = "cFSRMClassification"
