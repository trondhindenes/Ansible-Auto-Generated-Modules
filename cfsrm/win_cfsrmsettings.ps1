...
#ATTRIBUTE:AdminEmailAddress;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AdminEmailAddress = Get-Attr -obj $params -name AdminEmailAddress -failifempty $False -resultobj $result
#ATTRIBUTE:CommandNotificationLimit;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CommandNotificationLimit = Get-Attr -obj $params -name CommandNotificationLimit -failifempty $False -resultobj $result
#ATTRIBUTE:EmailNotificationLimit;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EmailNotificationLimit = Get-Attr -obj $params -name EmailNotificationLimit -failifempty $False -resultobj $result
#ATTRIBUTE:EventNotificationLimit;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EventNotificationLimit = Get-Attr -obj $params -name EventNotificationLimit -failifempty $False -resultobj $result
#ATTRIBUTE:FromEmailAddress;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FromEmailAddress = Get-Attr -obj $params -name FromEmailAddress -failifempty $False -resultobj $result
...
#ATTRIBUTE:SmtpServer;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SmtpServer = Get-Attr -obj $params -name SmtpServer -failifempty $False -resultobj $result
