...
#ATTRIBUTE:PropertyName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PropertyName = Get-Attr -obj $params -name PropertyName -failifempty $True -resultobj $result
...
$DscResourceName = "cFSRMClassificationPropertyValue"
