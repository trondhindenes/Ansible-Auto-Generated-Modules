...
#ATTRIBUTE:MatchesTemplate;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MatchesTemplate = Get-Attr -obj $params -name MatchesTemplate -failifempty $False -resultobj $result
...
#ATTRIBUTE:SoftLimit;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SoftLimit = Get-Attr -obj $params -name SoftLimit -failifempty $False -resultobj $result
...
#ATTRIBUTE:ThresholdPercentages;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ThresholdPercentages = Get-Attr -obj $params -name ThresholdPercentages -failifempty $False -resultobj $result
