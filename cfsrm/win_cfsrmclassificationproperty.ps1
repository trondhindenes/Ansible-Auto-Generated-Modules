...
#ATTRIBUTE:Type;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:DateTime,Integer,MultiChoice,MultiString,OrderedList,SingleChoice,String,YesNo
...
#ATTRIBUTE:PossibleValue;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PossibleValue = Get-Attr -obj $params -name PossibleValue -failifempty $False -resultobj $result
...
If ($Type)
{
    If (('DateTime','Integer','MultiChoice','MultiString','OrderedList','SingleChoice','String','YesNo') -contains $Type ) {
    }
    Else
    {
        Fail-Json $result "Option Type has invalid value $Type. Valid values are 'DateTime','Integer','MultiChoice','MultiString','OrderedList','SingleChoice','String','YesNo'"
    }
}
...
$DscResourceName = "cFSRMClassificationProperty"
