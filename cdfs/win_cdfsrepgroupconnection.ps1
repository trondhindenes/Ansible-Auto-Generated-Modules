...
#ATTRIBUTE:DisableConnection;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DisableConnection = Get-Attr -obj $params -name DisableConnection -failifempty $False -resultobj $result
#ATTRIBUTE:DisableRDC;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DisableRDC = Get-Attr -obj $params -name DisableRDC -failifempty $False -resultobj $result
...
$DscResourceName = "cDFSRepGroupConnection"
