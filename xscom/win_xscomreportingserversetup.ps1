...
#ATTRIBUTE:SRSInstance;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SRSInstance = Get-Attr -obj $params -name SRSInstance -failifempty $True -resultobj $result
...
$DscResourceName = "xSCOMReportingServerSetup"
