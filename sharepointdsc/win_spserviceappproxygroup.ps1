...
$ServiceAppProxies = Get-Attr -obj $params -name ServiceAppProxies -failifempty $False -resultobj $result
#ATTRIBUTE:ServiceAppProxiesToExclude;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ServiceAppProxiesToExclude = Get-Attr -obj $params -name ServiceAppProxiesToExclude -failifempty $False -resultobj $result
#ATTRIBUTE:ServiceAppProxiesToInclude;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ServiceAppProxiesToInclude = Get-Attr -obj $params -name ServiceAppProxiesToInclude -failifempty $False -resultobj $result
