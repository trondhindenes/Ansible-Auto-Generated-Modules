...
$CloudIndex = Get-Attr -obj $params -name CloudIndex -failifempty $False -resultobj $result
...
$SearchCenterUrl = Get-Attr -obj $params -name SearchCenterUrl -failifempty $False -resultobj $result
