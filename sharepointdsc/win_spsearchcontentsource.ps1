...
$Addresses = Get-Attr -obj $params -name Addresses -failifempty $True -resultobj $result
#ATTRIBUTE:ContentSourceType;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:FileShare,SharePoint,Website
$ContentSourceType = Get-Attr -obj $params -name ContentSourceType -failifempty $True -resultobj $result
#ATTRIBUTE:CrawlSetting;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:CrawlEverything,CrawlFirstOnly,Custom
$CrawlSetting = Get-Attr -obj $params -name CrawlSetting -failifempty $True -resultobj $result
...
$ServiceAppName = Get-Attr -obj $params -name ServiceAppName -failifempty $True -resultobj $result
#ATTRIBUTE:ContinuousCrawl;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ContinuousCrawl = Get-Attr -obj $params -name ContinuousCrawl -failifempty $False -resultobj $result
...
$FullSchedule = Get-Attr -obj $params -name FullSchedule -failifempty $False -resultobj $result
#ATTRIBUTE:IncrementalSchedule;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IncrementalSchedule = Get-Attr -obj $params -name IncrementalSchedule -failifempty $False -resultobj $result
...
$LimitPageDepth = Get-Attr -obj $params -name LimitPageDepth -failifempty $False -resultobj $result
#ATTRIBUTE:LimitServerHops;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LimitServerHops = Get-Attr -obj $params -name LimitServerHops -failifempty $False -resultobj $result
#ATTRIBUTE:Priority;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:High,Normal
$Priority = Get-Attr -obj $params -name Priority -failifempty $False -resultobj $result
