...
$Account_username = Get-Attr -obj $params -name Account_username -failifempty $False -resultobj $result
#ATTRIBUTE:Account_password;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Account_password = Get-Attr -obj $params -name Account_password -failifempty $False -resultobj $result
