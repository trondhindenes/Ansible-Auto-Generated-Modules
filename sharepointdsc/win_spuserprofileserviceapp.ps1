...
$EnableNetBIOS = Get-Attr -obj $params -name EnableNetBIOS -failifempty $False -resultobj $result
...
$FarmAccount_username = Get-Attr -obj $params -name FarmAccount_username -failifempty $False -resultobj $result
#ATTRIBUTE:FarmAccount_password;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FarmAccount_password = Get-Attr -obj $params -name FarmAccount_password -failifempty $False -resultobj $result
