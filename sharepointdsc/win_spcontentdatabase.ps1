...
$MaximumSiteCount = Get-Attr -obj $params -name MaximumSiteCount -failifempty $False -resultobj $result
...
$WarningSiteCount = Get-Attr -obj $params -name WarningSiteCount -failifempty $False -resultobj $result
