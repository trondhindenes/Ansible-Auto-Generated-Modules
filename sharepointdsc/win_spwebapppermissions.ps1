...
$AllPermissions = Get-Attr -obj $params -name AllPermissions -failifempty $False -resultobj $result
...
$ListPermissions = Get-Attr -obj $params -name ListPermissions -failifempty $False -resultobj $result
...
$PersonalPermissions = Get-Attr -obj $params -name PersonalPermissions -failifempty $False -resultobj $result
...
$SitePermissions = Get-Attr -obj $params -name SitePermissions -failifempty $False -resultobj $result
