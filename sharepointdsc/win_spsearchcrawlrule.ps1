...
$AuthenticationCredentials_username = Get-Attr -obj $params -name AuthenticationCredentials_username -failifempty $False -resultobj $result
#ATTRIBUTE:AuthenticationCredentials_password;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AuthenticationCredentials_password = Get-Attr -obj $params -name AuthenticationCredentials_password -failifempty $False -resultobj $result
...
$CrawlConfigurationRules = Get-Attr -obj $params -name CrawlConfigurationRules -failifempty $False -resultobj $result
...
$RuleType = Get-Attr -obj $params -name RuleType -failifempty $False -resultobj $result
