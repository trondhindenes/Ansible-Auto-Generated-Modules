...
$UserProfileServiceAppName = Get-Attr -obj $params -name UserProfileServiceAppName -failifempty $True -resultobj $result
...
$RunOnlyWhenWriteable = Get-Attr -obj $params -name RunOnlyWhenWriteable -failifempty $False -resultobj $result
