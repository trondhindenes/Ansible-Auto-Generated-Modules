...
$EnableCache = Get-Attr -obj $params -name EnableCache -failifempty $True -resultobj $result
...
$FileTypes = Get-Attr -obj $params -name FileTypes -failifempty $False -resultobj $result
...
$MaxAgeInSeconds = Get-Attr -obj $params -name MaxAgeInSeconds -failifempty $False -resultobj $result
#ATTRIBUTE:MaxSizeInGB;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MaxSizeInGB = Get-Attr -obj $params -name MaxSizeInGB -failifempty $False -resultobj $result
