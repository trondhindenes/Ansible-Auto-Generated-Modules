...
$DatabaseUpgradeDays = Get-Attr -obj $params -name DatabaseUpgradeDays -failifempty $False -resultobj $result
#ATTRIBUTE:DatabaseUpgradeTime;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DatabaseUpgradeTime = Get-Attr -obj $params -name DatabaseUpgradeTime -failifempty $False -resultobj $result
