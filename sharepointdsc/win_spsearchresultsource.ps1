...
$ProviderType = Get-Attr -obj $params -name ProviderType -failifempty $True -resultobj $result
#ATTRIBUTE:Query;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Query = Get-Attr -obj $params -name Query -failifempty $True -resultobj $result
#ATTRIBUTE:SearchServiceAppName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SearchServiceAppName = Get-Attr -obj $params -name SearchServiceAppName -failifempty $True -resultobj $result
#ATTRIBUTE:ConnectionUrl;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ConnectionUrl = Get-Attr -obj $params -name ConnectionUrl -failifempty $False -resultobj $result
