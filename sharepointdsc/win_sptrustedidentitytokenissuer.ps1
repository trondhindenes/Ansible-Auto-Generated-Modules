...
$ClaimsMappings = Get-Attr -obj $params -name ClaimsMappings -failifempty $True -resultobj $result
#ATTRIBUTE:Description;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Description = Get-Attr -obj $params -name Description -failifempty $True -resultobj $result
#ATTRIBUTE:IdentifierClaim;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IdentifierClaim = Get-Attr -obj $params -name IdentifierClaim -failifempty $True -resultobj $result
...
$Realm = Get-Attr -obj $params -name Realm -failifempty $True -resultobj $result
#ATTRIBUTE:SigningCertificateThumbPrint;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SigningCertificateThumbPrint = Get-Attr -obj $params -name SigningCertificateThumbPrint -failifempty $True -resultobj $result
#ATTRIBUTE:SignInUrl;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SignInUrl = Get-Attr -obj $params -name SignInUrl -failifempty $True -resultobj $result
#ATTRIBUTE:ClaimProviderName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ClaimProviderName = Get-Attr -obj $params -name ClaimProviderName -failifempty $False -resultobj $result
...
$ProviderSignOutUri = Get-Attr -obj $params -name ProviderSignOutUri -failifempty $False -resultobj $result
