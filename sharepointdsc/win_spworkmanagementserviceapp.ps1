...
$MinimumTimeBetweenEwsSyncSubscriptionSearches = Get-Attr -obj $params -name MinimumTimeBetweenEwsSyncSubscriptionSearches -failifempty $False -resultobj $result
#ATTRIBUTE:MinimumTimeBetweenProviderRefreshes;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MinimumTimeBetweenProviderRefreshes = Get-Attr -obj $params -name MinimumTimeBetweenProviderRefreshes -failifempty $False -resultobj $result
#ATTRIBUTE:MinimumTimeBetweenSearchQueries;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MinimumTimeBetweenSearchQueries = Get-Attr -obj $params -name MinimumTimeBetweenSearchQueries -failifempty $False -resultobj $result
#ATTRIBUTE:NumberOfSubscriptionSyncsPerEwsSyncRun;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$NumberOfSubscriptionSyncsPerEwsSyncRun = Get-Attr -obj $params -name NumberOfSubscriptionSyncsPerEwsSyncRun -failifempty $False -resultobj $result
#ATTRIBUTE:NumberOfUsersEwsSyncWillProcessAtOnce;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$NumberOfUsersEwsSyncWillProcessAtOnce = Get-Attr -obj $params -name NumberOfUsersEwsSyncWillProcessAtOnce -failifempty $False -resultobj $result
#ATTRIBUTE:NumberOfUsersPerEwsSyncBatch;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$NumberOfUsersPerEwsSyncBatch = Get-Attr -obj $params -name NumberOfUsersPerEwsSyncBatch -failifempty $False -resultobj $result
#ATTRIBUTE:ProxyName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ProxyName = Get-Attr -obj $params -name ProxyName -failifempty $False -resultobj $result
