...
$CreatePersonalSite = Get-Attr -obj $params -name CreatePersonalSite -failifempty $True -resultobj $result
#ATTRIBUTE:FollowAndEditProfile;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FollowAndEditProfile = Get-Attr -obj $params -name FollowAndEditProfile -failifempty $True -resultobj $result
#ATTRIBUTE:ProxyName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ProxyName = Get-Attr -obj $params -name ProxyName -failifempty $True -resultobj $result
#ATTRIBUTE:UseTagsAndNotes;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UseTagsAndNotes = Get-Attr -obj $params -name UseTagsAndNotes -failifempty $True -resultobj $result
