...
$LocalWebAppUrl = Get-Attr -obj $params -name LocalWebAppUrl -failifempty $True -resultobj $result
...
$RemoteWebAppUrl = Get-Attr -obj $params -name RemoteWebAppUrl -failifempty $True -resultobj $result
