...
$SetupFile = Get-Attr -obj $params -name SetupFile -failifempty $True -resultobj $result
#ATTRIBUTE:BinaryInstallDays;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:fri,mon,sat,sun,thu,tue,wed
$BinaryInstallDays = Get-Attr -obj $params -name BinaryInstallDays -failifempty $False -resultobj $result
#ATTRIBUTE:BinaryInstallTime;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$BinaryInstallTime = Get-Attr -obj $params -name BinaryInstallTime -failifempty $False -resultobj $result
...
$ShutdownServices = Get-Attr -obj $params -name ShutdownServices -failifempty $False -resultobj $result
