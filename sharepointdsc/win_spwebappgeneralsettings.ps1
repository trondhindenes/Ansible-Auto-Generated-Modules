...
$Alerts = Get-Attr -obj $params -name Alerts -failifempty $False -resultobj $result
#ATTRIBUTE:AlertsLimit;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AlertsLimit = Get-Attr -obj $params -name AlertsLimit -failifempty $False -resultobj $result
#ATTRIBUTE:AllowOnlineWebPartCatalog;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowOnlineWebPartCatalog = Get-Attr -obj $params -name AllowOnlineWebPartCatalog -failifempty $False -resultobj $result
#ATTRIBUTE:BlogAPI;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$BlogAPI = Get-Attr -obj $params -name BlogAPI -failifempty $False -resultobj $result
#ATTRIBUTE:BlogAPIAuthenticated;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$BlogAPIAuthenticated = Get-Attr -obj $params -name BlogAPIAuthenticated -failifempty $False -resultobj $result
#ATTRIBUTE:BrowserFileHandling;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Permissive,Strict
$BrowserFileHandling = Get-Attr -obj $params -name BrowserFileHandling -failifempty $False -resultobj $result
#ATTRIBUTE:CustomerExperienceProgram;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CustomerExperienceProgram = Get-Attr -obj $params -name CustomerExperienceProgram -failifempty $False -resultobj $result
...
$InstallAccount_password = Get-Attr -obj $params -name InstallAccount_password -failifempty $False -resultobj $result
#ATTRIBUTE:MaximumUploadSize;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MaximumUploadSize = Get-Attr -obj $params -name MaximumUploadSize -failifempty $False -resultobj $result
#ATTRIBUTE:PresenceEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PresenceEnabled = Get-Attr -obj $params -name PresenceEnabled -failifempty $False -resultobj $result
...
$RecycleBinCleanupEnabled = Get-Attr -obj $params -name RecycleBinCleanupEnabled -failifempty $False -resultobj $result
#ATTRIBUTE:RecycleBinEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RecycleBinEnabled = Get-Attr -obj $params -name RecycleBinEnabled -failifempty $False -resultobj $result
#ATTRIBUTE:RecycleBinRetentionPeriod;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RecycleBinRetentionPeriod = Get-Attr -obj $params -name RecycleBinRetentionPeriod -failifempty $False -resultobj $result
#ATTRIBUTE:RSS;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RSS = Get-Attr -obj $params -name RSS -failifempty $False -resultobj $result
#ATTRIBUTE:SecondStageRecycleBinQuota;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SecondStageRecycleBinQuota = Get-Attr -obj $params -name SecondStageRecycleBinQuota -failifempty $False -resultobj $result
#ATTRIBUTE:SecurityValidation;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SecurityValidation = Get-Attr -obj $params -name SecurityValidation -failifempty $False -resultobj $result
#ATTRIBUTE:SecurityValidationExpires;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SecurityValidationExpires = Get-Attr -obj $params -name SecurityValidationExpires -failifempty $False -resultobj $result
#ATTRIBUTE:SecurityValidationTimeOutMinutes;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SecurityValidationTimeOutMinutes = Get-Attr -obj $params -name SecurityValidationTimeOutMinutes -failifempty $False -resultobj $result
#ATTRIBUTE:SelfServiceSiteCreationEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SelfServiceSiteCreationEnabled = Get-Attr -obj $params -name SelfServiceSiteCreationEnabled -failifempty $False -resultobj $result
#ATTRIBUTE:TimeZone;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TimeZone = Get-Attr -obj $params -name TimeZone -failifempty $False -resultobj $result
