...
$AddToQuickLaunch = Get-Attr -obj $params -name AddToQuickLaunch -failifempty $False -resultobj $result
#ATTRIBUTE:AddToTopNav;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AddToTopNav = Get-Attr -obj $params -name AddToTopNav -failifempty $False -resultobj $result
...
$UniquePermissions = Get-Attr -obj $params -name UniquePermissions -failifempty $False -resultobj $result
#ATTRIBUTE:UseParentTopNav;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UseParentTopNav = Get-Attr -obj $params -name UseParentTopNav -failifempty $False -resultobj $result
