...
$RMSserver = Get-Attr -obj $params -name RMSserver -failifempty $False -resultobj $result
#ATTRIBUTE:UseADRMS;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UseADRMS = Get-Attr -obj $params -name UseADRMS -failifempty $False -resultobj $result
