...
#ATTRIBUTE:Access;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
...
#ATTRIBUTE:NoInherit;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$NoInherit = Get-Attr -obj $params -name NoInherit -failifempty $False -resultobj $result
...
#ATTRIBUTE:Rights;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
...
$DscResourceName = "cEPRSFolderPermissions"

$DscModuleName = "ceprsfolderpermissions"
