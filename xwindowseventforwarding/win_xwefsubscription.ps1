...
If ($SubscriptionType)
{
    ...
    Else
    {
        Fail-Json $result "Option SubscriptionType has invalid value $SubscriptionType. Valid values are 'CollectorInitiated','SourceInitiated'"
    }
}
...
If ($CredentialsType)
{
    If (('Basic','Default','Digest','Negotiate') -contains $CredentialsType ) {
    }
    Else
    {
        Fail-Json $result "Option CredentialsType has invalid value $CredentialsType. Valid values are 'Basic','Default','Digest','Negotiate'"
    }
}
...
If ($DeliveryMode)
{
    If (('Pull','Push') -contains $DeliveryMode ) {
    }
    Else
    {
        Fail-Json $result "Option DeliveryMode has invalid value $DeliveryMode. Valid values are 'Pull','Push'"
    }
}
...
{
    If (('false','true') -contains $ReadExistingEvents ) {
    }
    Else
    {
        Fail-Json $result "Option ReadExistingEvents has invalid value $ReadExistingEvents. Valid values are 'false','true'"
    }
}
...
If ($TransportName)
{
    If (('HTTP','HTTPS') -contains $TransportName ) {
    }
    Else
    {
...
$DscResourceName = "xWEFSubscription"

$DscModuleName = "xwindowseventforwarding"
