...
#ATTRIBUTE:DirverName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DirverName = Get-Attr -obj $params -name DirverName -failifempty $True -resultobj $result
...
#ATTRIBUTE:PortIP;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PortIP = Get-Attr -obj $params -name PortIP -failifempty $True -resultobj $result
#ATTRIBUTE:PrinterName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PrinterName = Get-Attr -obj $params -name PrinterName -failifempty $True -resultobj $result
#ATTRIBUTE:PrinterPort;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PrinterPort = Get-Attr -obj $params -name PrinterPort -failifempty $True -resultobj $result
...
$DscResourceName = "xPrinter"

$DscModuleName = "xprinter"
