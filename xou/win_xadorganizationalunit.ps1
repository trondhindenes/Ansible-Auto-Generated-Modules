...
#ATTRIBUTE:ProtectedFromAccidentalDeletion;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:No,Yes
...
{
    If (('No','Yes') -contains $ProtectedFromAccidentalDeletion ) {
    }
    Else
    {
        Fail-Json $result "Option ProtectedFromAccidentalDeletion has invalid value $ProtectedFromAccidentalDeletion. Valid values are 'No','Yes'"
    }
}
