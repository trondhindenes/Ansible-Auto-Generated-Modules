...
$SCOMAdminCredential = New-Object System.Management.Automation.PSCredential($SCOMAdminCredential_username,$SCOMAdminCredential_securepassword)
}

$DscResourceName = "xSCOMManagementPack"
