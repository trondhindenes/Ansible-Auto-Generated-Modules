...
#ATTRIBUTE:ServiceCredential_username;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ServiceCredential_username = Get-Attr -obj $params -name ServiceCredential_username -failifempty $False -resultobj $result
#ATTRIBUTE:ServiceCredential_password;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ServiceCredential_password = Get-Attr -obj $params -name ServiceCredential_password -failifempty $False -resultobj $result
...
$DscResourceName = "cSABnzbdInstall"

$DscModuleName = "csabnzbd"
