...
$FullName = Get-Attr -obj $params -name FullName -failifempty $False -resultobj $result
...
$PasswordChangeNotAllowed = Get-Attr -obj $params -name PasswordChangeNotAllowed -failifempty $False -resultobj $result
#ATTRIBUTE:PasswordChangeRequired;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PasswordChangeRequired = Get-Attr -obj $params -name PasswordChangeRequired -failifempty $False -resultobj $result
