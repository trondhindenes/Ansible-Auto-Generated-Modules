...
#ATTRIBUTE:BinaryPath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$BinaryPath = Get-Attr -obj $params -name BinaryPath -failifempty $True -resultobj $result
...
#ATTRIBUTE:ExeName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ExeName = Get-Attr -obj $params -name ExeName -failifempty $True -resultobj $result
#ATTRIBUTE:LogOnAccount;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LogOnAccount = Get-Attr -obj $params -name LogOnAccount -failifempty $True -resultobj $result
...
#ATTRIBUTE:StartupType;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$StartupType = Get-Attr -obj $params -name StartupType -failifempty $True -resultobj $result
...
#ATTRIBUTE:Domain;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Domain = Get-Attr -obj $params -name Domain -failifempty $False -resultobj $result
...
$DscResourceName = "cEprsCreateWindowsService"
