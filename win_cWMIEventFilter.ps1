...
#ATTRIBUTE:Query,MANDATORY:True,DEFAULTVALUE:,DESCRIPTION:
...
#ATTRIBUTE:EventNamespace,MANDATORY:False,DEFAULTVALUE:,DESCRIPTION:
$EventNamespace = Get-Attr -obj $params -name EventNamespace -failifempty $False -resultobj $result
...
$DscResourceName = "cWMIEventFilter"
