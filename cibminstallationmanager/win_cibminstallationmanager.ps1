...
#ATTRIBUTE:TempDir;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TempDir = Get-Attr -obj $params -name TempDir -failifempty $False -resultobj $result
...
$DscResourceName = "cIBMInstallationManager"
