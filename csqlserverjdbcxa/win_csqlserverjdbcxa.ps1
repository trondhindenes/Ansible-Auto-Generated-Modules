...
#ATTRIBUTE:Version;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:v2008,v2012,v2014
...
#ATTRIBUTE:SQLServerPort;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SQLServerPort = Get-Attr -obj $params -name SQLServerPort -failifempty $False -resultobj $result
...
If ($Version)
{
    If (('v2008','v2012','v2014') -contains $Version ) {
    }
    Else
    {
        Fail-Json $result "Option Version has invalid value $Version. Valid values are 'v2008','v2012','v2014'"
    }
}
...
$DscResourceName = "cSQLServerJDBCXA"

$DscModuleName = "csqlserverjdbcxa"
