...
#ATTRIBUTE:AdditionalParameters;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AdditionalParameters = Get-Attr -obj $params -name AdditionalParameters -failifempty $False -resultobj $result
...
#ATTRIBUTE:ProviderName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ProviderName = Get-Attr -obj $params -name ProviderName -failifempty $False -resultobj $result
...
$DscResourceName = "PackageManagement"

$DscModuleName = "packagemanagementproviderresource"
