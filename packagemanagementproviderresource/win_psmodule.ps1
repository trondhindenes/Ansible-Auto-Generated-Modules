...
#ATTRIBUTE:Repository;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Repository = Get-Attr -obj $params -name Repository -failifempty $False -resultobj $result
