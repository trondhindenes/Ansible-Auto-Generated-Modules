...
#ATTRIBUTE:InfFilePath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$InfFilePath = Get-Attr -obj $params -name InfFilePath -failifempty $True -resultobj $result
...
$DscResourceName = "cEPRSAddAsLogOnSvc"

$DscModuleName = "ceprsaddaslogonsvc"
