...
#ATTRIBUTE:AdministratorCredential_username;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AdministratorCredential_username = Get-Attr -obj $params -name AdministratorCredential_username -failifempty $True -resultobj $result
#ATTRIBUTE:AdministratorCredential_password;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AdministratorCredential_password = Get-Attr -obj $params -name AdministratorCredential_password -failifempty $True -resultobj $result
#ATTRIBUTE:AdministratorEmail;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AdministratorEmail = Get-Attr -obj $params -name AdministratorEmail -failifempty $True -resultobj $result
#ATTRIBUTE:Title;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Title = Get-Attr -obj $params -name Title -failifempty $True -resultobj $result
#ATTRIBUTE:Uri;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
...
if ($AdministratorCredential_username)
{
$AdministratorCredential_securepassword = $AdministratorCredential_password | ConvertTo-SecureString -asPlainText -Force
$AdministratorCredential = New-Object System.Management.Automation.PSCredential($AdministratorCredential_username,$AdministratorCredential_securepassword)
}
...
$DscResourceName = "xWordPressSite"

$DscModuleName = "xwordpress"
