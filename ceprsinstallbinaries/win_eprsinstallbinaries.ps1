...
#ATTRIBUTE:DLL_Installed;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DLL_Installed = Get-Attr -obj $params -name DLL_Installed -failifempty $True -resultobj $result
#ATTRIBUTE:FrameworkPath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FrameworkPath = Get-Attr -obj $params -name FrameworkPath -failifempty $True -resultobj $result
...
$DscResourceName = "EPRSInstallBinaries"

$DscModuleName = "ceprsinstallbinaries"
