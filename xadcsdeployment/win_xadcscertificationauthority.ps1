...
#ATTRIBUTE:CAType;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:EnterpriseRootCA,EnterpriseSubordinateCA,StandaloneRootCA,StandaloneSubordinateCA
$CAType = Get-Attr -obj $params -name CAType -failifempty $True -resultobj $result
...
#ATTRIBUTE:CACommonName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CACommonName = Get-Attr -obj $params -name CACommonName -failifempty $False -resultobj $result
#ATTRIBUTE:CADistinguishedNameSuffix;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CADistinguishedNameSuffix = Get-Attr -obj $params -name CADistinguishedNameSuffix -failifempty $False -resultobj $result
#ATTRIBUTE:CertFile;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CertFile = Get-Attr -obj $params -name CertFile -failifempty $False -resultobj $result
#ATTRIBUTE:CertFilePassword_username;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CertFilePassword_username = Get-Attr -obj $params -name CertFilePassword_username -failifempty $False -resultobj $result
#ATTRIBUTE:CertFilePassword_password;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CertFilePassword_password = Get-Attr -obj $params -name CertFilePassword_password -failifempty $False -resultobj $result
#ATTRIBUTE:CertificateID;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CertificateID = Get-Attr -obj $params -name CertificateID -failifempty $False -resultobj $result
#ATTRIBUTE:CryptoProviderName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CryptoProviderName = Get-Attr -obj $params -name CryptoProviderName -failifempty $False -resultobj $result
#ATTRIBUTE:DatabaseDirectory;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DatabaseDirectory = Get-Attr -obj $params -name DatabaseDirectory -failifempty $False -resultobj $result
#ATTRIBUTE:Ensure;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Absent,Present
$Ensure = Get-Attr -obj $params -name Ensure -failifempty $False -resultobj $result
#ATTRIBUTE:HashAlgorithmName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$HashAlgorithmName = Get-Attr -obj $params -name HashAlgorithmName -failifempty $False -resultobj $result
#ATTRIBUTE:IgnoreUnicode;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IgnoreUnicode = Get-Attr -obj $params -name IgnoreUnicode -failifempty $False -resultobj $result
#ATTRIBUTE:KeyContainerName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$KeyContainerName = Get-Attr -obj $params -name KeyContainerName -failifempty $False -resultobj $result
#ATTRIBUTE:KeyLength;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$KeyLength = Get-Attr -obj $params -name KeyLength -failifempty $False -resultobj $result
#ATTRIBUTE:LogDirectory;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LogDirectory = Get-Attr -obj $params -name LogDirectory -failifempty $False -resultobj $result
#ATTRIBUTE:OutputCertRequestFile;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$OutputCertRequestFile = Get-Attr -obj $params -name OutputCertRequestFile -failifempty $False -resultobj $result
#ATTRIBUTE:OverwriteExistingCAinDS;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$OverwriteExistingCAinDS = Get-Attr -obj $params -name OverwriteExistingCAinDS -failifempty $False -resultobj $result
#ATTRIBUTE:OverwriteExistingDatabase;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$OverwriteExistingDatabase = Get-Attr -obj $params -name OverwriteExistingDatabase -failifempty $False -resultobj $result
#ATTRIBUTE:OverwriteExistingKey;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$OverwriteExistingKey = Get-Attr -obj $params -name OverwriteExistingKey -failifempty $False -resultobj $result
#ATTRIBUTE:ParentCA;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ParentCA = Get-Attr -obj $params -name ParentCA -failifempty $False -resultobj $result
...
#ATTRIBUTE:ValidityPeriod;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Days,Hours,Months,Years
$ValidityPeriod = Get-Attr -obj $params -name ValidityPeriod -failifempty $False -resultobj $result
#ATTRIBUTE:ValidityPeriodUnits;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ValidityPeriodUnits = Get-Attr -obj $params -name ValidityPeriodUnits -failifempty $False -resultobj $result
...
If ($CAType)
{
    If (('EnterpriseRootCA','EnterpriseSubordinateCA','StandaloneRootCA','StandaloneSubordinateCA') -contains $CAType ) {
    }
    Else
    {
        Fail-Json $result "Option CAType has invalid value $CAType. Valid values are 'EnterpriseRootCA','EnterpriseSubordinateCA','StandaloneRootCA','StandaloneSubordinateCA'"
    }
}
...
If ($ValidityPeriod)
{
    If (('Days','Hours','Months','Years') -contains $ValidityPeriod ) {
    }
    Else
    {
        Fail-Json $result "Option ValidityPeriod has invalid value $ValidityPeriod. Valid values are 'Days','Hours','Months','Years'"
    }
}
...
if ($CertFilePassword_username)
{
$CertFilePassword_securepassword = $CertFilePassword_password | ConvertTo-SecureString -asPlainText -Force
$CertFilePassword = New-Object System.Management.Automation.PSCredential($CertFilePassword_username,$CertFilePassword_securepassword)
}
...
$DscResourceName = "xAdcsCertificationAuthority"

$DscModuleName = "xadcsdeployment"
