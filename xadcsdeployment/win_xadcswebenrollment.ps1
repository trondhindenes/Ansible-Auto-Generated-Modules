...
#ATTRIBUTE:CAConfig;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CAConfig = Get-Attr -obj $params -name CAConfig -failifempty $False -resultobj $result
...
$DscResourceName = "xAdcsWebEnrollment"
