...
#ATTRIBUTE:ActionExecutable;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ActionExecutable = Get-Attr -obj $params -name ActionExecutable -failifempty $True -resultobj $result
#ATTRIBUTE:RepeatInterval;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RepeatInterval = Get-Attr -obj $params -name RepeatInterval -failifempty $True -resultobj $result
#ATTRIBUTE:ScheduleType;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Daily,Hourly,Minutes
$ScheduleType = Get-Attr -obj $params -name ScheduleType -failifempty $True -resultobj $result
...
#ATTRIBUTE:ActionArguments;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
...
$ExecuteAsCredential_username = Get-Attr -obj $params -name ExecuteAsCredential_username -failifempty $False -resultobj $result
#ATTRIBUTE:ExecuteAsCredential_password;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ExecuteAsCredential_password = Get-Attr -obj $params -name ExecuteAsCredential_password -failifempty $False -resultobj $result
...
#ATTRIBUTE:StartTime;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$StartTime = Get-Attr -obj $params -name StartTime -failifempty $False -resultobj $result
...
If ($ScheduleType)
{
    If (('Daily','Hourly','Minutes') -contains $ScheduleType ) {
    }
    Else
    {
        Fail-Json $result "Option ScheduleType has invalid value $ScheduleType. Valid values are 'Daily','Hourly','Minutes'"
    }
}
...
if ($ExecuteAsCredential_username)
{
$ExecuteAsCredential_securepassword = $ExecuteAsCredential_password | ConvertTo-SecureString -asPlainText -Force
$ExecuteAsCredential = New-Object System.Management.Automation.PSCredential($ExecuteAsCredential_username,$ExecuteAsCredential_securepassword)
}
