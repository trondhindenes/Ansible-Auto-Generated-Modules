...
#ATTRIBUTE:RequestFile;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RequestFile = Get-Attr -obj $params -name RequestFile -failifempty $True -resultobj $result
...
$DscResourceName = "xOfflineDomainJoin"
