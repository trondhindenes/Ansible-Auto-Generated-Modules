...
#ATTRIBUTE:DnsHostName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DnsHostName = Get-Attr -obj $params -name DnsHostName -failifempty $False -resultobj $result
...
#ATTRIBUTE:RequestFile;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RequestFile = Get-Attr -obj $params -name RequestFile -failifempty $False -resultobj $result
#ATTRIBUTE:ServicePrincipalNames;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ServicePrincipalNames = Get-Attr -obj $params -name ServicePrincipalNames -failifempty $False -resultobj $result
