...
#ATTRIBUTE:FolderName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FolderName = Get-Attr -obj $params -name FolderName -failifempty $True -resultobj $result
#ATTRIBUTE:FolderType;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Application,Boot Image,Configuration Baseline,Configuration Item,Device Collection,Driver,Driver Package,Image Package,Operating System Installers,Package,Query,Software Metering,State Migration,Task Sequence,User Collection
$FolderType = Get-Attr -obj $params -name FolderType -failifempty $True -resultobj $result
...
If ($FolderType)
{
    If (('Application','Boot Image','Configuration Baseline','Configuration Item','Device Collection','Driver','Driver Package','Image Package','Operating System Installers','Package','Query','Software Metering','State Migration','Task Sequence','User Collection') -contains $FolderType ) {
    }
    Else
    {
        Fail-Json $result "Option FolderType has invalid value $FolderType. Valid values are 'Application','Boot Image','Configuration Baseline','Configuration Item','Device Collection','Driver','Driver Package','Image Package','Operating System Installers','Package','Query','Software Metering','State Migration','Task Sequence','User Collection'"
    }
}
