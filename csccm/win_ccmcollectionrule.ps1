...
#ATTRIBUTE:ParentCollection;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ParentCollection = Get-Attr -obj $params -name ParentCollection -failifempty $True -resultobj $result
...
#ATTRIBUTE:ParentCollectionType;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Device,User
$ParentCollectionType = Get-Attr -obj $params -name ParentCollectionType -failifempty $False -resultobj $result
...
#ATTRIBUTE:QueryExpression;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$QueryExpression = Get-Attr -obj $params -name QueryExpression -failifempty $False -resultobj $result
#ATTRIBUTE:QueryType;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Direct,Exclude,Include,Query
$QueryType = Get-Attr -obj $params -name QueryType -failifempty $False -resultobj $result
...
If ($ParentCollectionType)
{
    If (('Device','User') -contains $ParentCollectionType ) {
    }
    Else
    {
        Fail-Json $result "Option ParentCollectionType has invalid value $ParentCollectionType. Valid values are 'Device','User'"
    }
}
...
If ($QueryType)
{
    If (('Direct','Exclude','Include','Query') -contains $QueryType ) {
    }
    Else
    {
        Fail-Json $result "Option QueryType has invalid value $QueryType. Valid values are 'Direct','Exclude','Include','Query'"
    }
}
...
$DscResourceName = "cCMCollectionRule"
