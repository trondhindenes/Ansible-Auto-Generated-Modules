...
#ATTRIBUTE:SCCMAdministratorCredential_username;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SCCMAdministratorCredential_username = Get-Attr -obj $params -name SCCMAdministratorCredential_username -failifempty $True -resultobj $result
#ATTRIBUTE:SCCMAdministratorCredential_password;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SCCMAdministratorCredential_password = Get-Attr -obj $params -name SCCMAdministratorCredential_password -failifempty $True -resultobj $result
#ATTRIBUTE:CollectionType;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Device,User
$CollectionType = Get-Attr -obj $params -name CollectionType -failifempty $False -resultobj $result
...
#ATTRIBUTE:LimitingCollectionName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LimitingCollectionName = Get-Attr -obj $params -name LimitingCollectionName -failifempty $False -resultobj $result
#ATTRIBUTE:ParentFolder;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ParentFolder = Get-Attr -obj $params -name ParentFolder -failifempty $False -resultobj $result
...
#ATTRIBUTE:RefreshDays;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RefreshDays = Get-Attr -obj $params -name RefreshDays -failifempty $False -resultobj $result
#ATTRIBUTE:RefreshStart;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RefreshStart = Get-Attr -obj $params -name RefreshStart -failifempty $False -resultobj $result
#ATTRIBUTE:RefreshType;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Both,Incremental,Periodic
$RefreshType = Get-Attr -obj $params -name RefreshType -failifempty $False -resultobj $result
...
If ($CollectionType)
{
    If (('Device','User') -contains $CollectionType ) {
    }
    Else
    {
        Fail-Json $result "Option CollectionType has invalid value $CollectionType. Valid values are 'Device','User'"
    }
}
...
If ($RefreshType)
{
    If (('Both','Incremental','Periodic') -contains $RefreshType ) {
    }
    Else
    {
        Fail-Json $result "Option RefreshType has invalid value $RefreshType. Valid values are 'Both','Incremental','Periodic'"
    }
}
...
if ($SCCMAdministratorCredential_username)
{
$SCCMAdministratorCredential_securepassword = $SCCMAdministratorCredential_password | ConvertTo-SecureString -asPlainText -Force
$SCCMAdministratorCredential = New-Object System.Management.Automation.PSCredential($SCCMAdministratorCredential_username,$SCCMAdministratorCredential_securepassword)
}
