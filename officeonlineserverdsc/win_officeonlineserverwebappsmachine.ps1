...
#ATTRIBUTE:MachineToJoin;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MachineToJoin = Get-Attr -obj $params -name MachineToJoin -failifempty $True -resultobj $result
...
#ATTRIBUTE:Roles;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Roles = Get-Attr -obj $params -name Roles -failifempty $False -resultobj $result
...
$DscResourceName = "OfficeOnlineServerWebAppsMachine"
