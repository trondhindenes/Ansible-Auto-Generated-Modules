...
#ATTRIBUTE:AuthenticationLevel;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Incoming,Mutual,NoAuth
$AuthenticationLevel = Get-Attr -obj $params -name AuthenticationLevel -failifempty $True -resultobj $result
...
#ATTRIBUTE:InboundTransactionsEnabled;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$InboundTransactionsEnabled = Get-Attr -obj $params -name InboundTransactionsEnabled -failifempty $True -resultobj $result
...
#ATTRIBUTE:LUTransactionsEnabled;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LUTransactionsEnabled = Get-Attr -obj $params -name LUTransactionsEnabled -failifempty $True -resultobj $result
#ATTRIBUTE:OutboundTransactionsEnabled;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$OutboundTransactionsEnabled = Get-Attr -obj $params -name OutboundTransactionsEnabled -failifempty $True -resultobj $result
#ATTRIBUTE:RemoteAdministrationAccessEnabled;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RemoteAdministrationAccessEnabled = Get-Attr -obj $params -name RemoteAdministrationAccessEnabled -failifempty $True -resultobj $result
#ATTRIBUTE:RemoteClientAccessEnabled;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RemoteClientAccessEnabled = Get-Attr -obj $params -name RemoteClientAccessEnabled -failifempty $True -resultobj $result
#ATTRIBUTE:Status;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Started,Stopped
$Status = Get-Attr -obj $params -name Status -failifempty $True -resultobj $result
#ATTRIBUTE:XATransactionsEnabled;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$XATransactionsEnabled = Get-Attr -obj $params -name XATransactionsEnabled -failifempty $True -resultobj $result
...
{
    If (('Incoming','Mutual','NoAuth') -contains $AuthenticationLevel ) {
    }
    Else
    {
        Fail-Json $result "Option AuthenticationLevel has invalid value $AuthenticationLevel. Valid values are 'Incoming','Mutual','NoAuth'"
    }
}
...
If ($Status)
{
    If (('Started','Stopped') -contains $Status ) {
    }
    Else
    {
        Fail-Json $result "Option Status has invalid value $Status. Valid values are 'Started','Stopped'"
    }
}
...
$DscResourceName = "cDtc"

$DscModuleName = "cdtcresource"
