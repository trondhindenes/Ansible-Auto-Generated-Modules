...
$UserProfileService = Get-Attr -obj $params -name UserProfileService -failifempty $True -resultobj $result
...
$DisplayOrder = Get-Attr -obj $params -name DisplayOrder -failifempty $False -resultobj $result
...
$IsAlias = Get-Attr -obj $params -name IsAlias -failifempty $False -resultobj $result
#ATTRIBUTE:IsEventLog;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IsEventLog = Get-Attr -obj $params -name IsEventLog -failifempty $False -resultobj $result
#ATTRIBUTE:IsSearchable;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IsSearchable = Get-Attr -obj $params -name IsSearchable -failifempty $False -resultobj $result
#ATTRIBUTE:IsUserEditable;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IsUserEditable = Get-Attr -obj $params -name IsUserEditable -failifempty $False -resultobj $result
#ATTRIBUTE:IsVisibleOnEditor;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IsVisibleOnEditor = Get-Attr -obj $params -name IsVisibleOnEditor -failifempty $False -resultobj $result
#ATTRIBUTE:IsVisibleOnViewer;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IsVisibleOnViewer = Get-Attr -obj $params -name IsVisibleOnViewer -failifempty $False -resultobj $result
#ATTRIBUTE:Length;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Length = Get-Attr -obj $params -name Length -failifempty $False -resultobj $result
#ATTRIBUTE:MappingConnectionName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MappingConnectionName = Get-Attr -obj $params -name MappingConnectionName -failifempty $False -resultobj $result
#ATTRIBUTE:MappingDirection;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MappingDirection = Get-Attr -obj $params -name MappingDirection -failifempty $False -resultobj $result
#ATTRIBUTE:MappingPropertyName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MappingPropertyName = Get-Attr -obj $params -name MappingPropertyName -failifempty $False -resultobj $result
#ATTRIBUTE:PolicySetting;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Disabled,Mandatory,Optin,Optout
$PolicySetting = Get-Attr -obj $params -name PolicySetting -failifempty $False -resultobj $result
#ATTRIBUTE:PrivacySetting;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Contacts,Manager,Organization,Private,Public
$PrivacySetting = Get-Attr -obj $params -name PrivacySetting -failifempty $False -resultobj $result
...
$TermGroup = Get-Attr -obj $params -name TermGroup -failifempty $False -resultobj $result
#ATTRIBUTE:TermSet;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TermSet = Get-Attr -obj $params -name TermSet -failifempty $False -resultobj $result
#ATTRIBUTE:TermStore;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TermStore = Get-Attr -obj $params -name TermStore -failifempty $False -resultobj $result
...
$UserOverridePrivacy = Get-Attr -obj $params -name UserOverridePrivacy -failifempty $False -resultobj $result
...
$DscResourceName = "xSPUserProfileProperty"
