...
$AdminThreshold = Get-Attr -obj $params -name AdminThreshold -failifempty $False -resultobj $result
#ATTRIBUTE:AllowObjectModelOverride;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowObjectModelOverride = Get-Attr -obj $params -name AllowObjectModelOverride -failifempty $False -resultobj $result
#ATTRIBUTE:ChangeLogEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ChangeLogEnabled = Get-Attr -obj $params -name ChangeLogEnabled -failifempty $False -resultobj $result
#ATTRIBUTE:ChangeLogExpiryDays;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ChangeLogExpiryDays = Get-Attr -obj $params -name ChangeLogExpiryDays -failifempty $False -resultobj $result
#ATTRIBUTE:EventHandlersEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EventHandlersEnabled = Get-Attr -obj $params -name EventHandlersEnabled -failifempty $False -resultobj $result
#ATTRIBUTE:HappyHour;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$HappyHour = Get-Attr -obj $params -name HappyHour -failifempty $False -resultobj $result
#ATTRIBUTE:HappyHourEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$HappyHourEnabled = Get-Attr -obj $params -name HappyHourEnabled -failifempty $False -resultobj $result
...
$ListViewLookupThreshold = Get-Attr -obj $params -name ListViewLookupThreshold -failifempty $False -resultobj $result
#ATTRIBUTE:ListViewThreshold;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ListViewThreshold = Get-Attr -obj $params -name ListViewThreshold -failifempty $False -resultobj $result
...
$RequestThrottling = Get-Attr -obj $params -name RequestThrottling -failifempty $False -resultobj $result
#ATTRIBUTE:UniquePermissionThreshold;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UniquePermissionThreshold = Get-Attr -obj $params -name UniquePermissionThreshold -failifempty $False -resultobj $result
...
$DscResourceName = "xSPWebAppThrottlingSettings"
