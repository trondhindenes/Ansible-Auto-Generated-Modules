...
$CacheSizeInMB = Get-Attr -obj $params -name CacheSizeInMB -failifempty $True -resultobj $result
#ATTRIBUTE:CreateFirewallRules;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CreateFirewallRules = Get-Attr -obj $params -name CreateFirewallRules -failifempty $True -resultobj $result
...
$ServerProvisionOrder = Get-Attr -obj $params -name ServerProvisionOrder -failifempty $False -resultobj $result
...
$DscResourceName = "xSPDistributedCacheService"
