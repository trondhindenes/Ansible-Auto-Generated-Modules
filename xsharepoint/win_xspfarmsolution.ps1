...
$LiteralPath = Get-Attr -obj $params -name LiteralPath -failifempty $True -resultobj $result
...
$Deployed = Get-Attr -obj $params -name Deployed -failifempty $False -resultobj $result
...
$WebApplications = Get-Attr -obj $params -name WebApplications -failifempty $False -resultobj $result
...
$DscResourceName = "xSPFarmSolution"
