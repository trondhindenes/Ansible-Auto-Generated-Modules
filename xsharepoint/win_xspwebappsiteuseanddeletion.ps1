...
$AutomaticallyDeleteUnusedSiteCollections = Get-Attr -obj $params -name AutomaticallyDeleteUnusedSiteCollections -failifempty $False -resultobj $result
...
$SendUnusedSiteCollectionNotifications = Get-Attr -obj $params -name SendUnusedSiteCollectionNotifications -failifempty $False -resultobj $result
#ATTRIBUTE:UnusedSiteNotificationPeriod;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UnusedSiteNotificationPeriod = Get-Attr -obj $params -name UnusedSiteNotificationPeriod -failifempty $False -resultobj $result
#ATTRIBUTE:UnusedSiteNotificationsBeforeDeletion;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UnusedSiteNotificationsBeforeDeletion = Get-Attr -obj $params -name UnusedSiteNotificationsBeforeDeletion -failifempty $False -resultobj $result
...
$DscResourceName = "xSPWebAppSiteUseAndDeletion"
