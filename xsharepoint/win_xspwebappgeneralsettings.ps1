...
#ATTRIBUTE:BrowserFileHandling;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Permissive,Stric
...
{
    If (('Permissive','Stric') -contains $BrowserFileHandling ) {
    }
    Else
    {
        Fail-Json $result "Option BrowserFileHandling has invalid value $BrowserFileHandling. Valid values are 'Permissive','Stric'"
    }
}
...
$DscResourceName = "xSPWebAppGeneralSettings"

$DscModuleName = "xsharepoint"
