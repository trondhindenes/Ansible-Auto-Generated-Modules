...
$MaximumUsagePointsSolutions = Get-Attr -obj $params -name MaximumUsagePointsSolutions -failifempty $False -resultobj $result
...
$StorageMaxInMB = Get-Attr -obj $params -name StorageMaxInMB -failifempty $False -resultobj $result
#ATTRIBUTE:StorageWarningInMB;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$StorageWarningInMB = Get-Attr -obj $params -name StorageWarningInMB -failifempty $False -resultobj $result
#ATTRIBUTE:WarningUsagePointsSolutions;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WarningUsagePointsSolutions = Get-Attr -obj $params -name WarningUsagePointsSolutions -failifempty $False -resultobj $result
...
$DscResourceName = "xSPQuotaTemplate"
