...
$FixAutomatically = Get-Attr -obj $params -name FixAutomatically -failifempty $False -resultobj $result
...
$RuleScope = Get-Attr -obj $params -name RuleScope -failifempty $False -resultobj $result
...
$DscResourceName = "xSPHealthAnalyzerRuleState"
