...
$MailAddress = Get-Attr -obj $params -name MailAddress -failifempty $True -resultobj $result
#ATTRIBUTE:DaysBeforeExpiry;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DaysBeforeExpiry = Get-Attr -obj $params -name DaysBeforeExpiry -failifempty $False -resultobj $result
...
$NumberOfRetries = Get-Attr -obj $params -name NumberOfRetries -failifempty $False -resultobj $result
#ATTRIBUTE:PasswordChangeWaitTimeSeconds;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PasswordChangeWaitTimeSeconds = Get-Attr -obj $params -name PasswordChangeWaitTimeSeconds -failifempty $False -resultobj $result
...
$DscResourceName = "xSPPasswordChangeSettings"
