...
#ATTRIBUTE:DotNet452;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DotNet452 = Get-Attr -obj $params -name DotNet452 -failifempty $False -resultobj $result
...
$DscResourceName = "xSPInstallPrereqs"
