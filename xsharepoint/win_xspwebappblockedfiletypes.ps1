...
$Blocked = Get-Attr -obj $params -name Blocked -failifempty $False -resultobj $result
#ATTRIBUTE:EnsureAllowed;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EnsureAllowed = Get-Attr -obj $params -name EnsureAllowed -failifempty $False -resultobj $result
#ATTRIBUTE:EnsureBlocked;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EnsureBlocked = Get-Attr -obj $params -name EnsureBlocked -failifempty $False -resultobj $result
...
$DscResourceName = "xSPWebAppBlockedFileTypes"
