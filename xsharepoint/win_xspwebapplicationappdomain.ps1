...
$AppDomain = Get-Attr -obj $params -name AppDomain -failifempty $True -resultobj $result
#ATTRIBUTE:WebApplication;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WebApplication = Get-Attr -obj $params -name WebApplication -failifempty $True -resultobj $result
...
$SSL = Get-Attr -obj $params -name SSL -failifempty $False -resultobj $result
...
$DscResourceName = "xSPWebApplicationAppDomain"
