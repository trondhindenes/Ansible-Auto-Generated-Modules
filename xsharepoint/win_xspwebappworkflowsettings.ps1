...
$EmailToNoPermissionWorkflowParticipantsEnable = Get-Attr -obj $params -name EmailToNoPermissionWorkflowParticipantsEnable -failifempty $False -resultobj $result
#ATTRIBUTE:ExternalWorkflowParticipantsEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ExternalWorkflowParticipantsEnabled = Get-Attr -obj $params -name ExternalWorkflowParticipantsEnabled -failifempty $False -resultobj $result
...
$UserDefinedWorkflowsEnabled = Get-Attr -obj $params -name UserDefinedWorkflowsEnabled -failifempty $False -resultobj $result
...
$DscResourceName = "xSPWebAppWorkflowSettings"
