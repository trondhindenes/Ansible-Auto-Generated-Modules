...
$AllContentDatabases = Get-Attr -obj $params -name AllContentDatabases -failifempty $False -resultobj $result
#ATTRIBUTE:ContentDatabases;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ContentDatabases = Get-Attr -obj $params -name ContentDatabases -failifempty $False -resultobj $result
...
$DscResourceName = "xSPShellAdmins"
