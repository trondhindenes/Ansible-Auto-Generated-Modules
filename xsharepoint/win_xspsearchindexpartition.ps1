...
$Index = Get-Attr -obj $params -name Index -failifempty $True -resultobj $result
...
$RootDirectory = Get-Attr -obj $params -name RootDirectory -failifempty $False -resultobj $result
...
$DscResourceName = "xSPSearchIndexPartition"
