...
$ConnectionCredentials_username = Get-Attr -obj $params -name ConnectionCredentials_username -failifempty $True -resultobj $result
#ATTRIBUTE:ConnectionCredentials_password;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ConnectionCredentials_password = Get-Attr -obj $params -name ConnectionCredentials_password -failifempty $True -resultobj $result
#ATTRIBUTE:Forest;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Forest = Get-Attr -obj $params -name Forest -failifempty $True -resultobj $result
#ATTRIBUTE:IncludedOUs;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IncludedOUs = Get-Attr -obj $params -name IncludedOUs -failifempty $True -resultobj $result
...
$ConnectionType = Get-Attr -obj $params -name ConnectionType -failifempty $False -resultobj $result
#ATTRIBUTE:ExcludedOUs;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ExcludedOUs = Get-Attr -obj $params -name ExcludedOUs -failifempty $False -resultobj $result
...
$Server = Get-Attr -obj $params -name Server -failifempty $False -resultobj $result
...
$DscResourceName = "xSPUserProfileSyncConnection"
