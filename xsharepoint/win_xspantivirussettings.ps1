...
$ScanOnDownload = Get-Attr -obj $params -name ScanOnDownload -failifempty $True -resultobj $result
#ATTRIBUTE:AllowDownloadInfected;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowDownloadInfected = Get-Attr -obj $params -name AllowDownloadInfected -failifempty $False -resultobj $result
#ATTRIBUTE:AttemptToClean;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AttemptToClean = Get-Attr -obj $params -name AttemptToClean -failifempty $False -resultobj $result
...
$NumberOfThreads = Get-Attr -obj $params -name NumberOfThreads -failifempty $False -resultobj $result
...
$ScanOnUpload = Get-Attr -obj $params -name ScanOnUpload -failifempty $False -resultobj $result
#ATTRIBUTE:TimeoutDuration;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TimeoutDuration = Get-Attr -obj $params -name TimeoutDuration -failifempty $False -resultobj $result
...
$DscResourceName = "xSPAntivirusSettings"
