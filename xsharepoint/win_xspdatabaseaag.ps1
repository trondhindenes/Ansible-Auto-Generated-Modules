...
$AGName = Get-Attr -obj $params -name AGName -failifempty $True -resultobj $result
...
$FileShare = Get-Attr -obj $params -name FileShare -failifempty $False -resultobj $result
...
$DscResourceName = "xSPDatabaseAAG"
