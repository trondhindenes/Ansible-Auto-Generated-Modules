...
$CharacterSet = Get-Attr -obj $params -name CharacterSet -failifempty $True -resultobj $result
#ATTRIBUTE:FromAddress;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FromAddress = Get-Attr -obj $params -name FromAddress -failifempty $True -resultobj $result
#ATTRIBUTE:ReplyToAddress;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ReplyToAddress = Get-Attr -obj $params -name ReplyToAddress -failifempty $True -resultobj $result
...
$DscResourceName = "xSPOutgoingEmailSettings"
