...
$SettingsScope = Get-Attr -obj $params -name SettingsScope -failifempty $True -resultobj $result
...
$AllowCreateDeclarativeWorkflow = Get-Attr -obj $params -name AllowCreateDeclarativeWorkflow -failifempty $False -resultobj $result
#ATTRIBUTE:AllowCustomiseMasterPage;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowCustomiseMasterPage = Get-Attr -obj $params -name AllowCustomiseMasterPage -failifempty $False -resultobj $result
#ATTRIBUTE:AllowDetachPagesFromDefinition;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowDetachPagesFromDefinition = Get-Attr -obj $params -name AllowDetachPagesFromDefinition -failifempty $False -resultobj $result
#ATTRIBUTE:AllowManageSiteURLStructure;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowManageSiteURLStructure = Get-Attr -obj $params -name AllowManageSiteURLStructure -failifempty $False -resultobj $result
#ATTRIBUTE:AllowSaveDeclarativeWorkflowAsTemplate;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowSaveDeclarativeWorkflowAsTemplate = Get-Attr -obj $params -name AllowSaveDeclarativeWorkflowAsTemplate -failifempty $False -resultobj $result
#ATTRIBUTE:AllowSavePublishDeclarativeWorkflow;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowSavePublishDeclarativeWorkflow = Get-Attr -obj $params -name AllowSavePublishDeclarativeWorkflow -failifempty $False -resultobj $result
#ATTRIBUTE:AllowSharePointDesigner;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowSharePointDesigner = Get-Attr -obj $params -name AllowSharePointDesigner -failifempty $False -resultobj $result
...
$DscResourceName = "xSPDesignerSettings"
