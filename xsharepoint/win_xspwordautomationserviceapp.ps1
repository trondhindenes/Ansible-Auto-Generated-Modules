...
$ConversionProcesses = Get-Attr -obj $params -name ConversionProcesses -failifempty $False -resultobj $result
...
$DisableBinaryFileScan = Get-Attr -obj $params -name DisableBinaryFileScan -failifempty $False -resultobj $result
#ATTRIBUTE:DisableEmbeddedFonts;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DisableEmbeddedFonts = Get-Attr -obj $params -name DisableEmbeddedFonts -failifempty $False -resultobj $result
...
$JobConversionFrequency = Get-Attr -obj $params -name JobConversionFrequency -failifempty $False -resultobj $result
#ATTRIBUTE:KeepAliveTimeout;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$KeepAliveTimeout = Get-Attr -obj $params -name KeepAliveTimeout -failifempty $False -resultobj $result
#ATTRIBUTE:MaximumConversionAttempts;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MaximumConversionAttempts = Get-Attr -obj $params -name MaximumConversionAttempts -failifempty $False -resultobj $result
#ATTRIBUTE:MaximumConversionTime;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MaximumConversionTime = Get-Attr -obj $params -name MaximumConversionTime -failifempty $False -resultobj $result
#ATTRIBUTE:MaximumMemoryUsage;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MaximumMemoryUsage = Get-Attr -obj $params -name MaximumMemoryUsage -failifempty $False -resultobj $result
#ATTRIBUTE:MaximumSyncConversionRequests;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MaximumSyncConversionRequests = Get-Attr -obj $params -name MaximumSyncConversionRequests -failifempty $False -resultobj $result
#ATTRIBUTE:NumberOfConversionsPerProcess;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$NumberOfConversionsPerProcess = Get-Attr -obj $params -name NumberOfConversionsPerProcess -failifempty $False -resultobj $result
...
$RecycleThreshold = Get-Attr -obj $params -name RecycleThreshold -failifempty $False -resultobj $result
#ATTRIBUTE:SupportedFileFormats;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:doc,docx,mht,rtf,xml
$SupportedFileFormats = Get-Attr -obj $params -name SupportedFileFormats -failifempty $False -resultobj $result
#ATTRIBUTE:TimeBeforeConversionIsMonitored;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TimeBeforeConversionIsMonitored = Get-Attr -obj $params -name TimeBeforeConversionIsMonitored -failifempty $False -resultobj $result
...
$DscResourceName = "xSPWordAutomationServiceApp"
