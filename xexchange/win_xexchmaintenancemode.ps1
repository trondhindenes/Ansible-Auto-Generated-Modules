...
#ATTRIBUTE:AdditionalComponentsToActivate;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AdditionalComponentsToActivate = Get-Attr -obj $params -name AdditionalComponentsToActivate -failifempty $False -resultobj $result
...
#ATTRIBUTE:MovePreferredDatabasesBack;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MovePreferredDatabasesBack = Get-Attr -obj $params -name MovePreferredDatabasesBack -failifempty $False -resultobj $result
...
#ATTRIBUTE:SetInactiveComponentsFromAnyRequesterToActive;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SetInactiveComponentsFromAnyRequesterToActive = Get-Attr -obj $params -name SetInactiveComponentsFromAnyRequesterToActive -failifempty $False -resultobj $result
#ATTRIBUTE:UpgradedServerVersion;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UpgradedServerVersion = Get-Attr -obj $params -name UpgradedServerVersion -failifempty $False -resultobj $result
...
$DscResourceName = "xExchMaintenanceMode"
