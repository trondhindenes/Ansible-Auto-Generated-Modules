...
#ATTRIBUTE:AllowExtraServices;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowExtraServices = Get-Attr -obj $params -name AllowExtraServices -failifempty $False -resultobj $result
#ATTRIBUTE:CertCreds_username;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CertCreds_username = Get-Attr -obj $params -name CertCreds_username -failifempty $False -resultobj $result
#ATTRIBUTE:CertCreds_password;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CertCreds_password = Get-Attr -obj $params -name CertCreds_password -failifempty $False -resultobj $result
#ATTRIBUTE:CertFilePath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
...
#ATTRIBUTE:Services;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
...
if ($CertCreds_username)
{
$CertCreds_securepassword = $CertCreds_password | ConvertTo-SecureString -asPlainText -Force
$CertCreds = New-Object System.Management.Automation.PSCredential($CertCreds_username,$CertCreds_securepassword)
}
...
$DscResourceName = "xExchExchangeCertificate"
