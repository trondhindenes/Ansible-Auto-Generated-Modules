...
#ATTRIBUTE:IsExcludedFromProvisioningReason;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IsExcludedFromProvisioningReason = Get-Attr -obj $params -name IsExcludedFromProvisioningReason -failifempty $False -resultobj $result
