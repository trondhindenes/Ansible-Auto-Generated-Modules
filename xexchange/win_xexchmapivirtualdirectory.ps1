...
#ATTRIBUTE:IISAuthenticationMethods;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IISAuthenticationMethods = Get-Attr -obj $params -name IISAuthenticationMethods -failifempty $True -resultobj $result
...
$DscResourceName = "xExchMapiVirtualDirectory"
