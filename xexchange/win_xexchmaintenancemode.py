...
DOCUMENTATION = '''
---
module: win_xexchmaintenancemode
version_added: 
short_description: Generated from DSC module xexchange version 1.7.0.0 at 6/25/2016 12:49:09 AM
description:
...
options:
  ...
  SetInactiveComponentsFromAnyRequesterToActive:
    description:
      - 
    required: False
    default: 
