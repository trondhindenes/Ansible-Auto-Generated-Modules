...
#ATTRIBUTE:AutoDiscoverServiceInternalUri;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AutoDiscoverServiceInternalUri = Get-Attr -obj $params -name AutoDiscoverServiceInternalUri -failifempty $False -resultobj $result
#ATTRIBUTE:AutoDiscoverSiteScope;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AutoDiscoverSiteScope = Get-Attr -obj $params -name AutoDiscoverSiteScope -failifempty $False -resultobj $result
...
$DscResourceName = "xExchClientAccessServer"
