...
#ATTRIBUTE:DatabaseCopyActivationDisabledAndMoveNow;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DatabaseCopyActivationDisabledAndMoveNow = Get-Attr -obj $params -name DatabaseCopyActivationDisabledAndMoveNow -failifempty $False -resultobj $result
#ATTRIBUTE:DatabaseCopyAutoActivationPolicy;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Blocked,IntrasiteOnly,Unrestricted
$DatabaseCopyAutoActivationPolicy = Get-Attr -obj $params -name DatabaseCopyAutoActivationPolicy -failifempty $False -resultobj $result
...
#ATTRIBUTE:MaximumActiveDatabases;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MaximumActiveDatabases = Get-Attr -obj $params -name MaximumActiveDatabases -failifempty $False -resultobj $result
#ATTRIBUTE:MaximumPreferredActiveDatabases;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MaximumPreferredActiveDatabases = Get-Attr -obj $params -name MaximumPreferredActiveDatabases -failifempty $False -resultobj $result
...
If ($DatabaseCopyAutoActivationPolicy)
{
    If (('Blocked','IntrasiteOnly','Unrestricted') -contains $DatabaseCopyAutoActivationPolicy ) {
    }
    Else
    {
        Fail-Json $result "Option DatabaseCopyAutoActivationPolicy has invalid value $DatabaseCopyAutoActivationPolicy. Valid values are 'Blocked','IntrasiteOnly','Unrestricted'"
    }
}
