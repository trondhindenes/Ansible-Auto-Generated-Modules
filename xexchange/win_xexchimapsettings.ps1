...
#ATTRIBUTE:ExternalConnectionSettings;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ExternalConnectionSettings = Get-Attr -obj $params -name ExternalConnectionSettings -failifempty $False -resultobj $result
#ATTRIBUTE:LoginType;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:PlainTextAuthentication,PlainTextLogin,SecureLogin
$LoginType = Get-Attr -obj $params -name LoginType -failifempty $False -resultobj $result
...
#ATTRIBUTE:X509CertificateName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$X509CertificateName = Get-Attr -obj $params -name X509CertificateName -failifempty $False -resultobj $result
...
If ($LoginType)
{
    If (('PlainTextAuthentication','PlainTextLogin','SecureLogin') -contains $LoginType ) {
    }
    Else
    {
        Fail-Json $result "Option LoginType has invalid value $LoginType. Valid values are 'PlainTextAuthentication','PlainTextLogin','SecureLogin'"
    }
}
...
$DscResourceName = "xExchImapSettings"
