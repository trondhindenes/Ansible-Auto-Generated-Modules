...
#ATTRIBUTE:ProductId;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ProductId = Get-Attr -obj $params -name ProductId -failifempty $False -resultobj $result
#ATTRIBUTE:InstallerUri;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$InstallerUri = Get-Attr -obj $params -name InstallerUri -failifempty $False -resultobj $result
...
$DscResourceName = "cWebPILauncher"
