...
#ATTRIBUTE:IsProtected;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IsProtected = Get-Attr -obj $params -name IsProtected -failifempty $True -resultobj $result
#ATTRIBUTE:Path;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Path = Get-Attr -obj $params -name Path -failifempty $True -resultobj $result
#ATTRIBUTE:PreserveInheritance;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PreserveInheritance = Get-Attr -obj $params -name PreserveInheritance -failifempty $False -resultobj $result
