...
#ATTRIBUTE:TriggerCcmClientSDK;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TriggerCcmClientSDK = Get-Attr -obj $params -name TriggerCcmClientSDK -failifempty $False -resultobj $result
#ATTRIBUTE:TriggerComponentBasedServicing;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TriggerComponentBasedServicing = Get-Attr -obj $params -name TriggerComponentBasedServicing -failifempty $False -resultobj $result
#ATTRIBUTE:TriggerPendingComputerRename;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TriggerPendingComputerRename = Get-Attr -obj $params -name TriggerPendingComputerRename -failifempty $False -resultobj $result
#ATTRIBUTE:TriggerPendingFileRename;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TriggerPendingFileRename = Get-Attr -obj $params -name TriggerPendingFileRename -failifempty $False -resultobj $result
#ATTRIBUTE:TriggerWindowsUpdate;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TriggerWindowsUpdate = Get-Attr -obj $params -name TriggerWindowsUpdate -failifempty $False -resultobj $result
#ATTRIBUTE:WaitTimeSec;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WaitTimeSec = Get-Attr -obj $params -name WaitTimeSec -failifempty $False -resultobj $result
#ATTRIBUTE:WhatIf;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WhatIf = Get-Attr -obj $params -name WhatIf -failifempty $False -resultobj $result
...
$DscResourceName = "cPendingReboot"
