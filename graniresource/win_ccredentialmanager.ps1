...
#ATTRIBUTE:InstanceIdentifier;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$InstanceIdentifier = Get-Attr -obj $params -name InstanceIdentifier -failifempty $True -resultobj $result
...
$DscResourceName = "cCredentialManager"
