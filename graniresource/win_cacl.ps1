...
#ATTRIBUTE:Access;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Allow,Deny
$Access = Get-Attr -obj $params -name Access -failifempty $False -resultobj $result
#ATTRIBUTE:Ensure;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Absent,Present
$Ensure = Get-Attr -obj $params -name Ensure -failifempty $False -resultobj $result
#ATTRIBUTE:Inherit;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Inherit = Get-Attr -obj $params -name Inherit -failifempty $False -resultobj $result
...
#ATTRIBUTE:Rights;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:FullControl,Modify,ReadAndExecute
$Rights = Get-Attr -obj $params -name Rights -failifempty $False -resultobj $result
#ATTRIBUTE:Strict;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Strict = Get-Attr -obj $params -name Strict -failifempty $False -resultobj $result
...
If ($Access)
{
    If (('Allow','Deny') -contains $Access ) {
    }
    Else
    {
        Fail-Json $result "Option Access has invalid value $Access. Valid values are 'Allow','Deny'"
    }
}
...
If ($Rights)
{
    If (('FullControl','Modify','ReadAndExecute') -contains $Rights ) {
    }
    Else
    {
        Fail-Json $result "Option Rights has invalid value $Rights. Valid values are 'FullControl','Modify','ReadAndExecute'"
    }
}
