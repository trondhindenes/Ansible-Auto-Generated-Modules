...
#ATTRIBUTE:ContentPath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ContentPath = Get-Attr -obj $params -name ContentPath -failifempty $True -resultobj $result
...
#ATTRIBUTE:OAuth2Token_username;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$OAuth2Token_username = Get-Attr -obj $params -name OAuth2Token_username -failifempty $True -resultobj $result
#ATTRIBUTE:OAuth2Token_password;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$OAuth2Token_password = Get-Attr -obj $params -name OAuth2Token_password -failifempty $True -resultobj $result
#ATTRIBUTE:Repository;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Repository = Get-Attr -obj $params -name Repository -failifempty $True -resultobj $result
#ATTRIBUTE:RepositoryOwner;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RepositoryOwner = Get-Attr -obj $params -name RepositoryOwner -failifempty $True -resultobj $result
#ATTRIBUTE:AllowRedirect;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowRedirect = Get-Attr -obj $params -name AllowRedirect -failifempty $False -resultobj $result
#ATTRIBUTE:Branch;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Branch = Get-Attr -obj $params -name Branch -failifempty $False -resultobj $result
...
#ATTRIBUTE:ContentType;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:application/json,application/vnd.github.v3.html,application/vnd.github.v3.raw,application/vnd.github+json
$ContentType = Get-Attr -obj $params -name ContentType -failifempty $False -resultobj $result
#ATTRIBUTE:Header;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Header = Get-Attr -obj $params -name Header -failifempty $False -resultobj $result
...
If ($ContentType)
{
    If (('application/json','application/vnd.github.v3.html','application/vnd.github.v3.raw','application/vnd.github+json') -contains $ContentType ) {
    }
    Else
    {
        Fail-Json $result "Option ContentType has invalid value $ContentType. Valid values are 'application/json','application/vnd.github.v3.html','application/vnd.github.v3.raw','application/vnd.github+json'"
    }
}
...
if ($OAuth2Token_username)
{
$OAuth2Token_securepassword = $OAuth2Token_password | ConvertTo-SecureString -asPlainText -Force
$OAuth2Token = New-Object System.Management.Automation.PSCredential($OAuth2Token_username,$OAuth2Token_securepassword)
}
...
$DscResourceName = "cGitHubApiContent"

$DscModuleName = "graniresource"
