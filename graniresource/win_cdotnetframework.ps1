...
#ATTRIBUTE:KB;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$KB = Get-Attr -obj $params -name KB -failifempty $True -resultobj $result
#ATTRIBUTE:InstallerPath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$InstallerPath = Get-Attr -obj $params -name InstallerPath -failifempty $False -resultobj $result
...
#ATTRIBUTE:NoRestart;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$NoRestart = Get-Attr -obj $params -name NoRestart -failifempty $False -resultobj $result
...
$DscResourceName = "cDotNetFramework"
