...
#ATTRIBUTE:Identifier;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Identifier = Get-Attr -obj $params -name Identifier -failifempty $True -resultobj $result
...
#ATTRIBUTE:Restart;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Restart = Get-Attr -obj $params -name Restart -failifempty $False -resultobj $result
