...
#ATTRIBUTE:ExchSchemaVersion;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ExchSchemaVersion = Get-Attr -obj $params -name ExchSchemaVersion -failifempty $True -resultobj $result
...
$DscResourceName = "myAdExchPrepareSchema"
