...
#ATTRIBUTE:InterSiteTopologyGeneration;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$InterSiteTopologyGeneration = Get-Attr -obj $params -name InterSiteTopologyGeneration -failifempty $False -resultobj $result
#ATTRIBUTE:IntraSiteTopologyGeneration;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IntraSiteTopologyGeneration = Get-Attr -obj $params -name IntraSiteTopologyGeneration -failifempty $False -resultobj $result
...
$DscModuleName = "myactivedirectory"
