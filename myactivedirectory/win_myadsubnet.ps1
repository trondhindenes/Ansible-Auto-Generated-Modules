...
#ATTRIBUTE:DomainAdminCreds_username;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DomainAdminCreds_username = Get-Attr -obj $params -name DomainAdminCreds_username -failifempty $False -resultobj $result
#ATTRIBUTE:DomainAdminCreds_password;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DomainAdminCreds_password = Get-Attr -obj $params -name DomainAdminCreds_password -failifempty $False -resultobj $result
...
#ATTRIBUTE:Protected;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Protected = Get-Attr -obj $params -name Protected -failifempty $False -resultobj $result
...
#ATTRIBUTE:Site;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Site = Get-Attr -obj $params -name Site -failifempty $False -resultobj $result
...
if ($DomainAdminCreds_username)
{
$DomainAdminCreds_securepassword = $DomainAdminCreds_password | ConvertTo-SecureString -asPlainText -Force
$DomainAdminCreds = New-Object System.Management.Automation.PSCredential($DomainAdminCreds_username,$DomainAdminCreds_securepassword)
}
