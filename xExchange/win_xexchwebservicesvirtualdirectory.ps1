...
#ATTRIBUTE:CertificateAuthentication;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CertificateAuthentication = Get-Attr -obj $params -name CertificateAuthentication -failifempty $False -resultobj $result
...
#ATTRIBUTE:InternalNLBBypassUrl;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$InternalNLBBypassUrl = Get-Attr -obj $params -name InternalNLBBypassUrl -failifempty $False -resultobj $result
...
#ATTRIBUTE:OAuthAuthentication;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$OAuthAuthentication = Get-Attr -obj $params -name OAuthAuthentication -failifempty $False -resultobj $result
...
#ATTRIBUTE:WSSecurityAuthentication;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WSSecurityAuthentication = Get-Attr -obj $params -name WSSecurityAuthentication -failifempty $False -resultobj $result
...
$DscResourceName = "xExchWebServicesVirtualDirectory"
