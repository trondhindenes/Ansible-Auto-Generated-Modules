...
#ATTRIBUTE:NATSubnetAddress;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$NATSubnetAddress = Get-Attr -obj $params -name NATSubnetAddress -failifempty $True -resultobj $result
