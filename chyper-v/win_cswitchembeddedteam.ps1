...
#ATTRIBUTE:AllowManagementOS;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowManagementOS = Get-Attr -obj $params -name AllowManagementOS -failifempty $False -resultobj $result
#ATTRIBUTE:BandwidthReservationMode;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Absolute,Default,None,Weight
$BandwidthReservationMode = Get-Attr -obj $params -name BandwidthReservationMode -failifempty $False -resultobj $result
#ATTRIBUTE:EnableIov;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EnableIov = Get-Attr -obj $params -name EnableIov -failifempty $False -resultobj $result
#ATTRIBUTE:EnablePacketDirect;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EnablePacketDirect = Get-Attr -obj $params -name EnablePacketDirect -failifempty $False -resultobj $result
#ATTRIBUTE:Ensure;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Absent,Present
$Ensure = Get-Attr -obj $params -name Ensure -failifempty $False -resultobj $result
#ATTRIBUTE:LoadBalancingAlgorithm;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Dynamic,HyperVPort
$LoadBalancingAlgorithm = Get-Attr -obj $params -name LoadBalancingAlgorithm -failifempty $False -resultobj $result
#ATTRIBUTE:NetAdapterName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$NetAdapterName = Get-Attr -obj $params -name NetAdapterName -failifempty $False -resultobj $result
...
#ATTRIBUTE:TeamingMode;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:SwitchIndependent
...
If ($BandwidthReservationMode)
{
    If (('Absolute','Default','None','Weight') -contains $BandwidthReservationMode ) {
    }
    Else
    {
        Fail-Json $result "Option BandwidthReservationMode has invalid value $BandwidthReservationMode. Valid values are 'Absolute','Default','None','Weight'"
    }
}
...
{
    If (('Dynamic','HyperVPort') -contains $LoadBalancingAlgorithm ) {
    }
    Else
    {
        Fail-Json $result "Option LoadBalancingAlgorithm has invalid value $LoadBalancingAlgorithm. Valid values are 'Dynamic','HyperVPort'"
    }
}
...
If ($TeamingMode)
{
    If (('SwitchIndependent') -contains $TeamingMode ) {
    }
    Else
    {
        Fail-Json $result "Option TeamingMode has invalid value $TeamingMode. Valid values are 'SwitchIndependent'"
    }
}
...
$DscResourceName = "cSwitchEmbeddedTeam"

$DscModuleName = "chyper-v"
