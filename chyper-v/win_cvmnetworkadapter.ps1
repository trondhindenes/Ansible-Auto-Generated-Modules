...
#ATTRIBUTE:DynamicMacAddress;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
...
#ATTRIBUTE:StaticMacAddress;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
...
$DscResourceName = "cVMNetworkAdapter"
