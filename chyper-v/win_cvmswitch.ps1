...
#ATTRIBUTE:Type;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:External,Internal,Private
...
#ATTRIBUTE:MinimumBandwidthMode;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Absolute,Default,None,Weight
$MinimumBandwidthMode = Get-Attr -obj $params -name MinimumBandwidthMode -failifempty $False -resultobj $result
...
If ($Type)
{
    If (('External','Internal','Private') -contains $Type ) {
    }
    Else
    {
        Fail-Json $result "Option Type has invalid value $Type. Valid values are 'External','Internal','Private'"
    }
}
...
{
    If (('Absolute','Default','None','Weight') -contains $MinimumBandwidthMode ) {
    }
    Else
    {
        Fail-Json $result "Option MinimumBandwidthMode has invalid value $MinimumBandwidthMode. Valid values are 'Absolute','Default','None','Weight'"
    }
}
