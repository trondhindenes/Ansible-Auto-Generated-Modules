...
If ($AllowTeaming)
{
    ...
    Else
    {
        Fail-Json $result "Option AllowTeaming has invalid value $AllowTeaming. Valid values are 'Off','On'"
    }
}
...
If ($DhcpGuard)
{
    If (('Off','On') -contains $DhcpGuard ) {
    }
    Else
    {
        Fail-Json $result "Option DhcpGuard has invalid value $DhcpGuard. Valid values are 'Off','On'"
    }
}
...
If ($IeeePriorityTag)
{
    If (('Off','On') -contains $IeeePriorityTag ) {
    }
    Else
    {
        Fail-Json $result "Option IeeePriorityTag has invalid value $IeeePriorityTag. Valid values are 'Off','On'"
    }
}
...
{
    If (('Off','On') -contains $MacAddressSpoofing ) {
    }
    Else
    {
        Fail-Json $result "Option MacAddressSpoofing has invalid value $MacAddressSpoofing. Valid values are 'Off','On'"
    }
}
...
If ($PortMirroring)
{
    If (('Destination','None','Source') -contains $PortMirroring ) {
    }
    Else
    {
        Fail-Json $result "Option PortMirroring has invalid value $PortMirroring. Valid values are 'Destination','None','Source'"
    }
}
...
If ($RouterGuard)
{
    If (('Off','On') -contains $RouterGuard ) {
    }
    Else
    {
...
$DscResourceName = "cVMNetworkAdapterSettings"
