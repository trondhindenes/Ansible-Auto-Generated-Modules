...
#ATTRIBUTE:LoggingDatabaseName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LoggingDatabaseName = Get-Attr -obj $params -name LoggingDatabaseName -failifempty $True -resultobj $result
#ATTRIBUTE:MonitorDatabaseName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MonitorDatabaseName = Get-Attr -obj $params -name MonitorDatabaseName -failifempty $True -resultobj $result
#ATTRIBUTE:SiteDatabaseName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SiteDatabaseName = Get-Attr -obj $params -name SiteDatabaseName -failifempty $True -resultobj $result
