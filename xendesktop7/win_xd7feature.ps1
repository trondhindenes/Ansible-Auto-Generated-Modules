...
#ATTRIBUTE:Role;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Controller,Director,Licensing,Storefront,Studio
...
If ($Role)
{
    If (('Controller','Director','Licensing','Storefront','Studio') -contains $Role ) {
    }
    Else
    {
        Fail-Json $result "Option Role has invalid value $Role. Valid values are 'Controller','Director','Licensing','Storefront','Studio'"
    }
}
