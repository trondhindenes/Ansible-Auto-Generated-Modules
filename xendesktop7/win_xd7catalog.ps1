...
#ATTRIBUTE:Allocation;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Permanent,Random,Static
$Allocation = Get-Attr -obj $params -name Allocation -failifempty $True -resultobj $result
#ATTRIBUTE:Name;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Name = Get-Attr -obj $params -name Name -failifempty $True -resultobj $result
#ATTRIBUTE:Persistence;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Discard,Local,PVD
$Persistence = Get-Attr -obj $params -name Persistence -failifempty $True -resultobj $result
#ATTRIBUTE:Provisioning;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Manual,MCS,PVS
$Provisioning = Get-Attr -obj $params -name Provisioning -failifempty $True -resultobj $result
...
#ATTRIBUTE:IsMultiSession;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IsMultiSession = Get-Attr -obj $params -name IsMultiSession -failifempty $False -resultobj $result
...
#ATTRIBUTE:PvsAddress;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PvsAddress = Get-Attr -obj $params -name PvsAddress -failifempty $False -resultobj $result
#ATTRIBUTE:PvsDomain;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PvsDomain = Get-Attr -obj $params -name PvsDomain -failifempty $False -resultobj $result
...
If ($Allocation)
{
    If (('Permanent','Random','Static') -contains $Allocation ) {
    }
    Else
    {
        Fail-Json $result "Option Allocation has invalid value $Allocation. Valid values are 'Permanent','Random','Static'"
    }
}
...
If ($Persistence)
{
    If (('Discard','Local','PVD') -contains $Persistence ) {
    }
    Else
    {
        Fail-Json $result "Option Persistence has invalid value $Persistence. Valid values are 'Discard','Local','PVD'"
    }
}
...
If ($Provisioning)
{
    If (('Manual','MCS','PVS') -contains $Provisioning ) {
    }
    Else
    {
        Fail-Json $result "Option Provisioning has invalid value $Provisioning. Valid values are 'Manual','MCS','PVS'"
    }
}
