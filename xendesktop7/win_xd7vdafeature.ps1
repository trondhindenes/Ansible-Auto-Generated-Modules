...
#ATTRIBUTE:Role;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:DesktopVDA,SessionVDA
...
#ATTRIBUTE:EnableRealTimeTransport;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EnableRealTimeTransport = Get-Attr -obj $params -name EnableRealTimeTransport -failifempty $False -resultobj $result
#ATTRIBUTE:EnableRemoteAssistance;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EnableRemoteAssistance = Get-Attr -obj $params -name EnableRemoteAssistance -failifempty $False -resultobj $result
#ATTRIBUTE:Ensure;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Absent,Present
$Ensure = Get-Attr -obj $params -name Ensure -failifempty $False -resultobj $result
#ATTRIBUTE:InstallDesktopExperience;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$InstallDesktopExperience = Get-Attr -obj $params -name InstallDesktopExperience -failifempty $False -resultobj $result
#ATTRIBUTE:InstallReceiver;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$InstallReceiver = Get-Attr -obj $params -name InstallReceiver -failifempty $False -resultobj $result
...
#ATTRIBUTE:Optimize;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Optimize = Get-Attr -obj $params -name Optimize -failifempty $False -resultobj $result
...
If ($Role)
{
    If (('DesktopVDA','SessionVDA') -contains $Role ) {
    }
    Else
    {
        Fail-Json $result "Option Role has invalid value $Role. Valid values are 'DesktopVDA','SessionVDA'"
    }
}
