...
#ATTRIBUTE:Members;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Members = Get-Attr -obj $params -name Members -failifempty $True -resultobj $result
...
#ATTRIBUTE:RoleScope;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RoleScope = Get-Attr -obj $params -name RoleScope -failifempty $False -resultobj $result
