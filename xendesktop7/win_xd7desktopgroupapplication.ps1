...
#ATTRIBUTE:DesktopGroupName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DesktopGroupName = Get-Attr -obj $params -name DesktopGroupName -failifempty $True -resultobj $result
...
#ATTRIBUTE:ApplicationType;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:HostedOnDesktop,InstalledOnClient
...
#ATTRIBUTE:Visible;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Visible = Get-Attr -obj $params -name Visible -failifempty $False -resultobj $result
...
If ($ApplicationType)
{
    If (('HostedOnDesktop','InstalledOnClient') -contains $ApplicationType ) {
    }
    Else
    {
        Fail-Json $result "Option ApplicationType has invalid value $ApplicationType. Valid values are 'HostedOnDesktop','InstalledOnClient'"
    }
}
...
$DscResourceName = "XD7DesktopGroupApplication"
