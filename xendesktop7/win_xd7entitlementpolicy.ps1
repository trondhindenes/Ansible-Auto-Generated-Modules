...
#ATTRIBUTE:EntitlementType;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Application,Desktop
$EntitlementType = Get-Attr -obj $params -name EntitlementType -failifempty $True -resultobj $result
...
If ($EntitlementType)
{
    If (('Application','Desktop') -contains $EntitlementType ) {
    }
    Else
    {
        Fail-Json $result "Option EntitlementType has invalid value $EntitlementType. Valid values are 'Application','Desktop'"
    }
}
...
$DscResourceName = "XD7EntitlementPolicy"
