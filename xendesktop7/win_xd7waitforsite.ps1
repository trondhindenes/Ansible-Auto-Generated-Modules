...
#ATTRIBUTE:ExistingControllerName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ExistingControllerName = Get-Attr -obj $params -name ExistingControllerName -failifempty $True -resultobj $result
...
$DscResourceName = "XD7WaitForSite"
