...
#ATTRIBUTE:DeliveryType;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:AppsOnly,DesktopsAndApps,DesktopsOnly
$DeliveryType = Get-Attr -obj $params -name DeliveryType -failifempty $True -resultobj $result
#ATTRIBUTE:DesktopType;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Private,Shared
$DesktopType = Get-Attr -obj $params -name DesktopType -failifempty $True -resultobj $result
#ATTRIBUTE:IsMultiSession;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IsMultiSession = Get-Attr -obj $params -name IsMultiSession -failifempty $True -resultobj $result
#ATTRIBUTE:Name;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Name = Get-Attr -obj $params -name Name -failifempty $True -resultobj $result
#ATTRIBUTE:ColorDepth;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:EightBit,FourBit,SixteenBit,TwentyFourBit
$ColorDepth = Get-Attr -obj $params -name ColorDepth -failifempty $False -resultobj $result
...
#ATTRIBUTE:IsMaintenanceMode;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IsMaintenanceMode = Get-Attr -obj $params -name IsMaintenanceMode -failifempty $False -resultobj $result
#ATTRIBUTE:IsRemotePC;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IsRemotePC = Get-Attr -obj $params -name IsRemotePC -failifempty $False -resultobj $result
#ATTRIBUTE:IsSecureIca;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IsSecureIca = Get-Attr -obj $params -name IsSecureIca -failifempty $False -resultobj $result
...
#ATTRIBUTE:ShutdownDesktopsAfterUse;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ShutdownDesktopsAfterUse = Get-Attr -obj $params -name ShutdownDesktopsAfterUse -failifempty $False -resultobj $result
#ATTRIBUTE:TurnOnAddedMachine;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TurnOnAddedMachine = Get-Attr -obj $params -name TurnOnAddedMachine -failifempty $False -resultobj $result
...
If ($DeliveryType)
{
    If (('AppsOnly','DesktopsAndApps','DesktopsOnly') -contains $DeliveryType ) {
    }
    Else
    {
        Fail-Json $result "Option DeliveryType has invalid value $DeliveryType. Valid values are 'AppsOnly','DesktopsAndApps','DesktopsOnly'"
    }
}
...
If ($DesktopType)
{
    If (('Private','Shared') -contains $DesktopType ) {
    }
    Else
    {
        Fail-Json $result "Option DesktopType has invalid value $DesktopType. Valid values are 'Private','Shared'"
    }
}
...
If ($ColorDepth)
{
    If (('EightBit','FourBit','SixteenBit','TwentyFourBit') -contains $ColorDepth ) {
    }
    Else
    {
        Fail-Json $result "Option ColorDepth has invalid value $ColorDepth. Valid values are 'EightBit','FourBit','SixteenBit','TwentyFourBit'"
    }
}
...
$DscResourceName = "XD7DesktopGroup"
