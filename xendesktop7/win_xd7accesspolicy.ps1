...
#ATTRIBUTE:AccessType;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:AccessGateway,Direct
$AccessType = Get-Attr -obj $params -name AccessType -failifempty $True -resultobj $result
#ATTRIBUTE:DeliveryGroup;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DeliveryGroup = Get-Attr -obj $params -name DeliveryGroup -failifempty $True -resultobj $result
#ATTRIBUTE:AllowRestart;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowRestart = Get-Attr -obj $params -name AllowRestart -failifempty $False -resultobj $result
...
#ATTRIBUTE:ExcludeUsers;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ExcludeUsers = Get-Attr -obj $params -name ExcludeUsers -failifempty $False -resultobj $result
#ATTRIBUTE:IncludeUsers;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IncludeUsers = Get-Attr -obj $params -name IncludeUsers -failifempty $False -resultobj $result
...
#ATTRIBUTE:Protocol;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:HDX,RDP
...
If ($AccessType)
{
    If (('AccessGateway','Direct') -contains $AccessType ) {
    }
    Else
    {
        Fail-Json $result "Option AccessType has invalid value $AccessType. Valid values are 'AccessGateway','Direct'"
    }
}
...
If ($Protocol)
{
    If (('HDX','RDP') -contains $Protocol ) {
    }
    Else
    {
        Fail-Json $result "Option Protocol has invalid value $Protocol. Valid values are 'HDX','RDP'"
    }
}
...
$DscResourceName = "XD7AccessPolicy"
