...
#ATTRIBUTE:InstallDir;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$InstallDir = Get-Attr -obj $params -name InstallDir -failifempty $True -resultobj $result
...
$DscResourceName = "InstallBlendSDK"

$DscModuleName = "ceprsinstallblendsdk"
