...
#ATTRIBUTE:PreserveInherited;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PreserveInherited = Get-Attr -obj $params -name PreserveInherited -failifempty $False -resultobj $result
