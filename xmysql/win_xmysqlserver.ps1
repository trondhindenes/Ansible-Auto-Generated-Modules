...
if ($RootPassword_username)
{
$RootPassword_securepassword = $RootPassword_password | ConvertTo-SecureString -asPlainText -Force
$RootPassword = New-Object System.Management.Automation.PSCredential($RootPassword_username,$RootPassword_securepassword)
}
