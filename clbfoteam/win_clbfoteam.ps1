...
#ATTRIBUTE:TeamMembers;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TeamMembers = Get-Attr -obj $params -name TeamMembers -failifempty $True -resultobj $result
#ATTRIBUTE:TeamName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TeamName = Get-Attr -obj $params -name TeamName -failifempty $True -resultobj $result
#ATTRIBUTE:Ensure;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Absent,Present
$Ensure = Get-Attr -obj $params -name Ensure -failifempty $False -resultobj $result
#ATTRIBUTE:LBAlgorithm;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Dynamic,HyperVPort,IPAddresses,MacAddresses,TransportPorts
$LBAlgorithm = Get-Attr -obj $params -name LBAlgorithm -failifempty $False -resultobj $result
...
#ATTRIBUTE:TeamingMode;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:LACP,Static,SwitchIndependent
...
If ($LBAlgorithm)
{
    If (('Dynamic','HyperVPort','IPAddresses','MacAddresses','TransportPorts') -contains $LBAlgorithm ) {
    }
    Else
    {
        Fail-Json $result "Option LBAlgorithm has invalid value $LBAlgorithm. Valid values are 'Dynamic','HyperVPort','IPAddresses','MacAddresses','TransportPorts'"
    }
}
...
If ($TeamingMode)
{
    If (('LACP','Static','SwitchIndependent') -contains $TeamingMode ) {
    }
    Else
    {
        Fail-Json $result "Option TeamingMode has invalid value $TeamingMode. Valid values are 'LACP','Static','SwitchIndependent'"
    }
}
...
$DscResourceName = "cLBFOTeam"

$DscModuleName = "clbfoteam"
