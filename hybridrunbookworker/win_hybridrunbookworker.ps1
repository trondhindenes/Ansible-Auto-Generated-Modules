...
#ATTRIBUTE:Endpoint;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Endpoint = Get-Attr -obj $params -name Endpoint -failifempty $True -resultobj $result
...
#ATTRIBUTE:Token_username;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Token_username = Get-Attr -obj $params -name Token_username -failifempty $True -resultobj $result
#ATTRIBUTE:Token_password;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Token_password = Get-Attr -obj $params -name Token_password -failifempty $True -resultobj $result
...
if ($Token_username)
{
$Token_securepassword = $Token_password | ConvertTo-SecureString -asPlainText -Force
$Token = New-Object System.Management.Automation.PSCredential($Token_username,$Token_securepassword)
}
...
$DscResourceName = "HybridRunbookWorker"

$DscModuleName = "hybridrunbookworker"
