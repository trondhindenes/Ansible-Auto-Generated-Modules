...
#ATTRIBUTE:RealTimeScanDirection;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Both,Incoming,Outcoming
...
#ATTRIBUTE:SubmitSamplesConsent;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Always,Never,None
...
{
    If (('Both','Incoming','Outcoming') -contains $RealTimeScanDirection ) {
    }
    Else
    {
        Fail-Json $result "Option RealTimeScanDirection has invalid value $RealTimeScanDirection. Valid values are 'Both','Incoming','Outcoming'"
    }
}
...
{
    If (('Always','Never','None') -contains $SubmitSamplesConsent ) {
    }
    Else
    {
        Fail-Json $result "Option SubmitSamplesConsent has invalid value $SubmitSamplesConsent. Valid values are 'Always','Never','None'"
    }
}
...
$DscResourceName = "WindowsDefender"

$DscModuleName = "windowsdefender"
