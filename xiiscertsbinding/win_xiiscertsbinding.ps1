...
#ATTRIBUTE:BindingUrl;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$BindingUrl = Get-Attr -obj $params -name BindingUrl -failifempty $True -resultobj $result
#ATTRIBUTE:CertThumbprint;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CertThumbprint = Get-Attr -obj $params -name CertThumbprint -failifempty $True -resultobj $result
#ATTRIBUTE:IP;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IP = Get-Attr -obj $params -name IP -failifempty $True -resultobj $result
...
$DscResourceName = "xIISCertSBinding"

$DscModuleName = "xiiscertsbinding"
