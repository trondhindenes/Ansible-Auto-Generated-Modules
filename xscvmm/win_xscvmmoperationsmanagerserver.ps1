...
if ($SCVMMAdminCredential_username)
{
$SCVMMAdminCredential_securepassword = $SCVMMAdminCredential_password | ConvertTo-SecureString -asPlainText -Force
$SCVMMAdminCredential = New-Object System.Management.Automation.PSCredential($SCVMMAdminCredential_username,$SCVMMAdminCredential_securepassword)
}

if ($VMMServerCredential_username)
{
$VMMServerCredential_securepassword = $VMMServerCredential_password | ConvertTo-SecureString -asPlainText -Force
$VMMServerCredential = New-Object System.Management.Automation.PSCredential($VMMServerCredential_username,$VMMServerCredential_securepassword)
}
...
$DscResourceName = "xSCVMMOperationsManagerServer"
