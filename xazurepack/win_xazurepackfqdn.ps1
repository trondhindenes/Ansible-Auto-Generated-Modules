...
#ATTRIBUTE:FullyQualifiedDomainName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FullyQualifiedDomainName = Get-Attr -obj $params -name FullyQualifiedDomainName -failifempty $True -resultobj $result
#ATTRIBUTE:Namespace;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:AdminSite,AuthSite,TenantSite,WindowsAuthSite
...
If ($Namespace)
{
    If (('AdminSite','AuthSite','TenantSite','WindowsAuthSite') -contains $Namespace ) {
    }
    Else
    {
        Fail-Json $result "Option Namespace has invalid value $Namespace. Valid values are 'AdminSite','AuthSite','TenantSite','WindowsAuthSite'"
    }
}
...
$DscResourceName = "xAzurePackFQDN"
