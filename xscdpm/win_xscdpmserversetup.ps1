...
if ($ReportingMachineCredential_username)
{
$ReportingMachineCredential_securepassword = $ReportingMachineCredential_password | ConvertTo-SecureString -asPlainText -Force
$ReportingMachineCredential = New-Object System.Management.Automation.PSCredential($ReportingMachineCredential_username,$ReportingMachineCredential_securepassword)
}
...
if ($YukonMachineCredential_username)
{
$YukonMachineCredential_securepassword = $YukonMachineCredential_password | ConvertTo-SecureString -asPlainText -Force
$YukonMachineCredential = New-Object System.Management.Automation.PSCredential($YukonMachineCredential_username,$YukonMachineCredential_securepassword)
}
...
$DscResourceName = "xSCDPMServerSetup"

$DscModuleName = "xscdpm"
