...
#ATTRIBUTE:FailoverClusterNetworkName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:
$FailoverClusterNetworkName = Get-Attr -obj $params -name FailoverClusterNetworkName -failifempty $True -resultobj $result
#ATTRIBUTE:Features;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:
...
#ATTRIBUTE:SQLSvcAccount_username;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:
$SQLSvcAccount_username = Get-Attr -obj $params -name SQLSvcAccount_username -failifempty $True -resultobj $result
#ATTRIBUTE:SQLSvcAccount_password;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:
$SQLSvcAccount_password = Get-Attr -obj $params -name SQLSvcAccount_password -failifempty $True -resultobj $result
...
#ATTRIBUTE:FailoverClusterGroup;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:
$FailoverClusterGroup = Get-Attr -obj $params -name FailoverClusterGroup -failifempty $False -resultobj $result
#ATTRIBUTE:FailoverClusterIPAddress;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:
...
#ATTRIBUTE:ISFileSystemFolder;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:
$ISFileSystemFolder = Get-Attr -obj $params -name ISFileSystemFolder -failifempty $False -resultobj $result
