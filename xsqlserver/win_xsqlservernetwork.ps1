...
$ProtocolName = Get-Attr -obj $params -name ProtocolName -failifempty $True -resultobj $result
...
$RestartService = Get-Attr -obj $params -name RestartService -failifempty $False -resultobj $result
#ATTRIBUTE:TCPDynamicPorts;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TCPDynamicPorts = Get-Attr -obj $params -name TCPDynamicPorts -failifempty $False -resultobj $result
