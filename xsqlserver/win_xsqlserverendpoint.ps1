...
#ATTRIBUTE:AuthorizedUser;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AuthorizedUser = Get-Attr -obj $params -name AuthorizedUser -failifempty $False -resultobj $result
