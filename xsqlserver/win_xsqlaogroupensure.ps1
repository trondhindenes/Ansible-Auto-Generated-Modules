...
$AvailabilityGroupName = Get-Attr -obj $params -name AvailabilityGroupName -failifempty $True -resultobj $result
...
$AvailabilityGroupNameListener = Get-Attr -obj $params -name AvailabilityGroupNameListener -failifempty $False -resultobj $result
...
$ReadableSecondary = Get-Attr -obj $params -name ReadableSecondary -failifempty $False -resultobj $result
