...
$AdminLinkCredentials_username = Get-Attr -obj $params -name AdminLinkCredentials_username -failifempty $True -resultobj $result
#ATTRIBUTE:AdminLinkCredentials_password;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AdminLinkCredentials_password = Get-Attr -obj $params -name AdminLinkCredentials_password -failifempty $True -resultobj $result
#ATTRIBUTE:DistributorMode;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Local,Remote
$DistributorMode = Get-Attr -obj $params -name DistributorMode -failifempty $True -resultobj $result
...
$DistributionDBName = Get-Attr -obj $params -name DistributionDBName -failifempty $False -resultobj $result
...
$RemoteDistributor = Get-Attr -obj $params -name RemoteDistributor -failifempty $False -resultobj $result
#ATTRIBUTE:UninstallWithForce;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UninstallWithForce = Get-Attr -obj $params -name UninstallWithForce -failifempty $False -resultobj $result
#ATTRIBUTE:UseTrustedConnection;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UseTrustedConnection = Get-Attr -obj $params -name UseTrustedConnection -failifempty $False -resultobj $result
