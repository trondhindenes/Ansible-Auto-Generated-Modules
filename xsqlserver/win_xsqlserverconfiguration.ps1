...
$OptionName = Get-Attr -obj $params -name OptionName -failifempty $True -resultobj $result
#ATTRIBUTE:OptionValue;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$OptionValue = Get-Attr -obj $params -name OptionValue -failifempty $True -resultobj $result
