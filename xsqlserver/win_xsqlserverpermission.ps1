...
#ATTRIBUTE:Permission;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:AlterAnyAvailabilityGroup,AlterAnyEndPoint,ViewServerState
...
If ($Permission)
{
    If (('AlterAnyAvailabilityGroup','AlterAnyEndPoint','ViewServerState') -contains $Permission ) {
    }
    Else
    {
        Fail-Json $result "Option Permission has invalid value $Permission. Valid values are 'AlterAnyAvailabilityGroup','AlterAnyEndPoint','ViewServerState'"
    }
}
