...
$AvailabilityGroup = Get-Attr -obj $params -name AvailabilityGroup -failifempty $True -resultobj $result
...
$DHCP = Get-Attr -obj $params -name DHCP -failifempty $False -resultobj $result
