...
$GetFilePath = Get-Attr -obj $params -name GetFilePath -failifempty $True -resultobj $result
#ATTRIBUTE:ServerInstance;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ServerInstance = Get-Attr -obj $params -name ServerInstance -failifempty $True -resultobj $result
#ATTRIBUTE:SetFilePath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SetFilePath = Get-Attr -obj $params -name SetFilePath -failifempty $True -resultobj $result
#ATTRIBUTE:TestFilePath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TestFilePath = Get-Attr -obj $params -name TestFilePath -failifempty $True -resultobj $result
...
$Variable = Get-Attr -obj $params -name Variable -failifempty $False -resultobj $result
