...
If ($AdapterWarnings)
{
    If (('Disabled','Enabled') -contains $AdapterWarnings ) {
    }
    Else
    {
        Fail-Json $result "Option AdapterWarnings has invalid value $AdapterWarnings. Valid values are 'Disabled','Enabled'"
    }
}
...
If ($Fastboot)
{
    If (('Auto','Minimal','Thorough') -contains $Fastboot ) {
    }
    Else
    {
        Fail-Json $result "Option Fastboot has invalid value $Fastboot. Valid values are 'Auto','Minimal','Thorough'"
    }
}
...
If ($FnKeyEmulation)
{
    If (('Disabled','Enabled') -contains $FnKeyEmulation ) {
    }
    Else
    {
        Fail-Json $result "Option FnKeyEmulation has invalid value $FnKeyEmulation. Valid values are 'Disabled','Enabled'"
    }
}
...
If ($KeyboardErrors)
{
    If (('Disabled','Enabled') -contains $KeyboardErrors ) {
    }
    Else
    {
        Fail-Json $result "Option KeyboardErrors has invalid value $KeyboardErrors. Valid values are 'Disabled','Enabled'"
    }
}
...
If ($Keypad)
{
    If (('ByNumlock','FnKeyOnly') -contains $Keypad ) {
    }
    Else
    {
        Fail-Json $result "Option Keypad has invalid value $Keypad. Valid values are 'ByNumlock','FnKeyOnly'"
    }
}
...
If ($MEBxHotKey)
{
    If (('Disabled','Enabled') -contains $MEBxHotKey ) {
    }
    Else
    {
        Fail-Json $result "Option MEBxHotKey has invalid value $MEBxHotKey. Valid values are 'Disabled','Enabled'"
    }
}
...
If ($MouseTouchpad)
{
    If (('PS2Mouse','SerialMouse','SwitchToExternalPS2','SwitchToTouchpad') -contains $MouseTouchpad ) {
    }
    Else
    {
        Fail-Json $result "Option MouseTouchpad has invalid value $MouseTouchpad. Valid values are 'PS2Mouse','SerialMouse','SwitchToExternalPS2','SwitchToTouchpad'"
    }
}
...
If ($Numlock)
{
    If (('Disabled','Enabled') -contains $Numlock ) {
    }
    Else
    {
        Fail-Json $result "Option Numlock has invalid value $Numlock. Valid values are 'Disabled','Enabled'"
    }
}
...
If ($POSTHotKeys)
{
    If (('DisableF12BootOptionMenu','EnableF12BootOptionMenu') -contains $POSTHotKeys ) {
    }
    Else
    {
