...
#ATTRIBUTE:SettingType;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:DatabaseConnectionString,EndPointConnectionString
...
If ($SettingType)
{
    ...
    Else
    {
        Fail-Json $result "Option SettingType has invalid value $SettingType. Valid values are 'DatabaseConnectionString','EndPointConnectionString'"
    }
}
