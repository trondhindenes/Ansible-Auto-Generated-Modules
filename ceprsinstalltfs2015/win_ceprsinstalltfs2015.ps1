...
#ATTRIBUTE:TFSInstallerPath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TFSInstallerPath = Get-Attr -obj $params -name TFSInstallerPath -failifempty $True -resultobj $result
...
$DscResourceName = "cEPRSInstallTFS2015"

$DscModuleName = "ceprsinstalltfs2015"
