...
#ATTRIBUTE:PackageManagementProvider;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PackageManagementProvider = Get-Attr -obj $params -name PackageManagementProvider -failifempty $False -resultobj $result
...
#ATTRIBUTE:PublishLocation;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PublishLocation = Get-Attr -obj $params -name PublishLocation -failifempty $False -resultobj $result
#ATTRIBUTE:SourceLocation;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SourceLocation = Get-Attr -obj $params -name SourceLocation -failifempty $False -resultobj $result
...
$DscResourceName = "cPowerShellRepository"
