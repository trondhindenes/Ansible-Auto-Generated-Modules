...
#ATTRIBUTE:PSModuleName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PSModuleName = Get-Attr -obj $params -name PSModuleName -failifempty $True -resultobj $result
#ATTRIBUTE:RepositoryName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RepositoryName = Get-Attr -obj $params -name RepositoryName -failifempty $True -resultobj $result
#ATTRIBUTE:Ensure;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Absent,Present
$Ensure = Get-Attr -obj $params -name Ensure -failifempty $False -resultobj $result
#ATTRIBUTE:MaintenanceLengthMinute;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MaintenanceLengthMinute = Get-Attr -obj $params -name MaintenanceLengthMinute -failifempty $False -resultobj $result
#ATTRIBUTE:MaintenanceStartHour;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MaintenanceStartHour = Get-Attr -obj $params -name MaintenanceStartHour -failifempty $False -resultobj $result
#ATTRIBUTE:MaintenanceStartMinute;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MaintenanceStartMinute = Get-Attr -obj $params -name MaintenanceStartMinute -failifempty $False -resultobj $result
...
#ATTRIBUTE:PSModuleVersion;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PSModuleVersion = Get-Attr -obj $params -name PSModuleVersion -failifempty $False -resultobj $result
...
$DscResourceName = "cPowerShellModuleManagement"

$DscModuleName = "cpowershellpackagemanagement"
