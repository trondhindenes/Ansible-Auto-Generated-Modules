...
#ATTRIBUTE:DtcName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DtcName = Get-Attr -obj $params -name DtcName -failifempty $True -resultobj $result
...
#ATTRIBUTE:LUTransactionsEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LUTransactionsEnabled = Get-Attr -obj $params -name LUTransactionsEnabled -failifempty $False -resultobj $result
...
#ATTRIBUTE:XATransactionsEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$XATransactionsEnabled = Get-Attr -obj $params -name XATransactionsEnabled -failifempty $False -resultobj $result
...
$DscResourceName = "cDtcNetworkSetting"
