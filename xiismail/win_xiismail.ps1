...
#ATTRIBUTE:DeliveryMethod;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DeliveryMethod = Get-Attr -obj $params -name DeliveryMethod -failifempty $True -resultobj $result
...
#ATTRIBUTE:DefaultCredentials;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DefaultCredentials = Get-Attr -obj $params -name DefaultCredentials -failifempty $False -resultobj $result
#ATTRIBUTE:From;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$From = Get-Attr -obj $params -name From -failifempty $False -resultobj $result
#ATTRIBUTE:MailHost;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MailHost = Get-Attr -obj $params -name MailHost -failifempty $False -resultobj $result
...
#ATTRIBUTE:PickupDirectoryLocation;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PickupDirectoryLocation = Get-Attr -obj $params -name PickupDirectoryLocation -failifempty $False -resultobj $result
...
$DscResourceName = "xIISMail"

$DscModuleName = "xiismail"
