...
#ATTRIBUTE:BinaryDir;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:
$BinaryDir = Get-Attr -obj $params -name BinaryDir -failifempty $True -resultobj $result
#ATTRIBUTE:ProductKey;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:
$ProductKey = Get-Attr -obj $params -name ProductKey -failifempty $True -resultobj $result
#ATTRIBUTE:AutoInstallModule;MANDATORY:False;DEFAULTVALUE:false;DESCRIPTION:If true, the required dsc resource/module will be auto-installed using the Powershell package manager
$AutoInstallModule = Get-Attr -obj $params -name AutoInstallModule -failifempty $False -resultobj $result
#ATTRIBUTE:AutoConfigureLcm;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:If true, LCM will be auto-configured for directly invoking DSC resources (which is a one-time requirement for Ansible DSC modules)
$AutoConfigureLcm = Get-Attr -obj $params -name AutoConfigureLcm -failifempty $False -resultobj $result
$DscResourceName = "xSPInstall"
