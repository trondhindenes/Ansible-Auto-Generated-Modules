...
#ATTRIBUTE:ChocoInstallScriptUrl;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ChocoInstallScriptUrl = Get-Attr -obj $params -name ChocoInstallScriptUrl -failifempty $False -resultobj $result
...
$DscResourceName = "cChocoInstaller"

$DscModuleName = "cchoco-testing"
