...
If ($SendCEIPReports)
{
    If (('No','Yes') -contains $SendCEIPReports ) {
    }
    Else
    {
        Fail-Json $result "Option SendCEIPReports has invalid value $SendCEIPReports. Valid values are 'No','Yes'"
    }
}
...
{
    If (('No','Yes') -contains $UseMicrosoftUpdate ) {
    }
    Else
    {
...
$DscResourceName = "xSCSRServerSetup"
