...
#ATTRIBUTE:ContainerImageName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ContainerImageName = Get-Attr -obj $params -name ContainerImageName -failifempty $True -resultobj $result
...
#ATTRIBUTE:ContainerComputerName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ContainerComputerName = Get-Attr -obj $params -name ContainerComputerName -failifempty $False -resultobj $result
#ATTRIBUTE:ContainerImagePublisher;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ContainerImagePublisher = Get-Attr -obj $params -name ContainerImagePublisher -failifempty $False -resultobj $result
#ATTRIBUTE:ContainerImageVersion;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ContainerImageVersion = Get-Attr -obj $params -name ContainerImageVersion -failifempty $False -resultobj $result
#ATTRIBUTE:ContainerType;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Default,HyperV
$ContainerType = Get-Attr -obj $params -name ContainerType -failifempty $False -resultobj $result
...
If ($ContainerType)
{
    If (('Default','HyperV') -contains $ContainerType ) {
    }
    Else
    {
        Fail-Json $result "Option ContainerType has invalid value $ContainerType. Valid values are 'Default','HyperV'"
    }
}
...
$DscResourceName = "cWindowsContainer"

$DscModuleName = "cwindowscontainer"
