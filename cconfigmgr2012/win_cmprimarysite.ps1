...
#ATTRIBUTE:SiteCode;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SiteCode = Get-Attr -obj $params -name SiteCode -failifempty $True -resultobj $result
...
#ATTRIBUTE:DPServer;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DPServer = Get-Attr -obj $params -name DPServer -failifempty $False -resultobj $result
...
#ATTRIBUTE:MPServer;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MPServer = Get-Attr -obj $params -name MPServer -failifempty $False -resultobj $result
#ATTRIBUTE:PrereqPath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PrereqPath = Get-Attr -obj $params -name PrereqPath -failifempty $False -resultobj $result
...
#ATTRIBUTE:SMSProviderServer;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SMSProviderServer = Get-Attr -obj $params -name SMSProviderServer -failifempty $False -resultobj $result
#ATTRIBUTE:SQLPort;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SQLPort = Get-Attr -obj $params -name SQLPort -failifempty $False -resultobj $result
#ATTRIBUTE:SQLServerInstance;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SQLServerInstance = Get-Attr -obj $params -name SQLServerInstance -failifempty $False -resultobj $result
...
$DscResourceName = "CMPrimarySite"

$DscModuleName = "cconfigmgr2012"
