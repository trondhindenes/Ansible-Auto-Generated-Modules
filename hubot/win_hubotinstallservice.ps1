...
#ATTRIBUTE:BotAdapter;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$BotAdapter = Get-Attr -obj $params -name BotAdapter -failifempty $True -resultobj $result
#ATTRIBUTE:BotPath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$BotPath = Get-Attr -obj $params -name BotPath -failifempty $True -resultobj $result
...
$DscResourceName = "HubotInstallService"
