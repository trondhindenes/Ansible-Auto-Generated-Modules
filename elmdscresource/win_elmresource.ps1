...
#ATTRIBUTE:ElmExePath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ElmExePath = Get-Attr -obj $params -name ElmExePath -failifempty $True -resultobj $result
#ATTRIBUTE:ElmInputFile;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ElmInputFile = Get-Attr -obj $params -name ElmInputFile -failifempty $True -resultobj $result
#ATTRIBUTE:ElmOutputFile;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ElmOutputFile = Get-Attr -obj $params -name ElmOutputFile -failifempty $True -resultobj $result
...
$DscResourceName = "ElmResource"

$DscModuleName = "elmdscresource"
