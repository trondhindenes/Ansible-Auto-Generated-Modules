...
#ATTRIBUTE:Delete;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Delete = Get-Attr -obj $params -name Delete -failifempty $False -resultobj $result
#ATTRIBUTE:Overwrite;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Overwrite = Get-Attr -obj $params -name Overwrite -failifempty $False -resultobj $result
...
$DscResourceName = "ROWBuildingBlock"
