...
#ATTRIBUTE:Agent;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:AgentOnly,Full
$Agent = Get-Attr -obj $params -name Agent -failifempty $True -resultobj $result
#ATTRIBUTE:EnableWorkspaceComposer;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EnableWorkspaceComposer = Get-Attr -obj $params -name EnableWorkspaceComposer -failifempty $True -resultobj $result
#ATTRIBUTE:EnvironmentGuid;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EnvironmentGuid = Get-Attr -obj $params -name EnvironmentGuid -failifempty $True -resultobj $result
#ATTRIBUTE:EnvironmentPassword_username;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EnvironmentPassword_username = Get-Attr -obj $params -name EnvironmentPassword_username -failifempty $True -resultobj $result
#ATTRIBUTE:EnvironmentPassword_password;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EnvironmentPassword_password = Get-Attr -obj $params -name EnvironmentPassword_password -failifempty $True -resultobj $result
#ATTRIBUTE:InheritSettings;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$InheritSettings = Get-Attr -obj $params -name InheritSettings -failifempty $True -resultobj $result
#ATTRIBUTE:Path;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Path = Get-Attr -obj $params -name Path -failifempty $True -resultobj $result
#ATTRIBUTE:AddToWorkspace;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AddToWorkspace = Get-Attr -obj $params -name AddToWorkspace -failifempty $False -resultobj $result
#ATTRIBUTE:Ensure;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Absent,Present
$Ensure = Get-Attr -obj $params -name Ensure -failifempty $False -resultobj $result
#ATTRIBUTE:EnvironmentPasswordIsHashed;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EnvironmentPasswordIsHashed = Get-Attr -obj $params -name EnvironmentPasswordIsHashed -failifempty $False -resultobj $result
#ATTRIBUTE:ForceRestart;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ForceRestart = Get-Attr -obj $params -name ForceRestart -failifempty $False -resultobj $result
#ATTRIBUTE:IsLiteralPath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IsLiteralPath = Get-Attr -obj $params -name IsLiteralPath -failifempty $False -resultobj $result
#ATTRIBUTE:NoDesktopShortcut;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$NoDesktopShortcut = Get-Attr -obj $params -name NoDesktopShortcut -failifempty $False -resultobj $result
#ATTRIBUTE:NoStartMenuShortcut;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$NoStartMenuShortcut = Get-Attr -obj $params -name NoStartMenuShortcut -failifempty $False -resultobj $result
...
#ATTRIBUTE:RelayServerDiscovery;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RelayServerDiscovery = Get-Attr -obj $params -name RelayServerDiscovery -failifempty $False -resultobj $result
#ATTRIBUTE:RelayServerDnsName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RelayServerDnsName = Get-Attr -obj $params -name RelayServerDnsName -failifempty $False -resultobj $result
#ATTRIBUTE:RelayServerList;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RelayServerList = Get-Attr -obj $params -name RelayServerList -failifempty $False -resultobj $result
...
If ($Agent)
{
    If (('AgentOnly','Full') -contains $Agent ) {
    }
    Else
    {
        Fail-Json $result "Option Agent has invalid value $Agent. Valid values are 'AgentOnly','Full'"
    }
}
...
if ($EnvironmentPassword_username)
{
$EnvironmentPassword_securepassword = $EnvironmentPassword_password | ConvertTo-SecureString -asPlainText -Force
$EnvironmentPassword = New-Object System.Management.Automation.PSCredential($EnvironmentPassword_username,$EnvironmentPassword_securepassword)
}
...
$DscResourceName = "ROWRelayServerAgent"

$DscModuleName = "resoneworkspace"
