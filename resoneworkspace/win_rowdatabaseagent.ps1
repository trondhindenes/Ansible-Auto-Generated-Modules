...
#ATTRIBUTE:ServiceAccountCredential_username;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ServiceAccountCredential_username = Get-Attr -obj $params -name ServiceAccountCredential_username -failifempty $False -resultobj $result
#ATTRIBUTE:ServiceAccountCredential_password;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ServiceAccountCredential_password = Get-Attr -obj $params -name ServiceAccountCredential_password -failifempty $False -resultobj $result
#ATTRIBUTE:UseDatabaseProtocolEncryption;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UseDatabaseProtocolEncryption = Get-Attr -obj $params -name UseDatabaseProtocolEncryption -failifempty $False -resultobj $result
...
if ($ServiceAccountCredential_username)
{
$ServiceAccountCredential_securepassword = $ServiceAccountCredential_password | ConvertTo-SecureString -asPlainText -Force
$ServiceAccountCredential = New-Object System.Management.Automation.PSCredential($ServiceAccountCredential_username,$ServiceAccountCredential_securepassword)
}

$DscResourceName = "ROWDatabaseAgent"
