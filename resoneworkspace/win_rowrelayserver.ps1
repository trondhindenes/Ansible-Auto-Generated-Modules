...
#ATTRIBUTE:CachePath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CachePath = Get-Attr -obj $params -name CachePath -failifempty $False -resultobj $result
...
$DscResourceName = "ROWRelayServer"
