...
#ATTRIBUTE:Architecture;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Architecture = Get-Attr -obj $params -name Architecture -failifempty $False -resultobj $result
...
$DscResourceName = "ROWCitrixProcessIntercept"
