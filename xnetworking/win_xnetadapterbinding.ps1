...
#ATTRIBUTE:ComponentId;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ComponentId = Get-Attr -obj $params -name ComponentId -failifempty $True -resultobj $result
...
If ($State)
{
    If (('Disabled','Enabled') -contains $State ) {
    }
    Else
    {
...
$DscResourceName = "xNetAdapterBinding"
