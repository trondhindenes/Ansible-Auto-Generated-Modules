...
#ATTRIBUTE:ConnectionSpecificSuffix;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ConnectionSpecificSuffix = Get-Attr -obj $params -name ConnectionSpecificSuffix -failifempty $True -resultobj $result
...
#ATTRIBUTE:RegisterThisConnectionsAddress;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RegisterThisConnectionsAddress = Get-Attr -obj $params -name RegisterThisConnectionsAddress -failifempty $False -resultobj $result
#ATTRIBUTE:UseSuffixWhenRegistering;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UseSuffixWhenRegistering = Get-Attr -obj $params -name UseSuffixWhenRegistering -failifempty $False -resultobj $result
...
$DscResourceName = "xDnsConnectionSuffix"
