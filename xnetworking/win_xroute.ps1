...
#ATTRIBUTE:DestinationPrefix;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DestinationPrefix = Get-Attr -obj $params -name DestinationPrefix -failifempty $True -resultobj $result
...
#ATTRIBUTE:NextHop;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$NextHop = Get-Attr -obj $params -name NextHop -failifempty $True -resultobj $result
#ATTRIBUTE:Ensure;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Absent,Present
$Ensure = Get-Attr -obj $params -name Ensure -failifempty $False -resultobj $result
#ATTRIBUTE:PreferredLifetime;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PreferredLifetime = Get-Attr -obj $params -name PreferredLifetime -failifempty $False -resultobj $result
...
#ATTRIBUTE:Publish;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Age,No,Yes
$Publish = Get-Attr -obj $params -name Publish -failifempty $False -resultobj $result
#ATTRIBUTE:RouteMetric;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RouteMetric = Get-Attr -obj $params -name RouteMetric -failifempty $False -resultobj $result
...
If ($Publish)
{
    If (('Age','No','Yes') -contains $Publish ) {
    }
    Else
    {
        Fail-Json $result "Option Publish has invalid value $Publish. Valid values are 'Age','No','Yes'"
    }
}
