...
#ATTRIBUTE:DevolutionLevel;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DevolutionLevel = Get-Attr -obj $params -name DevolutionLevel -failifempty $False -resultobj $result
...
#ATTRIBUTE:SuffixSearchList;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SuffixSearchList = Get-Attr -obj $params -name SuffixSearchList -failifempty $False -resultobj $result
#ATTRIBUTE:UseDevolution;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UseDevolution = Get-Attr -obj $params -name UseDevolution -failifempty $False -resultobj $result
...
$DscResourceName = "xDnsClientGlobalSetting"
