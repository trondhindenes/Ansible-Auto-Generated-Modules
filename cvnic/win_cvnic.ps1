...
#ATTRIBUTE:vNICName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$vNICName = Get-Attr -obj $params -name vNICName -failifempty $True -resultobj $result
...
#ATTRIBUTE:VLAN;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$VLAN = Get-Attr -obj $params -name VLAN -failifempty $False -resultobj $result
