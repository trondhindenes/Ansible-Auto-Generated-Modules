...
#ATTRIBUTE:PortalEdition;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:EXPRESS,EXTEND,MP,WCM
$PortalEdition = Get-Attr -obj $params -name PortalEdition -failifempty $True -resultobj $result
#ATTRIBUTE:Version;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Version = Get-Attr -obj $params -name Version -failifempty $True -resultobj $result
#ATTRIBUTE:WebSphereAdministratorCredential_username;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WebSphereAdministratorCredential_username = Get-Attr -obj $params -name WebSphereAdministratorCredential_username -failifempty $True -resultobj $result
#ATTRIBUTE:WebSphereAdministratorCredential_password;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WebSphereAdministratorCredential_password = Get-Attr -obj $params -name WebSphereAdministratorCredential_password -failifempty $True -resultobj $result
#ATTRIBUTE:CellName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CellName = Get-Attr -obj $params -name CellName -failifempty $False -resultobj $result
#ATTRIBUTE:IMSharedLocation;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IMSharedLocation = Get-Attr -obj $params -name IMSharedLocation -failifempty $False -resultobj $result
#ATTRIBUTE:InstallationDirectory;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$InstallationDirectory = Get-Attr -obj $params -name InstallationDirectory -failifempty $False -resultobj $result
#ATTRIBUTE:InstallMediaConfig;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$InstallMediaConfig = Get-Attr -obj $params -name InstallMediaConfig -failifempty $False -resultobj $result
#ATTRIBUTE:NodeName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$NodeName = Get-Attr -obj $params -name NodeName -failifempty $False -resultobj $result
#ATTRIBUTE:PortalAdministratorCredential_username;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PortalAdministratorCredential_username = Get-Attr -obj $params -name PortalAdministratorCredential_username -failifempty $False -resultobj $result
#ATTRIBUTE:PortalAdministratorCredential_password;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PortalAdministratorCredential_password = Get-Attr -obj $params -name PortalAdministratorCredential_password -failifempty $False -resultobj $result
#ATTRIBUTE:Primary;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Primary = Get-Attr -obj $params -name Primary -failifempty $False -resultobj $result
#ATTRIBUTE:ProfileName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ProfileName = Get-Attr -obj $params -name ProfileName -failifempty $False -resultobj $result
...
#ATTRIBUTE:ResponseFileTemplate;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ResponseFileTemplate = Get-Attr -obj $params -name ResponseFileTemplate -failifempty $False -resultobj $result
...
If ($PortalEdition)
{
    If (('EXPRESS','EXTEND','MP','WCM') -contains $PortalEdition ) {
    }
    Else
    {
        Fail-Json $result "Option PortalEdition has invalid value $PortalEdition. Valid values are 'EXPRESS','EXTEND','MP','WCM'"
    }
}
...
if ($WebSphereAdministratorCredential_username)
{
$WebSphereAdministratorCredential_securepassword = $WebSphereAdministratorCredential_password | ConvertTo-SecureString -asPlainText -Force
$WebSphereAdministratorCredential = New-Object System.Management.Automation.PSCredential($WebSphereAdministratorCredential_username,$WebSphereAdministratorCredential_securepassword)
}

if ($PortalAdministratorCredential_username)
{
$PortalAdministratorCredential_securepassword = $PortalAdministratorCredential_password | ConvertTo-SecureString -asPlainText -Force
$PortalAdministratorCredential = New-Object System.Management.Automation.PSCredential($PortalAdministratorCredential_username,$PortalAdministratorCredential_securepassword)
}
...
$DscResourceName = "cIBMWebSpherePortal"
