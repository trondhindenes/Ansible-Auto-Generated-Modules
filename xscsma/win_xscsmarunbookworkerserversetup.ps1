...
#ATTRIBUTE:Service_username;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Service_username = Get-Attr -obj $params -name Service_username -failifempty $True -resultobj $result
#ATTRIBUTE:Service_password;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
...
if ($Service_username)
{
$Service_securepassword = $Service_password | ConvertTo-SecureString -asPlainText -Force
$Service = New-Object System.Management.Automation.PSCredential($Service_username,$Service_securepassword)
}
...
$DscResourceName = "xSCSMARunbookWorkerServerSetup"
