...
if ($ApPool_username)
{
$ApPool_securepassword = $ApPool_password | ConvertTo-SecureString -asPlainText -Force
$ApPool = New-Object System.Management.Automation.PSCredential($ApPool_username,$ApPool_securepassword)
}
...
$DscResourceName = "xSCSMAWebServiceServerSetup"
