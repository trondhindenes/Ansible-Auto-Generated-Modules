...
#ATTRIBUTE:Ensure;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Absent,Draft,Published
$Ensure = Get-Attr -obj $params -name Ensure -failifempty $True -resultobj $result
#ATTRIBUTE:RunbookPath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RunbookPath = Get-Attr -obj $params -name RunbookPath -failifempty $True -resultobj $result
#ATTRIBUTE:WebServiceEndpoint;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WebServiceEndpoint = Get-Attr -obj $params -name WebServiceEndpoint -failifempty $True -resultobj $result
...
If ($Ensure)
{
    If (('Absent','Draft','Published') -contains $Ensure ) {
    }
    Else
    {
        Fail-Json $result "Option Ensure has invalid value $Ensure. Valid values are 'Absent','Draft','Published'"
    }
}
...
$DscResourceName = "RunbookDirectory"

$DscModuleName = "xscsma"
