...
#ATTRIBUTE:Subfolders;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Subfolders = Get-Attr -obj $params -name Subfolders -failifempty $True -resultobj $result
#ATTRIBUTE:Template;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Template = Get-Attr -obj $params -name Template -failifempty $True -resultobj $result
