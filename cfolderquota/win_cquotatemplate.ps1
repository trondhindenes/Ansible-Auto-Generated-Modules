...
#ATTRIBUTE:Percentage;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Percentage = Get-Attr -obj $params -name Percentage -failifempty $False -resultobj $result
...
$DscResourceName = "cQuotaTemplate"

$DscModuleName = "cfolderquota"
