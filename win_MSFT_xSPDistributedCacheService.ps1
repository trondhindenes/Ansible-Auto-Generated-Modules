...
#ATTRIBUTE:CacheSizeInMB,MANDATORY:True,DEFAULTVALUE:,DESCRIPTION:
$CacheSizeInMB = Get-Attr -obj $params -name CacheSizeInMB -failifempty $True -resultobj $result


#ATTRIBUTE:CreateFirewallRules,MANDATORY:True,DEFAULTVALUE:,DESCRIPTION:
...
$DscResourceName = "MSFT_xSPDistributedCacheService"
