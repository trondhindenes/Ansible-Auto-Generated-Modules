...
#ATTRIBUTE:GroupCategory;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$GroupCategory = Get-Attr -obj $params -name GroupCategory -failifempty $True -resultobj $result
...
#ATTRIBUTE:GroupScope;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$GroupScope = Get-Attr -obj $params -name GroupScope -failifempty $True -resultobj $result
...
$DscResourceName = "cADGroup"

$DscModuleName = "cactivedirectory"
