...
#ATTRIBUTE:AccountstoPass;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AccountstoPass = Get-Attr -obj $params -name AccountstoPass -failifempty $True -resultobj $result
#ATTRIBUTE:IncludeDisabled;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IncludeDisabled = Get-Attr -obj $params -name IncludeDisabled -failifempty $True -resultobj $result
...
$DscResourceName = "cSQLCheckSA"

$DscModuleName = "csqlconfig"
