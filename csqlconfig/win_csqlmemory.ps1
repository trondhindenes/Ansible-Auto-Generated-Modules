...
$MaxMemory = Get-Attr -obj $params -name MaxMemory -failifempty $False -resultobj $result
#ATTRIBUTE:MinMemory;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MinMemory = Get-Attr -obj $params -name MinMemory -failifempty $False -resultobj $result
