...
#ATTRIBUTE:DataDir;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DataDir = Get-Attr -obj $params -name DataDir -failifempty $True -resultobj $result
#ATTRIBUTE:InstallPath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$InstallPath = Get-Attr -obj $params -name InstallPath -failifempty $True -resultobj $result
...
#ATTRIBUTE:DeleteFilesAndData;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DeleteFilesAndData = Get-Attr -obj $params -name DeleteFilesAndData -failifempty $False -resultobj $result
#ATTRIBUTE:Ensure;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Absent,Present
$Ensure = Get-Attr -obj $params -name Ensure -failifempty $False -resultobj $result
#ATTRIBUTE:PackagePath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PackagePath = Get-Attr -obj $params -name PackagePath -failifempty $False -resultobj $result
...
$DscResourceName = "cRavenDB"

$DscModuleName = "cravendb"
