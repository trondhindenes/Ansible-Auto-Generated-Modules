...
#ATTRIBUTE:State;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Running,Stopped
...
If ($State)
{
    If (('Running','Stopped') -contains $State ) {
    }
    Else
    {
...
$DscResourceName = "nService"

$DscModuleName = "npsdesiredstateconfiguration"
