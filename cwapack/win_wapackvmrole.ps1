...
#ATTRIBUTE:NetworkReference;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$NetworkReference = Get-Attr -obj $params -name NetworkReference -failifempty $True -resultobj $result
...
#ATTRIBUTE:TokenSource;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:ADFS,ASPNET
$TokenSource = Get-Attr -obj $params -name TokenSource -failifempty $True -resultobj $result
#ATTRIBUTE:TokenUrl;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TokenUrl = Get-Attr -obj $params -name TokenUrl -failifempty $True -resultobj $result
...
#ATTRIBUTE:VMRoleGIName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$VMRoleGIName = Get-Attr -obj $params -name VMRoleGIName -failifempty $True -resultobj $result
#ATTRIBUTE:Ensure;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Absent,Present
$Ensure = Get-Attr -obj $params -name Ensure -failifempty $False -resultobj $result
#ATTRIBUTE:OSDiskFamilyName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$OSDiskFamilyName = Get-Attr -obj $params -name OSDiskFamilyName -failifempty $False -resultobj $result
#ATTRIBUTE:OSDiskRelease;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$OSDiskRelease = Get-Attr -obj $params -name OSDiskRelease -failifempty $False -resultobj $result
#ATTRIBUTE:OSDiskSearch;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:LatestApplicable,LatestApplicableWithFamilyName,Specified
$OSDiskSearch = Get-Attr -obj $params -name OSDiskSearch -failifempty $False -resultobj $result
...
#ATTRIBUTE:TokenPort;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TokenPort = Get-Attr -obj $params -name TokenPort -failifempty $False -resultobj $result
#ATTRIBUTE:VMRoleGIPublisher;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$VMRoleGIPublisher = Get-Attr -obj $params -name VMRoleGIPublisher -failifempty $False -resultobj $result
#ATTRIBUTE:VMRoleGIVersion;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$VMRoleGIVersion = Get-Attr -obj $params -name VMRoleGIVersion -failifempty $False -resultobj $result
#ATTRIBUTE:VMRoleParameters;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$VMRoleParameters = Get-Attr -obj $params -name VMRoleParameters -failifempty $False -resultobj $result
#ATTRIBUTE:VMSize;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:A6,A7,ExtraLarge,ExtraSmall,Large,Medium,Small
$VMSize = Get-Attr -obj $params -name VMSize -failifempty $False -resultobj $result
...
If ($TokenSource)
{
    If (('ADFS','ASPNET') -contains $TokenSource ) {
    }
    Else
    {
        Fail-Json $result "Option TokenSource has invalid value $TokenSource. Valid values are 'ADFS','ASPNET'"
    }
}
...
If ($OSDiskSearch)
{
    If (('LatestApplicable','LatestApplicableWithFamilyName','Specified') -contains $OSDiskSearch ) {
    }
    Else
    {
        Fail-Json $result "Option OSDiskSearch has invalid value $OSDiskSearch. Valid values are 'LatestApplicable','LatestApplicableWithFamilyName','Specified'"
    }
}
...
If ($VMSize)
{
    If (('A6','A7','ExtraLarge','ExtraSmall','Large','Medium','Small') -contains $VMSize ) {
    }
    Else
    {
        Fail-Json $result "Option VMSize has invalid value $VMSize. Valid values are 'A6','A7','ExtraLarge','ExtraSmall','Large','Medium','Small'"
    }
}
...
$DscResourceName = "WAPackVMRole"

$DscModuleName = "cwapack"
