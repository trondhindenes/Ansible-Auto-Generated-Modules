...
#ATTRIBUTE:ServiceCredential_username;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:
$ServiceCredential_username = Get-Attr -obj $params -name ServiceCredential_username -failifempty $True -resultobj $result
#ATTRIBUTE:ServiceCredential_password;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:
