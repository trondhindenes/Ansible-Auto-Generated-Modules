...
#ATTRIBUTE:DnsServer;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DnsServer = Get-Attr -obj $params -name DnsServer -failifempty $True -resultobj $result
...
#ATTRIBUTE:ZoneName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ZoneName = Get-Attr -obj $params -name ZoneName -failifempty $True -resultobj $result
#ATTRIBUTE:AgeRecord;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AgeRecord = Get-Attr -obj $params -name AgeRecord -failifempty $False -resultobj $result
#ATTRIBUTE:AllowUpdateAny;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AllowUpdateAny = Get-Attr -obj $params -name AllowUpdateAny -failifempty $False -resultobj $result
#ATTRIBUTE:CreatePtr;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CreatePtr = Get-Attr -obj $params -name CreatePtr -failifempty $False -resultobj $result
...
#ATTRIBUTE:TTL;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TTL = Get-Attr -obj $params -name TTL -failifempty $False -resultobj $result
...
$DscResourceName = "ARecord"

$DscModuleName = "poshorigin_activedirectorydns"
