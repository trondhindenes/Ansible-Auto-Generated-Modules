...
$NodeName = Get-Attr -obj $params -name NodeName -failifempty $True -resultobj $result
#ATTRIBUTE:ProfileName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ProfileName = Get-Attr -obj $params -name ProfileName -failifempty $True -resultobj $result
#ATTRIBUTE:AdminCredential_username;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AdminCredential_username = Get-Attr -obj $params -name AdminCredential_username -failifempty $False -resultobj $result
#ATTRIBUTE:AdminCredential_password;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AdminCredential_password = Get-Attr -obj $params -name AdminCredential_password -failifempty $False -resultobj $result
...
#ATTRIBUTE:DmgrHost;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DmgrHost = Get-Attr -obj $params -name DmgrHost -failifempty $False -resultobj $result
#ATTRIBUTE:DmgrPort;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DmgrPort = Get-Attr -obj $params -name DmgrPort -failifempty $False -resultobj $result
...
#ATTRIBUTE:IsDmgr;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IsDmgr = Get-Attr -obj $params -name IsDmgr -failifempty $False -resultobj $result
...
#ATTRIBUTE:TemplatePath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TemplatePath = Get-Attr -obj $params -name TemplatePath -failifempty $False -resultobj $result
...
if ($AdminCredential_username)
{
$AdminCredential_securepassword = $AdminCredential_password | ConvertTo-SecureString -asPlainText -Force
$AdminCredential = New-Object System.Management.Automation.PSCredential($AdminCredential_username,$AdminCredential_securepassword)
}
...
$DscResourceName = "cIBMWebSphereAppServerProfile"
