...
#ATTRIBUTE:WASEdition;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Base,Developer,Express,Liberty,ND
$WASEdition = Get-Attr -obj $params -name WASEdition -failifempty $True -resultobj $result
...
#ATTRIBUTE:PlusJava7;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PlusJava7 = Get-Attr -obj $params -name PlusJava7 -failifempty $False -resultobj $result
...
If ($WASEdition)
{
    If (('Base','Developer','Express','Liberty','ND') -contains $WASEdition ) {
    }
    Else
    {
        Fail-Json $result "Option WASEdition has invalid value $WASEdition. Valid values are 'Base','Developer','Express','Liberty','ND'"
    }
}
...
$DscResourceName = "cIBMWebSphereAppServer"
