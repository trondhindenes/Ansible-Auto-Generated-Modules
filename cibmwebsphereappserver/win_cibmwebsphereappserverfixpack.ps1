...
#ATTRIBUTE:WebSphereInstallationDirectory;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WebSphereInstallationDirectory = Get-Attr -obj $params -name WebSphereInstallationDirectory -failifempty $False -resultobj $result
...
$DscResourceName = "cIBMWebSphereAppServerFixpack"
