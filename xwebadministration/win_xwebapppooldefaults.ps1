...
#ATTRIBUTE:IdentityType;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:ApplicationPoolIdentity,LocalService,LocalSystem,NetworkService
...
If ($IdentityType)
{
    If (('ApplicationPoolIdentity','LocalService','LocalSystem','NetworkService') -contains $IdentityType ) {
    }
    Else
    {
        Fail-Json $result "Option IdentityType has invalid value $IdentityType. Valid values are 'ApplicationPoolIdentity','LocalService','LocalSystem','NetworkService'"
    }
}
...
$DscResourceName = "xWebAppPoolDefaults"
