...
#ATTRIBUTE:Action;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Allow,Block
...
If ($Action)
{
    ...
    Else
    {
        Fail-Json $result "Option Action has invalid value $Action. Valid values are 'Allow','Block'"
    }
}
...
$DscResourceName = "cFirewallRule"

$DscModuleName = "cfirewall"
