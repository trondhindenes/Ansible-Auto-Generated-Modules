...
#ATTRIBUTE:LSA_SecurityOptions;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LSA_SecurityOptions = Get-Attr -obj $params -name LSA_SecurityOptions -failifempty $False -resultobj $result
...
$DscResourceName = "LSA_SecurityOptions"
