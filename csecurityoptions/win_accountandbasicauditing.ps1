...
#ATTRIBUTE:Enable;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Enable = Get-Attr -obj $params -name Enable -failifempty $True -resultobj $result
#ATTRIBUTE:AccountAndBasicAuditing;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AccountAndBasicAuditing = Get-Attr -obj $params -name AccountAndBasicAuditing -failifempty $False -resultobj $result
...
$DscResourceName = "AccountAndBasicAuditing"
