...
#ATTRIBUTE:AdvancedAuditOption;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:AuditBaseDirectories,AuditBaseObjects,CrashOnAuditFail,FullPrivilegeAuditing
$AdvancedAuditOption = Get-Attr -obj $params -name AdvancedAuditOption -failifempty $True -resultobj $result
#ATTRIBUTE:Ensure;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Disabled,Enabled
...
If ($AdvancedAuditOption)
{
    If (('AuditBaseDirectories','AuditBaseObjects','CrashOnAuditFail','FullPrivilegeAuditing') -contains $AdvancedAuditOption ) {
    }
    Else
    {
        Fail-Json $result "Option AdvancedAuditOption has invalid value $AdvancedAuditOption. Valid values are 'AuditBaseDirectories','AuditBaseObjects','CrashOnAuditFail','FullPrivilegeAuditing'"
    }
}
...
If ($Ensure)
{
    If (('Disabled','Enabled') -contains $Ensure ) {
    }
    Else
    {
        Fail-Json $result "Option Ensure has invalid value $Ensure. Valid values are 'Disabled','Enabled'"
    }
}
...
$DscResourceName = "AdvancedAuditOptions"
