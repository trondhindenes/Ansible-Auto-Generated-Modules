...
#ATTRIBUTE:DnsName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DnsName = Get-Attr -obj $params -name DnsName -failifempty $False -resultobj $result
...
$DscResourceName = "xDhcpServerAuthorization"
