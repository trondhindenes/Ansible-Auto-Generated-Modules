...
#ATTRIBUTE:Alias;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Alias = Get-Attr -obj $params -name Alias -failifempty $True -resultobj $result
...
#ATTRIBUTE:DisplayName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DisplayName = Get-Attr -obj $params -name DisplayName -failifempty $True -resultobj $result
#ATTRIBUTE:FilePath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FilePath = Get-Attr -obj $params -name FilePath -failifempty $True -resultobj $result
#ATTRIBUTE:CommandLineSetting;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CommandLineSetting = Get-Attr -obj $params -name CommandLineSetting -failifempty $False -resultobj $result
#ATTRIBUTE:FileVirtualPath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FileVirtualPath = Get-Attr -obj $params -name FileVirtualPath -failifempty $False -resultobj $result
#ATTRIBUTE:FolderName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FolderName = Get-Attr -obj $params -name FolderName -failifempty $False -resultobj $result
#ATTRIBUTE:IconIndex;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IconIndex = Get-Attr -obj $params -name IconIndex -failifempty $False -resultobj $result
#ATTRIBUTE:IconPath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IconPath = Get-Attr -obj $params -name IconPath -failifempty $False -resultobj $result
...
#ATTRIBUTE:RequiredCommandLine;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RequiredCommandLine = Get-Attr -obj $params -name RequiredCommandLine -failifempty $False -resultobj $result
#ATTRIBUTE:ShowInWebAccess;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ShowInWebAccess = Get-Attr -obj $params -name ShowInWebAccess -failifempty $False -resultobj $result
#ATTRIBUTE:UserGroups;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UserGroups = Get-Attr -obj $params -name UserGroups -failifempty $False -resultobj $result
