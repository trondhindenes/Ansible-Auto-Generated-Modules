...
#ATTRIBUTE:ConnectionBroker;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ConnectionBroker = Get-Attr -obj $params -name ConnectionBroker -failifempty $True -resultobj $result
...
#ATTRIBUTE:WebAccessServer;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WebAccessServer = Get-Attr -obj $params -name WebAccessServer -failifempty $True -resultobj $result
...
$DscResourceName = "xRDSessionDeployment"
