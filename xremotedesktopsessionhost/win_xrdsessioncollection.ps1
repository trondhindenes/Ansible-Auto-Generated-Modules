...
#ATTRIBUTE:SessionHost;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SessionHost = Get-Attr -obj $params -name SessionHost -failifempty $True -resultobj $result
...
$DscResourceName = "xRDSessionCollection"
