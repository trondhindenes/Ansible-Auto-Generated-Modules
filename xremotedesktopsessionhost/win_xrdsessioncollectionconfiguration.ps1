...
#ATTRIBUTE:CollectionName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CollectionName = Get-Attr -obj $params -name CollectionName -failifempty $True -resultobj $result
#ATTRIBUTE:ActiveSessionLimitMin;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ActiveSessionLimitMin = Get-Attr -obj $params -name ActiveSessionLimitMin -failifempty $False -resultobj $result
#ATTRIBUTE:AuthenticateUsingNLA;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AuthenticateUsingNLA = Get-Attr -obj $params -name AuthenticateUsingNLA -failifempty $False -resultobj $result
#ATTRIBUTE:AutomaticReconnectionEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AutomaticReconnectionEnabled = Get-Attr -obj $params -name AutomaticReconnectionEnabled -failifempty $False -resultobj $result
#ATTRIBUTE:BrokenConnectionAction;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$BrokenConnectionAction = Get-Attr -obj $params -name BrokenConnectionAction -failifempty $False -resultobj $result
#ATTRIBUTE:ClientDeviceRedirectionOptions;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ClientDeviceRedirectionOptions = Get-Attr -obj $params -name ClientDeviceRedirectionOptions -failifempty $False -resultobj $result
#ATTRIBUTE:ClientPrinterAsDefault;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ClientPrinterAsDefault = Get-Attr -obj $params -name ClientPrinterAsDefault -failifempty $False -resultobj $result
#ATTRIBUTE:ClientPrinterRedirected;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ClientPrinterRedirected = Get-Attr -obj $params -name ClientPrinterRedirected -failifempty $False -resultobj $result
#ATTRIBUTE:CollectionDescription;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CollectionDescription = Get-Attr -obj $params -name CollectionDescription -failifempty $False -resultobj $result
#ATTRIBUTE:ConnectionBroker;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ConnectionBroker = Get-Attr -obj $params -name ConnectionBroker -failifempty $False -resultobj $result
#ATTRIBUTE:CustomRdpProperty;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CustomRdpProperty = Get-Attr -obj $params -name CustomRdpProperty -failifempty $False -resultobj $result
#ATTRIBUTE:DisconnectedSessionLimitMin;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DisconnectedSessionLimitMin = Get-Attr -obj $params -name DisconnectedSessionLimitMin -failifempty $False -resultobj $result
#ATTRIBUTE:EncryptionLevel;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EncryptionLevel = Get-Attr -obj $params -name EncryptionLevel -failifempty $False -resultobj $result
#ATTRIBUTE:IdleSessionLimitMin;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IdleSessionLimitMin = Get-Attr -obj $params -name IdleSessionLimitMin -failifempty $False -resultobj $result
#ATTRIBUTE:MaxRedirectedMonitors;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MaxRedirectedMonitors = Get-Attr -obj $params -name MaxRedirectedMonitors -failifempty $False -resultobj $result
...
#ATTRIBUTE:RDEasyPrintDriverEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RDEasyPrintDriverEnabled = Get-Attr -obj $params -name RDEasyPrintDriverEnabled -failifempty $False -resultobj $result
#ATTRIBUTE:SecurityLayer;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SecurityLayer = Get-Attr -obj $params -name SecurityLayer -failifempty $False -resultobj $result
#ATTRIBUTE:TemporaryFoldersDeletedOnExit;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TemporaryFoldersDeletedOnExit = Get-Attr -obj $params -name TemporaryFoldersDeletedOnExit -failifempty $False -resultobj $result
#ATTRIBUTE:UserGroup;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UserGroup = Get-Attr -obj $params -name UserGroup -failifempty $False -resultobj $result
...
$DscResourceName = "xRDSessionCollectionConfiguration"

$DscModuleName = "xremotedesktopsessionhost"
