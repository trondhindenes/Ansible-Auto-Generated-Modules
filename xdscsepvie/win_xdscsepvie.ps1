...
#ATTRIBUTE:VIELocation;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$VIELocation = Get-Attr -obj $params -name VIELocation -failifempty $True -resultobj $result
...
$DscResourceName = "xDSCSEPVIE"

$DscModuleName = "xdscsepvie"
