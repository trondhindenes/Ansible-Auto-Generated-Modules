...
#ATTRIBUTE:Location;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
...
#ATTRIBUTE:SBNameSpace;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SBNameSpace = Get-Attr -obj $params -name SBNameSpace -failifempty $True -resultobj $result
#ATTRIBUTE:StorageAccount;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$StorageAccount = Get-Attr -obj $params -name StorageAccount -failifempty $True -resultobj $result
...
$DscResourceName = "AzureServiceBusCreation"

$DscModuleName = "azureservicebuscreation"
