...
#ATTRIBUTE:StorageAccountContainer;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$StorageAccountContainer = Get-Attr -obj $params -name StorageAccountContainer -failifempty $True -resultobj $result
#ATTRIBUTE:StorageAccountKey;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$StorageAccountKey = Get-Attr -obj $params -name StorageAccountKey -failifempty $True -resultobj $result
...
#ATTRIBUTE:Blob;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Blob = Get-Attr -obj $params -name Blob -failifempty $False -resultobj $result
...
$DscResourceName = "cAzureStorage"

$DscModuleName = "cazurestorage"
