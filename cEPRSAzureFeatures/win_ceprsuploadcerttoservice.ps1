...
#ATTRIBUTE:CertPassword;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CertPassword = Get-Attr -obj $params -name CertPassword -failifempty $False -resultobj $result
...
$DscResourceName = "cEprsUploadCertToService"
