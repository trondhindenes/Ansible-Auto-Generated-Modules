...
#ATTRIBUTE:AdministratorLogin;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AdministratorLogin = Get-Attr -obj $params -name AdministratorLogin -failifempty $True -resultobj $result
#ATTRIBUTE:AdministratorPassword;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AdministratorPassword = Get-Attr -obj $params -name AdministratorPassword -failifempty $True -resultobj $result
...
#ATTRIBUTE:DatabaseEdition;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DatabaseEdition = Get-Attr -obj $params -name DatabaseEdition -failifempty $False -resultobj $result
...
$DscResourceName = "cEPRSCreateAzureDatabase"
