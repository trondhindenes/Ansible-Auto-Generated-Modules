...
#ATTRIBUTE:AdministratorLogin;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AdministratorLogin = Get-Attr -obj $params -name AdministratorLogin -failifempty $False -resultobj $result
#ATTRIBUTE:AdministratorPassword;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AdministratorPassword = Get-Attr -obj $params -name AdministratorPassword -failifempty $False -resultobj $result
...
#ATTRIBUTE:ServerLocation;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ServerLocation = Get-Attr -obj $params -name ServerLocation -failifempty $False -resultobj $result
...
$DscResourceName = "cEPRSCreateAzureDBServer"
