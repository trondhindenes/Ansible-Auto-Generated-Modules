...
#ATTRIBUTE:CreateACSNamespace;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CreateACSNamespace = Get-Attr -obj $params -name CreateACSNamespace -failifempty $True -resultobj $result
...
#ATTRIBUTE:NamespaceType;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$NamespaceType = Get-Attr -obj $params -name NamespaceType -failifempty $True -resultobj $result
#ATTRIBUTE:PublishSettingsFilePath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PublishSettingsFilePath = Get-Attr -obj $params -name PublishSettingsFilePath -failifempty $True -resultobj $result
...
#ATTRIBUTE:ServiceBusName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ServiceBusName = Get-Attr -obj $params -name ServiceBusName -failifempty $False -resultobj $result
...
$DscResourceName = "cEprsCreateAzureServiceBus"
