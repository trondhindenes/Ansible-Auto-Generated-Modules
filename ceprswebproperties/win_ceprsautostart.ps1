...
#ATTRIBUTE:AutoStartEnabled;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AutoStartEnabled = Get-Attr -obj $params -name AutoStartEnabled -failifempty $True -resultobj $result
...
$DscResourceName = "cEPRSAutoStart"
