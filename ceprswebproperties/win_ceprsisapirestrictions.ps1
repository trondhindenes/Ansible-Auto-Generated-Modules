...
#ATTRIBUTE:ISAPIPath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ISAPIPath = Get-Attr -obj $params -name ISAPIPath -failifempty $True -resultobj $result
...
$DscResourceName = "cEPRSISAPIRestrictions"

$DscModuleName = "ceprswebproperties"
