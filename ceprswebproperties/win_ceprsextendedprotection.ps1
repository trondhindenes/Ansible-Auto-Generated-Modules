...
#ATTRIBUTE:Vdir;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Vdir = Get-Attr -obj $params -name Vdir -failifempty $True -resultobj $result
...
$DscResourceName = "cEPRSExtendedProtection"
