...
#ATTRIBUTE:OctopusAPIKey;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$OctopusAPIKey = Get-Attr -obj $params -name OctopusAPIKey -failifempty $True -resultobj $result
#ATTRIBUTE:OctopusURL;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$OctopusURL = Get-Attr -obj $params -name OctopusURL -failifempty $True -resultobj $result
#ATTRIBUTE:ProjectEnv;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ProjectEnv = Get-Attr -obj $params -name ProjectEnv -failifempty $True -resultobj $result
#ATTRIBUTE:ProjectTR;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ProjectTR = Get-Attr -obj $params -name ProjectTR -failifempty $True -resultobj $result
...
$DscResourceName = "OctopusProjects"

$DscModuleName = "octopusprojectsdsc"
