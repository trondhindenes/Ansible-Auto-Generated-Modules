...
#ATTRIBUTE:OutPath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$OutPath = Get-Attr -obj $params -name OutPath -failifempty $True -resultobj $result
#ATTRIBUTE:CertName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CertName = Get-Attr -obj $params -name CertName -failifempty $False -resultobj $result
#ATTRIBUTE:ExpireAfter;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ExpireAfter = Get-Attr -obj $params -name ExpireAfter -failifempty $False -resultobj $result
#ATTRIBUTE:OutPathCredential_username;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$OutPathCredential_username = Get-Attr -obj $params -name OutPathCredential_username -failifempty $False -resultobj $result
#ATTRIBUTE:OutPathCredential_password;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$OutPathCredential_password = Get-Attr -obj $params -name OutPathCredential_password -failifempty $False -resultobj $result
#ATTRIBUTE:OutputName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Computer,FQDN,GUID
$OutputName = Get-Attr -obj $params -name OutputName -failifempty $False -resultobj $result
...
#ATTRIBUTE:SubjectAlternativeName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SubjectAlternativeName = Get-Attr -obj $params -name SubjectAlternativeName -failifempty $False -resultobj $result
#ATTRIBUTE:TemplateName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TemplateName = Get-Attr -obj $params -name TemplateName -failifempty $False -resultobj $result
...
If ($OutputName)
{
    If (('Computer','FQDN','GUID') -contains $OutputName ) {
    }
    Else
    {
        Fail-Json $result "Option OutputName has invalid value $OutputName. Valid values are 'Computer','FQDN','GUID'"
    }
}
...
if ($OutPathCredential_username)
{
$OutPathCredential_securepassword = $OutPathCredential_password | ConvertTo-SecureString -asPlainText -Force
$OutPathCredential = New-Object System.Management.Automation.PSCredential($OutPathCredential_username,$OutPathCredential_securepassword)
}
...
$DscResourceName = "cLCMCertUpdate"

$DscModuleName = "clcmcertmanager"
