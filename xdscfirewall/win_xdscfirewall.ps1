...
#ATTRIBUTE:Zone;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Zone = Get-Attr -obj $params -name Zone -failifempty $True -resultobj $result
#ATTRIBUTE:DefaultInboundAction;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DefaultInboundAction = Get-Attr -obj $params -name DefaultInboundAction -failifempty $False -resultobj $result
#ATTRIBUTE:DefaultOutboundAction;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DefaultOutboundAction = Get-Attr -obj $params -name DefaultOutboundAction -failifempty $False -resultobj $result
#ATTRIBUTE:Ensure;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Absent,Present
$Ensure = Get-Attr -obj $params -name Ensure -failifempty $False -resultobj $result
#ATTRIBUTE:LogAllowed;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LogAllowed = Get-Attr -obj $params -name LogAllowed -failifempty $False -resultobj $result
#ATTRIBUTE:LogBlocked;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LogBlocked = Get-Attr -obj $params -name LogBlocked -failifempty $False -resultobj $result
#ATTRIBUTE:LogIgnored;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LogIgnored = Get-Attr -obj $params -name LogIgnored -failifempty $False -resultobj $result
#ATTRIBUTE:LogMaxSizeKilobytes;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LogMaxSizeKilobytes = Get-Attr -obj $params -name LogMaxSizeKilobytes -failifempty $False -resultobj $result
...
$DscResourceName = "xDSCFirewall"

$DscModuleName = "xdscfirewall"
