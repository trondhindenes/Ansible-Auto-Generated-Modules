...
#ATTRIBUTE:webConfigProp,MANDATORY:False,DEFAULTVALUE:,DESCRIPTION:
$webConfigProp = Get-Attr -obj $params -name webConfigProp -failifempty $False -resultobj $result
