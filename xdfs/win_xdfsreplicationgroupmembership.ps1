...
#ATTRIBUTE:ComputerName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ComputerName = Get-Attr -obj $params -name ComputerName -failifempty $True -resultobj $result
...
#ATTRIBUTE:ContentPath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ContentPath = Get-Attr -obj $params -name ContentPath -failifempty $False -resultobj $result
...
#ATTRIBUTE:PrimaryMember;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PrimaryMember = Get-Attr -obj $params -name PrimaryMember -failifempty $False -resultobj $result
...
#ATTRIBUTE:ReadOnly;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ReadOnly = Get-Attr -obj $params -name ReadOnly -failifempty $False -resultobj $result
#ATTRIBUTE:StagingPath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$StagingPath = Get-Attr -obj $params -name StagingPath -failifempty $False -resultobj $result
...
$DscResourceName = "xDFSReplicationGroupMembership"
