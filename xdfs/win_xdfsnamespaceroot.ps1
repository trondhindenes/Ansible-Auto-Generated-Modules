...
#ATTRIBUTE:TargetPath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TargetPath = Get-Attr -obj $params -name TargetPath -failifempty $True -resultobj $result
#ATTRIBUTE:Type;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:DomainV1,DomainV2,Standalone
...
#ATTRIBUTE:EnableAccessBasedEnumeration;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EnableAccessBasedEnumeration = Get-Attr -obj $params -name EnableAccessBasedEnumeration -failifempty $False -resultobj $result
#ATTRIBUTE:EnableInsiteReferrals;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EnableInsiteReferrals = Get-Attr -obj $params -name EnableInsiteReferrals -failifempty $False -resultobj $result
#ATTRIBUTE:EnableRootScalability;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EnableRootScalability = Get-Attr -obj $params -name EnableRootScalability -failifempty $False -resultobj $result
#ATTRIBUTE:EnableSiteCosting;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EnableSiteCosting = Get-Attr -obj $params -name EnableSiteCosting -failifempty $False -resultobj $result
#ATTRIBUTE:EnableTargetFailback;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EnableTargetFailback = Get-Attr -obj $params -name EnableTargetFailback -failifempty $False -resultobj $result
...
#ATTRIBUTE:ReferralPriorityClass;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Global-High,Global-Low,SiteCost-High,SiteCost-Low,SiteCost-Normal
$ReferralPriorityClass = Get-Attr -obj $params -name ReferralPriorityClass -failifempty $False -resultobj $result
#ATTRIBUTE:ReferralPriorityRank;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ReferralPriorityRank = Get-Attr -obj $params -name ReferralPriorityRank -failifempty $False -resultobj $result
#ATTRIBUTE:TimeToLiveSec;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TimeToLiveSec = Get-Attr -obj $params -name TimeToLiveSec -failifempty $False -resultobj $result
...
If ($Type)
{
    If (('DomainV1','DomainV2','Standalone') -contains $Type ) {
    }
    Else
    {
        Fail-Json $result "Option Type has invalid value $Type. Valid values are 'DomainV1','DomainV2','Standalone'"
    }
}
...
{
    If (('Global-High','Global-Low','SiteCost-High','SiteCost-Low','SiteCost-Normal') -contains $ReferralPriorityClass ) {
    }
    Else
    {
        Fail-Json $result "Option ReferralPriorityClass has invalid value $ReferralPriorityClass. Valid values are 'Global-High','Global-Low','SiteCost-High','SiteCost-Low','SiteCost-Normal'"
    }
}
...
$DscResourceName = "xDFSNamespaceRoot"
