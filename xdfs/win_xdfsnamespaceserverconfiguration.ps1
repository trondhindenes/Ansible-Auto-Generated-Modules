...
#ATTRIBUTE:LdapTimeoutSec;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LdapTimeoutSec = Get-Attr -obj $params -name LdapTimeoutSec -failifempty $False -resultobj $result
...
#ATTRIBUTE:SyncIntervalSec;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SyncIntervalSec = Get-Attr -obj $params -name SyncIntervalSec -failifempty $False -resultobj $result
#ATTRIBUTE:UseFQDN;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UseFQDN = Get-Attr -obj $params -name UseFQDN -failifempty $False -resultobj $result
...
$DscResourceName = "xDFSNamespaceServerConfiguration"
