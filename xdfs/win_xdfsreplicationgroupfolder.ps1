...
#ATTRIBUTE:DfsnPath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DfsnPath = Get-Attr -obj $params -name DfsnPath -failifempty $False -resultobj $result
#ATTRIBUTE:DirectoryNameToExclude;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DirectoryNameToExclude = Get-Attr -obj $params -name DirectoryNameToExclude -failifempty $False -resultobj $result
...
#ATTRIBUTE:FilenameToExclude;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$FilenameToExclude = Get-Attr -obj $params -name FilenameToExclude -failifempty $False -resultobj $result
...
$DscResourceName = "xDFSReplicationGroupFolder"
