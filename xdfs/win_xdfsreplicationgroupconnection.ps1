...
#ATTRIBUTE:DestinationComputerName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DestinationComputerName = Get-Attr -obj $params -name DestinationComputerName -failifempty $True -resultobj $result
...
#ATTRIBUTE:SourceComputerName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SourceComputerName = Get-Attr -obj $params -name SourceComputerName -failifempty $True -resultobj $result
...
#ATTRIBUTE:EnsureEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Disabled,Enabled
$EnsureEnabled = Get-Attr -obj $params -name EnsureEnabled -failifempty $False -resultobj $result
#ATTRIBUTE:EnsureRDCEnabled;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Disabled,Enabled
$EnsureRDCEnabled = Get-Attr -obj $params -name EnsureRDCEnabled -failifempty $False -resultobj $result
...
If ($EnsureEnabled)
{
    If (('Disabled','Enabled') -contains $EnsureEnabled ) {
    }
    Else
    {
        Fail-Json $result "Option EnsureEnabled has invalid value $EnsureEnabled. Valid values are 'Disabled','Enabled'"
    }
}
...
If ($EnsureRDCEnabled)
{
    If (('Disabled','Enabled') -contains $EnsureRDCEnabled ) {
    }
    Else
    {
        Fail-Json $result "Option EnsureRDCEnabled has invalid value $EnsureRDCEnabled. Valid values are 'Disabled','Enabled'"
    }
}
...
$DscResourceName = "xDFSReplicationGroupConnection"
