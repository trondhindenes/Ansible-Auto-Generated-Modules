...
#ATTRIBUTE:ContentPaths;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ContentPaths = Get-Attr -obj $params -name ContentPaths -failifempty $False -resultobj $result
...
#ATTRIBUTE:Folders;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Folders = Get-Attr -obj $params -name Folders -failifempty $False -resultobj $result
...
#ATTRIBUTE:Topology;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Fullmesh,Manual
$Topology = Get-Attr -obj $params -name Topology -failifempty $False -resultobj $result
...
If ($Topology)
{
    If (('Fullmesh','Manual') -contains $Topology ) {
    }
    Else
    {
        Fail-Json $result "Option Topology has invalid value $Topology. Valid values are 'Fullmesh','Manual'"
    }
}
...
$DscResourceName = "xDFSReplicationGroup"
