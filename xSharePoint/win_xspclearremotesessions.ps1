...
#ATTRIBUTE:ClearRemoteSessions;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ClearRemoteSessions = Get-Attr -obj $params -name ClearRemoteSessions -failifempty $True -resultobj $result
...
$DscResourceName = "xSPClearRemoteSessions"
