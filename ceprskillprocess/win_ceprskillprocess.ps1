...
#ATTRIBUTE:ProcessName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ProcessName = Get-Attr -obj $params -name ProcessName -failifempty $True -resultobj $result
...
$DscResourceName = "cEPRSKillProcess"

$DscModuleName = "ceprskillprocess"
