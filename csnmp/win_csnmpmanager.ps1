...
#ATTRIBUTE:Manager;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Manager = Get-Attr -obj $params -name Manager -failifempty $True -resultobj $result
