...
#ATTRIBUTE:Community;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Community = Get-Attr -obj $params -name Community -failifempty $False -resultobj $result
...
$DscResourceName = "cSNMPTrapDestination"
