...
#ATTRIBUTE:EnableAuthenticationTraps;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EnableAuthenticationTraps = Get-Attr -obj $params -name EnableAuthenticationTraps -failifempty $True -resultobj $result
...
$DscResourceName = "cSNMPEnableAuthenticationTrap"
