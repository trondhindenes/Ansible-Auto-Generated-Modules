...
#ATTRIBUTE:IPAddresses;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IPAddresses = Get-Attr -obj $params -name IPAddresses -failifempty $False -resultobj $result
...
$DscResourceName = "xDnsServerForwarder"
