...
#ATTRIBUTE:Type;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:ARecord,CName
...
If ($Type)
{
    If (('ARecord','CName') -contains $Type ) {
    }
    Else
    {
        Fail-Json $result "Option Type has invalid value $Type. Valid values are 'ARecord','CName'"
    }
}
