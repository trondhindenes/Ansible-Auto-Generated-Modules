...
#ATTRIBUTE:AccessType;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
...
#ATTRIBUTE:AppliesTo;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Children,Self
$AppliesTo = Get-Attr -obj $params -name AppliesTo -failifempty $False -resultobj $result
#ATTRIBUTE:Ensure;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Absent,Present
$Ensure = Get-Attr -obj $params -name Ensure -failifempty $False -resultobj $result
#ATTRIBUTE:Permission;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Enable,FullWrite,MethodExecute,PartialWrite,ProviderWrite,Publish,ReadSecurity,RemoteAccess,Subscribe,WriteSecurity
...
If ($AppliesTo)
{
    If (('Children','Self') -contains $AppliesTo ) {
    }
    Else
    {
        Fail-Json $result "Option AppliesTo has invalid value $AppliesTo. Valid values are 'Children','Self'"
    }
}
...
If ($Permission)
{
    If (('Enable','FullWrite','MethodExecute','PartialWrite','ProviderWrite','Publish','ReadSecurity','RemoteAccess','Subscribe','WriteSecurity') -contains $Permission ) {
    }
    Else
    {
        Fail-Json $result "Option Permission has invalid value $Permission. Valid values are 'Enable','FullWrite','MethodExecute','PartialWrite','ProviderWrite','Publish','ReadSecurity','RemoteAccess','Subscribe','WriteSecurity'"
    }
}
...
$DscResourceName = "WMINamespaceSecurity"

$DscModuleName = "wminamespacesecurity"
