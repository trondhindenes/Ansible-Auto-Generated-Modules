...
#ATTRIBUTE:BandwidthReservationMode;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Absolute,Default,NA,None,Weight
...
{
    If (('Absolute','Default','NA','None','Weight') -contains $BandwidthReservationMode ) {
    }
    Else
    {
        Fail-Json $result "Option BandwidthReservationMode has invalid value $BandwidthReservationMode. Valid values are 'Absolute','Default','NA','None','Weight'"
    }
}
