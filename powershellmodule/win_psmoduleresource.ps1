...
#ATTRIBUTE:Module_Name;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Module_Name = Get-Attr -obj $params -name Module_Name -failifempty $True -resultobj $result
...
$DscResourceName = "PSModuleResource"

$DscModuleName = "powershellmodule"
