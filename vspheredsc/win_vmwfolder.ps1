...
#ATTRIBUTE:Type;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Blue,Yellow
$Type = Get-Attr -obj $params -name Type -failifempty $True -resultobj $result
#ATTRIBUTE:vCredential_username;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$vCredential_username = Get-Attr -obj $params -name vCredential_username -failifempty $True -resultobj $result
#ATTRIBUTE:vCredential_password;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$vCredential_password = Get-Attr -obj $params -name vCredential_password -failifempty $True -resultobj $result
#ATTRIBUTE:vServer;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$vServer = Get-Attr -obj $params -name vServer -failifempty $True -resultobj $result
...
#ATTRIBUTE:vSessionId;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$vSessionId = Get-Attr -obj $params -name vSessionId -failifempty $False -resultobj $result
...
If ($Type)
{
    If (('Blue','Yellow') -contains $Type ) {
    }
    Else
    {
        Fail-Json $result "Option Type has invalid value $Type. Valid values are 'Blue','Yellow'"
    }
}
...
if ($vCredential_username)
{
$vCredential_securepassword = $vCredential_password | ConvertTo-SecureString -asPlainText -Force
$vCredential = New-Object System.Management.Automation.PSCredential($vCredential_username,$vCredential_securepassword)
}
...
$DscResourceName = "VmwFolder"

$DscModuleName = "vspheredsc"
