...
#ATTRIBUTE:CatalogServicesCredential_username;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CatalogServicesCredential_username = Get-Attr -obj $params -name CatalogServicesCredential_username -failifempty $True -resultobj $result
#ATTRIBUTE:CatalogServicesCredential_password;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CatalogServicesCredential_password = Get-Attr -obj $params -name CatalogServicesCredential_password -failifempty $True -resultobj $result
...
#ATTRIBUTE:SQLCredential_username;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SQLCredential_username = Get-Attr -obj $params -name SQLCredential_username -failifempty $True -resultobj $result
#ATTRIBUTE:SQLCredential_password;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SQLCredential_password = Get-Attr -obj $params -name SQLCredential_password -failifempty $True -resultobj $result
...
#ATTRIBUTE:LicensePath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LicensePath = Get-Attr -obj $params -name LicensePath -failifempty $False -resultobj $result
...
if ($CatalogServicesCredential_username)
{
$CatalogServicesCredential_securepassword = $CatalogServicesCredential_password | ConvertTo-SecureString -asPlainText -Force
$CatalogServicesCredential = New-Object System.Management.Automation.PSCredential($CatalogServicesCredential_username,$CatalogServicesCredential_securepassword)
}
...
if ($SQLCredential_username)
{
$SQLCredential_securepassword = $SQLCredential_password | ConvertTo-SecureString -asPlainText -Force
$SQLCredential = New-Object System.Management.Automation.PSCredential($SQLCredential_username,$SQLCredential_securepassword)
}
...
$DscResourceName = "ROSSDatabase"

$DscModuleName = "resoneservicestore"
