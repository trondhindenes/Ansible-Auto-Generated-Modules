...
#ATTRIBUTE:EnableTransactions;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EnableTransactions = Get-Attr -obj $params -name EnableTransactions -failifempty $False -resultobj $result
#ATTRIBUTE:NoClobber;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$NoClobber = Get-Attr -obj $params -name NoClobber -failifempty $False -resultobj $result
...
#ATTRIBUTE:UseHttps;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UseHttps = Get-Attr -obj $params -name UseHttps -failifempty $False -resultobj $result
...
$DscResourceName = "ROSSBuildingBlock"
