...
#ATTRIBUTE:CatalogServicesHost;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CatalogServicesHost = Get-Attr -obj $params -name CatalogServicesHost -failifempty $True -resultobj $result
#ATTRIBUTE:DefaultDomain;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DefaultDomain = Get-Attr -obj $params -name DefaultDomain -failifempty $True -resultobj $result
#ATTRIBUTE:HostHeader;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$HostHeader = Get-Attr -obj $params -name HostHeader -failifempty $True -resultobj $result
