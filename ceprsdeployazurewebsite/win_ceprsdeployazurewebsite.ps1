...
#ATTRIBUTE:PackageFile;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PackageFile = Get-Attr -obj $params -name PackageFile -failifempty $False -resultobj $result
...
#ATTRIBUTE:Slot;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
...
$DscResourceName = "cEPRSDeployAzureWebsite"
