...
#ATTRIBUTE:SubscriptionName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SubscriptionName = Get-Attr -obj $params -name SubscriptionName -failifempty $True -resultobj $result
...
#ATTRIBUTE:Location;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Central US,East Asia,East US,East US 2,North Europe,South Central US,Southeast Asia,West Europe,West US
...
#ATTRIBUTE:PublishingUsername;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PublishingUsername = Get-Attr -obj $params -name PublishingUsername -failifempty $False -resultobj $result
#ATTRIBUTE:PublishSettingsFile;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PublishSettingsFile = Get-Attr -obj $params -name PublishSettingsFile -failifempty $False -resultobj $result
#ATTRIBUTE:Slot;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Production,Staging
$Slot = Get-Attr -obj $params -name Slot -failifempty $False -resultobj $result
#ATTRIBUTE:WebsiteName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WebsiteName = Get-Attr -obj $params -name WebsiteName -failifempty $False -resultobj $result
...
If ($Location)
{
    If (('Central US','East Asia','East US','East US 2','North Europe','South Central US','Southeast Asia','West Europe','West US') -contains $Location ) {
    }
    Else
    {
        Fail-Json $result "Option Location has invalid value $Location. Valid values are 'Central US','East Asia','East US','East US 2','North Europe','South Central US','Southeast Asia','West Europe','West US'"
    }
}
...
If ($Slot)
{
    If (('Production','Staging') -contains $Slot ) {
    }
    Else
    {
        Fail-Json $result "Option Slot has invalid value $Slot. Valid values are 'Production','Staging'"
    }
}
...
$DscResourceName = "cEPRSCreateAzureWebsite"

$DscModuleName = "ceprsdeployazurewebsite"
