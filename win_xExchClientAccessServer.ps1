...
#ATTRIBUTE:AutoDiscoverServiceInternalUri,MANDATORY:False,DEFAULTVALUE:,DESCRIPTION:
...
#ATTRIBUTE:AutoDiscoverSiteScope,MANDATORY:False,DEFAULTVALUE:,DESCRIPTION:
