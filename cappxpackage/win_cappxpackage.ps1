...
#ATTRIBUTE:InstallLocation;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$InstallLocation = Get-Attr -obj $params -name InstallLocation -failifempty $False -resultobj $result
...
$DscResourceName = "cAppxPackage"

$DscModuleName = "cappxpackage"
