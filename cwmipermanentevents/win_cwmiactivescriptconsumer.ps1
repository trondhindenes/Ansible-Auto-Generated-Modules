...
#ATTRIBUTE:MaximumQueueSize;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MaximumQueueSize = Get-Attr -obj $params -name MaximumQueueSize -failifempty $False -resultobj $result
...
#ATTRIBUTE:ScriptFileName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ScriptFileName = Get-Attr -obj $params -name ScriptFileName -failifempty $False -resultobj $result
#ATTRIBUTE:ScriptingEngine;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ScriptingEngine = Get-Attr -obj $params -name ScriptingEngine -failifempty $False -resultobj $result
#ATTRIBUTE:ScriptText;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ScriptText = Get-Attr -obj $params -name ScriptText -failifempty $False -resultobj $result
...
$DscResourceName = "cWMIActiveScriptConsumer"

$DscModuleName = "cwmipermanentevents"
