...
#ATTRIBUTE:CommandLineTemplate;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CommandLineTemplate = Get-Attr -obj $params -name CommandLineTemplate -failifempty $True -resultobj $result
...
#ATTRIBUTE:ExecutablePath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ExecutablePath = Get-Attr -obj $params -name ExecutablePath -failifempty $False -resultobj $result
...
$DscResourceName = "cWMICommandLineConsumer"
