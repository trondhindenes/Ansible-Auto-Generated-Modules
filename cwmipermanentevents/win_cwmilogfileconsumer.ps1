...
#ATTRIBUTE:Filename;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Filename = Get-Attr -obj $params -name Filename -failifempty $True -resultobj $result
#ATTRIBUTE:Name;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Name = Get-Attr -obj $params -name Name -failifempty $True -resultobj $result
#ATTRIBUTE:Text;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Text = Get-Attr -obj $params -name Text -failifempty $True -resultobj $result
#ATTRIBUTE:Ensure;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Absent,Present
$Ensure = Get-Attr -obj $params -name Ensure -failifempty $False -resultobj $result
#ATTRIBUTE:IsUnicode;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$IsUnicode = Get-Attr -obj $params -name IsUnicode -failifempty $False -resultobj $result
#ATTRIBUTE:MaximumFileSize;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$MaximumFileSize = Get-Attr -obj $params -name MaximumFileSize -failifempty $False -resultobj $result
...
$DscResourceName = "cWMILogFileConsumer"
