...
If ($ConsumerType)
{
    ...
    Else
    {
        Fail-Json $result "Option ConsumerType has invalid value $ConsumerType. Valid values are 'CommandLine','EventLog','LogFile','Script','SMTP'"
    }
}
...
$DscResourceName = "cWMIEventBinding"
