...
#ATTRIBUTE:RegFilePath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RegFilePath = Get-Attr -obj $params -name RegFilePath -failifempty $False -resultobj $result
...
$DscResourceName = "cRegFile"

$DscModuleName = "cregfile"
