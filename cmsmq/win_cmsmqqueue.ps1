...
#ATTRIBUTE:Authenticate;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Authenticate = Get-Attr -obj $params -name Authenticate -failifempty $False -resultobj $result
#ATTRIBUTE:Ensure;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Absent,Present
$Ensure = Get-Attr -obj $params -name Ensure -failifempty $False -resultobj $result
#ATTRIBUTE:Journaling;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Journaling = Get-Attr -obj $params -name Journaling -failifempty $False -resultobj $result
#ATTRIBUTE:JournalQuota;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$JournalQuota = Get-Attr -obj $params -name JournalQuota -failifempty $False -resultobj $result
#ATTRIBUTE:Label;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Label = Get-Attr -obj $params -name Label -failifempty $False -resultobj $result
#ATTRIBUTE:PrivacyLevel;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Body,None,Optional
$PrivacyLevel = Get-Attr -obj $params -name PrivacyLevel -failifempty $False -resultobj $result
...
#ATTRIBUTE:QueueQuota;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$QueueQuota = Get-Attr -obj $params -name QueueQuota -failifempty $False -resultobj $result
#ATTRIBUTE:Transactional;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Transactional = Get-Attr -obj $params -name Transactional -failifempty $False -resultobj $result
...
If ($PrivacyLevel)
{
    If (('Body','None','Optional') -contains $PrivacyLevel ) {
    }
    Else
    {
        Fail-Json $result "Option PrivacyLevel has invalid value $PrivacyLevel. Valid values are 'Body','None','Optional'"
    }
}
