...
#ATTRIBUTE:AccessRights;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AccessRights = Get-Attr -obj $params -name AccessRights -failifempty $False -resultobj $result
