...
#ATTRIBUTE:Content;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Content = Get-Attr -obj $params -name Content -failifempty $False -resultobj $result
...
$DscResourceName = "cMDTCustomSettingsIni"
