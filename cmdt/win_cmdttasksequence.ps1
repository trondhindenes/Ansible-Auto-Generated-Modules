...
#ATTRIBUTE:OperatingSystemPath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$OperatingSystemPath = Get-Attr -obj $params -name OperatingSystemPath -failifempty $False -resultobj $result
...
#ATTRIBUTE:WIMFileName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WIMFileName = Get-Attr -obj $params -name WIMFileName -failifempty $False -resultobj $result
...
$DscResourceName = "cMDTTaskSequence"
