...
#ATTRIBUTE:PSDriveName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PSDriveName = Get-Attr -obj $params -name PSDriveName -failifempty $False -resultobj $result
#ATTRIBUTE:PSDrivePath;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PSDrivePath = Get-Attr -obj $params -name PSDrivePath -failifempty $False -resultobj $result
