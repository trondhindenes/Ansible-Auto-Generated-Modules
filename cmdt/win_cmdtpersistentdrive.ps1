...
#ATTRIBUTE:NetworkPath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$NetworkPath = Get-Attr -obj $params -name NetworkPath -failifempty $True -resultobj $result
...
$DscResourceName = "cMDTPersistentDrive"
