...
#ATTRIBUTE:Comment;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Comment = Get-Attr -obj $params -name Comment -failifempty $True -resultobj $result
