...
#ATTRIBUTE:RemoteInstallPath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$RemoteInstallPath = Get-Attr -obj $params -name RemoteInstallPath -failifempty $True -resultobj $result
...
$DscResourceName = "cWDSConfiguration"
