...
#ATTRIBUTE:DownloadPath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DownloadPath = Get-Attr -obj $params -name DownloadPath -failifempty $True -resultobj $result
