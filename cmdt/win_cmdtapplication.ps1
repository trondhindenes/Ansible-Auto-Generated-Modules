...
#ATTRIBUTE:ApplicationSourcePath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ApplicationSourcePath = Get-Attr -obj $params -name ApplicationSourcePath -failifempty $True -resultobj $result
#ATTRIBUTE:CommandLine;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CommandLine = Get-Attr -obj $params -name CommandLine -failifempty $True -resultobj $result
#ATTRIBUTE:DestinationFolder;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DestinationFolder = Get-Attr -obj $params -name DestinationFolder -failifempty $True -resultobj $result
#ATTRIBUTE:Enabled;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Enabled = Get-Attr -obj $params -name Enabled -failifempty $True -resultobj $result
...
#ATTRIBUTE:Language;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Language = Get-Attr -obj $params -name Language -failifempty $True -resultobj $result
...
#ATTRIBUTE:PSDriveName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PSDriveName = Get-Attr -obj $params -name PSDriveName -failifempty $True -resultobj $result
#ATTRIBUTE:PSDrivePath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PSDrivePath = Get-Attr -obj $params -name PSDrivePath -failifempty $True -resultobj $result
#ATTRIBUTE:Publisher;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Publisher = Get-Attr -obj $params -name Publisher -failifempty $True -resultobj $result
#ATTRIBUTE:ShortName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ShortName = Get-Attr -obj $params -name ShortName -failifempty $True -resultobj $result
#ATTRIBUTE:TempLocation;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TempLocation = Get-Attr -obj $params -name TempLocation -failifempty $True -resultobj $result
...
$WorkingDirectory = Get-Attr -obj $params -name WorkingDirectory -failifempty $True -resultobj $result
...
$DscResourceName = "cMDTApplication"
