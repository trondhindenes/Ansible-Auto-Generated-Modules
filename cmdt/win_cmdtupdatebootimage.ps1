...
#ATTRIBUTE:Compress;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Compress = Get-Attr -obj $params -name Compress -failifempty $True -resultobj $result
#ATTRIBUTE:DeploymentSharePath;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DeploymentSharePath = Get-Attr -obj $params -name DeploymentSharePath -failifempty $True -resultobj $result
#ATTRIBUTE:Force;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Force = Get-Attr -obj $params -name Force -failifempty $True -resultobj $result
#ATTRIBUTE:PSDeploymentShare;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$PSDeploymentShare = Get-Attr -obj $params -name PSDeploymentShare -failifempty $True -resultobj $result
...
#ATTRIBUTE:BackgroundFile;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$BackgroundFile = Get-Attr -obj $params -name BackgroundFile -failifempty $False -resultobj $result
#ATTRIBUTE:ExtraDirectory;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ExtraDirectory = Get-Attr -obj $params -name ExtraDirectory -failifempty $False -resultobj $result
#ATTRIBUTE:LiteTouchWIMDescription;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$LiteTouchWIMDescription = Get-Attr -obj $params -name LiteTouchWIMDescription -failifempty $False -resultobj $result
...
$DscResourceName = "cMDTUpdateBootImage"
