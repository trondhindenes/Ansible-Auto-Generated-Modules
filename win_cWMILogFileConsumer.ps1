...
#ATTRIBUTE:Filename,MANDATORY:True,DEFAULTVALUE:,DESCRIPTION:
...
#ATTRIBUTE:Text,MANDATORY:True,DEFAULTVALUE:,DESCRIPTION:
...
#ATTRIBUTE:IsUnicode,MANDATORY:False,DEFAULTVALUE:,DESCRIPTION:
$IsUnicode = Get-Attr -obj $params -name IsUnicode -failifempty $False -resultobj $result


#ATTRIBUTE:MaximumFileSize,MANDATORY:False,DEFAULTVALUE:,DESCRIPTION:
