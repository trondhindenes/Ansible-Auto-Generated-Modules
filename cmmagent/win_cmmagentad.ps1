...
#ATTRIBUTE:EnableAD;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EnableAD = Get-Attr -obj $params -name EnableAD -failifempty $True -resultobj $result
