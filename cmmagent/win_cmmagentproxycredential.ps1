...
#ATTRIBUTE:ProxyUserName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ProxyUserName = Get-Attr -obj $params -name ProxyUserName -failifempty $True -resultobj $result
#ATTRIBUTE:ProxyUserPassword_username;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ProxyUserPassword_username = Get-Attr -obj $params -name ProxyUserPassword_username -failifempty $True -resultobj $result
#ATTRIBUTE:ProxyUserPassword_password;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ProxyUserPassword_password = Get-Attr -obj $params -name ProxyUserPassword_password -failifempty $True -resultobj $result
...
if ($ProxyUserPassword_username)
{
$ProxyUserPassword_securepassword = $ProxyUserPassword_password | ConvertTo-SecureString -asPlainText -Force
$ProxyUserPassword = New-Object System.Management.Automation.PSCredential($ProxyUserPassword_username,$ProxyUserPassword_securepassword)
}
...
$DscResourceName = "cMMAgentProxyCredential"
