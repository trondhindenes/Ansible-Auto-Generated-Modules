...
#ATTRIBUTE:WorkspaceID;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WorkspaceID = Get-Attr -obj $params -name WorkspaceID -failifempty $True -resultobj $result
#ATTRIBUTE:WorkspaceKey;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WorkspaceKey = Get-Attr -obj $params -name WorkspaceKey -failifempty $True -resultobj $result
...
$DscResourceName = "cMMAgentInstall"
