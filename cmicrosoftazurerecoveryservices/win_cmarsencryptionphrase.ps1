...
#ATTRIBUTE:EncryptionPassPhrase;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EncryptionPassPhrase = Get-Attr -obj $params -name EncryptionPassPhrase -failifempty $True -resultobj $result
...
$DscResourceName = "cMARSEncryptionPhrase"
