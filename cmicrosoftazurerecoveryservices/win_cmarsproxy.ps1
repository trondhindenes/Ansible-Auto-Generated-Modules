...
#ATTRIBUTE:ProxyServer;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
...
#ATTRIBUTE:ProxyPort;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
...
$DscModuleName = "cmicrosoftazurerecoveryservices"
