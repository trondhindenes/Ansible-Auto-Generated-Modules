...
#ATTRIBUTE:VaultCredential;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$VaultCredential = Get-Attr -obj $params -name VaultCredential -failifempty $True -resultobj $result
...
$DscResourceName = "cMARSRegistration"
