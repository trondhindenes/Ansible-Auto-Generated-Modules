...
#ATTRIBUTE:Domain;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Domain = Get-Attr -obj $params -name Domain -failifempty $True -resultobj $result
...
$DscResourceName = "xDSCDomainjoin"

$DscModuleName = "xdscdomainjoin"
