...
#ATTRIBUTE:BaseDirectory;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$BaseDirectory = Get-Attr -obj $params -name BaseDirectory -failifempty $True -resultobj $result
#ATTRIBUTE:Branch;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Branch = Get-Attr -obj $params -name Branch -failifempty $True -resultobj $result
...
$DscResourceName = "cGitRepositoryBranch"
