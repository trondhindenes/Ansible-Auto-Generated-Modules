...
#ATTRIBUTE:Resource;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Resource = Get-Attr -obj $params -name Resource -failifempty $False -resultobj $result
#ATTRIBUTE:Type;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:DiskOnly,NodeAndDiskMajority,NodeAndFileShareMajority,NodeMajority
...
If ($Type)
{
    If (('DiskOnly','NodeAndDiskMajority','NodeAndFileShareMajority','NodeMajority') -contains $Type ) {
    }
    Else
    {
        Fail-Json $result "Option Type has invalid value $Type. Valid values are 'DiskOnly','NodeAndDiskMajority','NodeAndFileShareMajority','NodeMajority'"
    }
}
...
$DscResourceName = "xClusterQuorum"

$DscModuleName = "xfailovercluster"
