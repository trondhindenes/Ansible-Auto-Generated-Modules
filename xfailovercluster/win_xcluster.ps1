...
#ATTRIBUTE:StaticIPAddress;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$StaticIPAddress = Get-Attr -obj $params -name StaticIPAddress -failifempty $True -resultobj $result
