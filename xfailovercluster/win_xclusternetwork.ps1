...
#ATTRIBUTE:AddressMask;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AddressMask = Get-Attr -obj $params -name AddressMask -failifempty $True -resultobj $result
#ATTRIBUTE:Metric;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Metric = Get-Attr -obj $params -name Metric -failifempty $False -resultobj $result
...
#ATTRIBUTE:Role;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:0,1,3
$Role = Get-Attr -obj $params -name Role -failifempty $False -resultobj $result
...
If ($Role)
{
    If (('0','1','3') -contains $Role ) {
    }
    Else
    {
        Fail-Json $result "Option Role has invalid value $Role. Valid values are '0','1','3'"
    }
}
...
$DscResourceName = "xClusterNetwork"
