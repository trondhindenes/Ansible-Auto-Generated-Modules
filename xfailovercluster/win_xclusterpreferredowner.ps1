...
#ATTRIBUTE:ClusterGroup;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ClusterGroup = Get-Attr -obj $params -name ClusterGroup -failifempty $True -resultobj $result
...
#ATTRIBUTE:Nodes;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Nodes = Get-Attr -obj $params -name Nodes -failifempty $True -resultobj $result
#ATTRIBUTE:ClusterResources;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ClusterResources = Get-Attr -obj $params -name ClusterResources -failifempty $False -resultobj $result
...
$DscResourceName = "xClusterPreferredOwner"
