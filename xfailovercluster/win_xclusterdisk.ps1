...
#ATTRIBUTE:Number;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Number = Get-Attr -obj $params -name Number -failifempty $True -resultobj $result
