...
#ATTRIBUTE:subnetName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$subnetName = Get-Attr -obj $params -name subnetName -failifempty $True -resultobj $result
