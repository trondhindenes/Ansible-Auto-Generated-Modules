...
#ATTRIBUTE:DCLocation;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DCLocation = Get-Attr -obj $params -name DCLocation -failifempty $True -resultobj $result
#ATTRIBUTE:DCName;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$DCName = Get-Attr -obj $params -name DCName -failifempty $True -resultobj $result
