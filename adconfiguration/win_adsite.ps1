...
#ATTRIBUTE:newSiteName;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$newSiteName = Get-Attr -obj $params -name newSiteName -failifempty $False -resultobj $result
...
#ATTRIBUTE:siteDescription;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$siteDescription = Get-Attr -obj $params -name siteDescription -failifempty $False -resultobj $result
...
$DscResourceName = "adsite"

$DscModuleName = "adconfiguration"
