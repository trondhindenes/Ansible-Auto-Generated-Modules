...
#ATTRIBUTE:State;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Disabled,Enabled
...
$DscResourceName = "cWindowsErrorReporting"

$DscModuleName = "cwindowserrorreporting"
