...
#ATTRIBUTE:TimeTrigger;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TimeTrigger = Get-Attr -obj $params -name TimeTrigger -failifempty $True -resultobj $result
...
$DscResourceName = "VSSTaskScheduler"

$DscModuleName = "mario_cvss"
