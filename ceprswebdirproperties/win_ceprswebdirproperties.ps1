...
#ATTRIBUTE:AnonymousAuthentication;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$AnonymousAuthentication = Get-Attr -obj $params -name AnonymousAuthentication -failifempty $False -resultobj $result
#ATTRIBUTE:HandlerMappingPermission;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$HandlerMappingPermission = Get-Attr -obj $params -name HandlerMappingPermission -failifempty $False -resultobj $result
...
#ATTRIBUTE:SSLSetting;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SSLSetting = Get-Attr -obj $params -name SSLSetting -failifempty $False -resultobj $result
...
$DscResourceName = "cEPRSWebDirProperties"

$DscModuleName = "ceprswebdirproperties"
