...
#ATTRIBUTE:StartPage;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$StartPage = Get-Attr -obj $params -name StartPage -failifempty $True -resultobj $result
...
#ATTRIBUTE:SecondaryStartPages;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SecondaryStartPages = Get-Attr -obj $params -name SecondaryStartPages -failifempty $False -resultobj $result
...
$DscResourceName = "xInternetExplorerHomePage"

$DscModuleName = "xinternetexplorerhomepage"
