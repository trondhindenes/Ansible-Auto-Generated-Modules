...
#ATTRIBUTE:TaskCredential_username;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TaskCredential_username = Get-Attr -obj $params -name TaskCredential_username -failifempty $False -resultobj $result
#ATTRIBUTE:TaskCredential_password;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TaskCredential_password = Get-Attr -obj $params -name TaskCredential_password -failifempty $False -resultobj $result
#ATTRIBUTE:TaskXml;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TaskXml = Get-Attr -obj $params -name TaskXml -failifempty $False -resultobj $result
...
if ($TaskCredential_username)
{
$TaskCredential_securepassword = $TaskCredential_password | ConvertTo-SecureString -asPlainText -Force
$TaskCredential = New-Object System.Management.Automation.PSCredential($TaskCredential_username,$TaskCredential_securepassword)
}

$DscResourceName = "Carbon_ScheduledTask"
