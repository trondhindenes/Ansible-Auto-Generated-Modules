...
#ATTRIBUTE:Privilege;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Privilege = Get-Attr -obj $params -name Privilege -failifempty $False -resultobj $result
...
$DscResourceName = "Carbon_Privilege"
