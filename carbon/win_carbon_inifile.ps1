...
#ATTRIBUTE:CaseSensitive;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$CaseSensitive = Get-Attr -obj $params -name CaseSensitive -failifempty $False -resultobj $result
...
#ATTRIBUTE:Section;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$Section = Get-Attr -obj $params -name Section -failifempty $False -resultobj $result
...
$DscResourceName = "Carbon_IniFile"
