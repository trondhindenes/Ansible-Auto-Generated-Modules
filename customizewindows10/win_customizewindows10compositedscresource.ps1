...
#ATTRIBUTE:EnableWin10ConnectedStandby;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EnableWin10ConnectedStandby = Get-Attr -obj $params -name EnableWin10ConnectedStandby -failifempty $False -resultobj $result
#ATTRIBUTE:EnablePowerShellOnWinX;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EnablePowerShellOnWinX = Get-Attr -obj $params -name EnablePowerShellOnWinX -failifempty $False -resultobj $result
#ATTRIBUTE:EnableSnapFill;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EnableSnapFill = Get-Attr -obj $params -name EnableSnapFill -failifempty $False -resultobj $result
#ATTRIBUTE:EnableSnapAssist;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EnableSnapAssist = Get-Attr -obj $params -name EnableSnapAssist -failifempty $False -resultobj $result
#ATTRIBUTE:ShowFileExtensions;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ShowFileExtensions = Get-Attr -obj $params -name ShowFileExtensions -failifempty $False -resultobj $result
#ATTRIBUTE:ShowHiddenFiles;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ShowHiddenFiles = Get-Attr -obj $params -name ShowHiddenFiles -failifempty $False -resultobj $result
#ATTRIBUTE:ShowProtectedOSFiles;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ShowProtectedOSFiles = Get-Attr -obj $params -name ShowProtectedOSFiles -failifempty $False -resultobj $result
#ATTRIBUTE:ShowDesktopIcons;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$ShowDesktopIcons = Get-Attr -obj $params -name ShowDesktopIcons -failifempty $False -resultobj $result
#ATTRIBUTE:UserCredentials;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$UserCredentials = Get-Attr -obj $params -name UserCredentials -failifempty $False -resultobj $result
#ATTRIBUTE:WindowsUpdateMode;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$WindowsUpdateMode = Get-Attr -obj $params -name WindowsUpdateMode -failifempty $False -resultobj $result
#ATTRIBUTE:EnableDriverInstallationFromWindowsUpdate;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$EnableDriverInstallationFromWindowsUpdate = Get-Attr -obj $params -name EnableDriverInstallationFromWindowsUpdate -failifempty $False -resultobj $result
...
$DscResourceName = "CustomizeWindows10CompositeDSCResource"

$DscModuleName = "customizewindows10"
