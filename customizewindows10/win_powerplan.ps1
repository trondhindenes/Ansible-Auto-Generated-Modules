...
#ATTRIBUTE:ActivePowerPlan;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:Balanced,High performance,Power saver
$ActivePowerPlan = Get-Attr -obj $params -name ActivePowerPlan -failifempty $True -resultobj $result
...
#ATTRIBUTE:SleepAfterOnAC;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SleepAfterOnAC = Get-Attr -obj $params -name SleepAfterOnAC -failifempty $False -resultobj $result
#ATTRIBUTE:SleepAfterOnDC;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SleepAfterOnDC = Get-Attr -obj $params -name SleepAfterOnDC -failifempty $False -resultobj $result
#ATTRIBUTE:TurnOffDisplayAfterOnAC;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TurnOffDisplayAfterOnAC = Get-Attr -obj $params -name TurnOffDisplayAfterOnAC -failifempty $False -resultobj $result
#ATTRIBUTE:TurnOffDisplayAfterOnDC;MANDATORY:False;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$TurnOffDisplayAfterOnDC = Get-Attr -obj $params -name TurnOffDisplayAfterOnDC -failifempty $False -resultobj $result
...
If ($ActivePowerPlan)
{
    If (('Balanced','High performance','Power saver') -contains $ActivePowerPlan ) {
    }
    Else
    {
        Fail-Json $result "Option ActivePowerPlan has invalid value $ActivePowerPlan. Valid values are 'Balanced','High performance','Power saver'"
    }
}
