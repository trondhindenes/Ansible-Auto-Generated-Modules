...
#ATTRIBUTE:SystemLocale;MANDATORY:True;DEFAULTVALUE:;DESCRIPTION:;CHOICES:
$SystemLocale = Get-Attr -obj $params -name SystemLocale -failifempty $True -resultobj $result
